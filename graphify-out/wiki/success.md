...
> God node · 216 connections · [D:\.MUSICVERSE\aimusicverse\supabase\functions\suno-music-callback\index.ts](file:///D:/.MUSICVERSE/aimusicverse/supabase/functions/suno-music-callback/index.ts#L1013)
...
sequenceDiagram
    ...
    participant P7 as uploadAndShowActions()
    participant P8 as handleAudioActionCallback()
    participant P9 as processVoiceMessage()
    participant P10 as handleClassificationCallback()
    participant P11 as handleAudioMessage()
    participant P12 as deleteMessage()
    participant P13 as handleCallbackQuery()
    participant P14 as handleProjects()
    ...
    participant P20 as handleAutoUploadWithPipeline()
    participant P21 as editMessageMedia()
    participant P22 as sendNotification()
    participant P23 as .setActive()
    participant P24 as handleGenerate()
    participant P25 as handleGuitarAudio()
    participant P26 as handleInlineQuery()
    participant P27 as handleMidiCommand()
    participant P28 as startMidiConversion()
    participant P29 as handleStatus()
    participant P30 as processMediaGroupAction()
    ...
    participant P527 as info
    participant P528 as .get()
    participant P529 as .warn()
    participant P530 as .debug()
    participant P531 as json
    participant P532 as blob
    participant P533 as processQueueItem()
    participant P534 as processNotification()
    participant P535 as sanitizeFilename()
    participant P536 as handleSelectHistory()
    participant P537 as handleDeleteHistory()
    participant P538 as handleAddShortcut()
    participant P539 as handleExport()
    participant P540 as handleCover()
    participant P541 as handleExtend()
    participant P542 as handleOpenPromptDJ()
    participant P543 as handleUseForGeneration()
    participant P544 as handleDragEnd()
    participant P545 as handleDuplicateSection()
    participant P546 as handleApplyTemplate()
    participant P547 as handleSelectInspiration()
    participant P548 as handleSaveToBookmarks()
    participant P549 as handleGenerateMusic()
    participant P550 as handleAutoFix()
    participant P551 as handleUseAsReference()
    participant P552 as handleUseTemplate()
    participant P553 as handleClearDraft()
    participant P554 as handleMelodyComplete()
    participant P555 as handleAddSection()
    participant P556 as handleDeleteSection()
    participant P557 as handleDeleteSaved()
    participant P558 as handleClearHistory()
    participant P559 as handleStopRecording()
    participant P560 as handleShare()
    participant P561 as handleCopyTag()
    participant P562 as handleShare()
    participant P563 as handleDelete()
    participant P564 as handleDownload()
    participant P565 as handleGenerateAll()
    participant P566 as handleExport()
    participant P567 as handleShare()
    participant P568 as handleAddToQueue()
    participant P569 as handleToggleLoop()
    participant P570 as handleSpeedChange()
    participant P571 as handlePlayFromHere()
    participant P572 as handlePlayNext()
    participant P573 as handleAddToQueue()
    participant P574 as handleShare()
    participant P575 as handleAddToQueue()
    participant P576 as startUpload()
    participant P577 as handleStopRecording()
    participant P578 as loadTemplate()
    participant P579 as toggleCommand()
    participant P580 as handleCopyTab()
    participant P581 as handleNotify()
    participant P582 as handleTemplateSelect()
    participant P583 as handleCreateClick()
    participant P584 as handleCopyCode()
    participant P585 as handleGuitarRecordingComplete()
    participant P586 as handleCopyProgression()
    participant P587 as handleSelectSaved()
    participant P588 as handleCopy()
    participant P589 as applyAllSuggestions()
    participant P590 as copyToClipboard()
    participant P591 as handleCopyTags()
    participant P592 as handleCopyTags()
    participant P593 as handleCopyTags()
    participant P594 as handleCopyTags()
    participant P595 as handleDownload()
    participant P596 as handleDownloadAll()
    participant P597 as handleCopyPrompt()
    participant P598 as handleCopyLink()
    participant P599 as handleUseAsReference()
    participant P600 as handleCopyLyrics()
    participant P601 as handleUseLyrics()
    participant P602 as handleClearQueue()
    participant P603 as handleToggleVersionMode()
    participant P604 as handleSeparateFirst()
    participant P605 as handleLoadPreset()
    participant P606 as handleLoadSaved()
    participant P607 as handleAddToTimeline()
    participant P608 as handleDownload()
    participant P609 as handleAddToTimeline()
    participant P610 as handleShare()
    participant P611 as handleApply()
    participant P612 as handleCopyPart()
    participant P613 as handleShare()
    participant P614 as handleProgressionExport()
    participant P615 as handleCopyCode()
    participant P616 as handleCopyLink()
    participant P617 as handleCopy()
    P0->>+ P1: calls
    P1-->>- P0: return
    P1->>+ P2: calls
    P2-->>- P1: return
...
- [[handleStemAction()]] `INFERRED`
- [[pollForResult()]] `INFERRED`
- [[handleSubmit()]] `INFERRED`
- [[handleTranscribe()]] `INFERRED`
- [[handleSubmit()]] `INFERRED`
- [[handleImageUpload()]] `INFERRED`
- [[handleFileUpload()]] `INFERRED`
- [[handleRecordingComplete()]] `INFERRED`
- [[handleFileSelect()]] `INFERRED`
- [[analyzeAudio()]] `INFERRED`
- [[handleSelectHistory()]] `INFERRED`
- [[generateSection()]] `INFERRED`
