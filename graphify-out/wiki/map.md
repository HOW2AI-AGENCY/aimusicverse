...
> God node · 268 connections · [D:\.MUSICVERSE\aimusicverse\src\components\admin\analytics\ErrorTrendsPanel.tsx](file:///D:/.MUSICVERSE/aimusicverse/src/components/admin/analytics/ErrorTrendsPanel.tsx#L400)
...
sequenceDiagram
    ...
    participant P527 as from
    participant P528 as Select
    ...
    participant P539 as .addRow()
    participant P540 as handleProjectsCallback()
    participant P541 as handleAchievements()
    participant P542 as handleTransactions()
    participant P543 as .routeToProviders()
    participant P544 as handleArtistDetails()
    participant P545 as buildDynamicKeyboard()
    participant P546 as createKeyValue()
    participant P547 as sectionsToLyrics()
    participant P548 as getCDNUrl()
    participant P549 as generateGuitarTab()
    participant P550 as handleProjectStats()
    participant P551 as fetchUsersWithBalances()
    participant P552 as generateTab()
    participant P553 as getLuminance()
    participant P554 as trackFeature()
    participant P555 as handleLeaderboard()
    participant P556 as .professionalAnalysis()
    participant P557 as searchTracksAndProjects()
    participant P558 as sendTrackBatch()
    participant P559 as processMediaGroup()
    participant P560 as showTariffsMenu()
    participant P561 as showTypeSelection()
    participant P562 as showGenreSelection()
    participant P563 as showMoodSelection()
    participant P564 as fetchTracksWithTagJoin()
    participant P565 as generateWaveform()
    participant P566 as updateSectionContent()
    participant P567 as handleSelectHistory()
    participant P568 as generateWaveform()
    participant P569 as generateWaveform()
    participant P570 as useUserFeatures()
    participant P571 as .extractInlineTags()
    participant P572 as getProductsByType()
    participant P573 as cleanupTable()
    participant P574 as searchProjects()
    participant P575 as generateTinkoffToken()
    participant P576 as getLyricVersions()
    participant P577 as getSectionNotes()
    participant P578 as generateWaveform()
    participant P579 as loadHistory()
    participant P580 as loadLocalSaved()
    participant P581 as fetchPublicTracks()
    participant P582 as fetchFeaturedContent()
    participant P583 as logAudioDiagnostics()
    participant P584 as generateWaveformFromAudioBuffer()
    participant P585 as detectSectionsFromGaps()
    participant P586 as parseTag()
    participant P587 as getProducts()
    participant P588 as getPaymentHistory()
    participant P589 as fetchTracksWithLikes()
    participant P590 as generateMidi()
    participant P591 as buildTrackCaption()
    participant P592 as createBreadcrumb()
    participant P593 as capitalizeTitle()
    participant P594 as fetchFunnelDropoffStats()
    participant P595 as getTrackBatches()
    participant P596 as getActiveUserBatches()
    participant P597 as getPresetsWithAuthors()
    participant P598 as parseLyrics()
    participant P599 as handleVoiceInput()
    participant P600 as handleApplyTemplate()
    participant P601 as handleGenerateMusic()
    participant P602 as enrichTracksWithCreators()
    participant P603 as enrichTracksWithCreators()
    participant P604 as loadLocalHistory()
    participant P605 as groupWordsIntoLines()
    participant P606 as useStudioAudioEngine()
    participant P607 as .getActiveElements()
    participant P608 as getRelativeLuminance()
    participant P609 as getUniqueMentionedUserIds()
    participant P610 as parseStyleTags()
    participant P611 as toCSV()
    participant P612 as detectBPM()
    participant P613 as formatLyricsForDisplay()
    participant P614 as moveTrack()
    participant P615 as getFeaturedProducts()
    participant P616 as fetchPublicTracksWithCreators()
    participant P617 as parseTextResponse()
    participant P618 as syncBotCommands()
    participant P619 as .buildKeyboard()
    participant P620 as .buildStepMenu()
    participant P621 as generateFallbackTitle()
    participant P622 as printResults()
    participant P623 as normalizePeaks()
    participant P624 as reorderPlaylistTracks()
    participant P625 as exportLogs()
    participant P626 as calculateForecast()
    participant P627 as handleExportCSV()
    participant P628 as exportUsers()
    participant P629 as UserJourneyPanel()
    participant P630 as ReportCommentDialog()
    participant P631 as ContentHubTabs()
    participant P632 as handleMelodyComplete()
    participant P633 as handleComplete()
    participant P634 as handleUpdateSection()
    participant P635 as handleUpdateSectionTags()
    participant P636 as sectionsToLyrics()
    participant P637 as changeSectionType()
    participant P638 as applyTemplate()
    participant P639 as QuickActions()
    participant P640 as generateTags()
    participant P641 as generateStyleDescription()
    participant P642 as toMidiNotes()
    participant P643 as parseLyrics()
    participant P644 as analyzeLine()
    participant P645 as MobileFormSkeleton()
    participant P646 as handleDragEnd()
    participant P647 as groupWordsIntoLines()
    participant P648 as groupLinesIntoSections()
    participant P649 as getNextVersionLabel()
    participant P650 as handleGenerateAll()
    participant P651 as handleUpdateSection()
    participant P652 as MidiTranscriptionActions()
    participant P653 as GridSkeleton()
    participant P654 as Skeleton()
    participant P655 as startUpload()
    participant P656 as getAvailableModels()
    participant P657 as calculateStdDev()
    participant P658 as detectZScoreAnomalies()
    participant P659 as getConfigByCategory()
    participant P660 as getFlagsByCategory()
    participant P661 as generatePeaksMainThread()
    participant P662 as getResponsiveImageSrcSet()
    participant P663 as getItems()
    participant P664 as processBatched()
    participant P665 as preloadCriticalRoutes()
    participant P666 as parseFullAnalysis()
    participant P667 as parseProducerReview()
    participant P668 as createMusicalSections()
    participant P669 as findAccessibleUrl()
    participant P670 as .validateTags()
    participant P671 as .detectRhymeScheme()
    participant P672 as .suggestStylePrompt()
    participant P673 as LoadingState()
    participant P674 as LoadingState()
    participant P675 as identifyChord()
    participant P676 as generateTagsFromAnalysis()
    participant P677 as batchSaveLyrics()
    participant P678 as cleanLyricsText()
    participant P679 as .normalizeKlangioResult()
    participant P680 as getSuggestedInstruments()
    participant P681 as sha256()
    participant P682 as detectTimeSignature()
    participant P683 as createGenerationResults()
    participant P684 as createProjectListKeyboard()
    participant P685 as measureFrame()
    participant P686 as .getPeakMemory()
    participant P687 as batchApplyPresetToTracks()
    participant P688 as SourcesHeatmap()
    participant P689 as BlogContentRenderer()
    participant P690 as calculateSimilarity()
    participant P691 as selectTemplate()
    participant P692 as generateStylePrompt()
    participant P693 as generateDetailedPrompt()
    participant P694 as parseLyrics()
    participant P695 as renderSectionTags()
    participant P696 as LyricsEditorToolbar()
    participant P697 as ParaphraseResultCard()
    participant P698 as analyzeRhythm()
    participant P699 as parseLyrics()
    participant P700 as parseLyrics()
    participant P701 as parseStructureContent()
    participant P702 as PresetCard()
    participant P703 as ShortcutsHelpContent()
    participant P704 as SocialLinks()
    participant P705 as QuickPresets()
    participant P706 as TelegramTab()
    participant P707 as SectionPresets()
    participant P708 as SectionQuickPicker()
    participant P709 as expandAll()
    participant P710 as SunoTimeline()
    participant P711 as StepIndicator()
    participant P712 as getComingSoonFeatures()
    participant P713 as extractTagsFromLyrics()
    participant P714 as parseCompoundTag()
    participant P715 as getAvailableGenres()
    participant P716 as generateStyleDescription()
    participant P717 as generateTags()
    participant P718 as getRegisteredShortcuts()
    participant P719 as getCacheKey()
    participant P720 as getGenrePlaylists()
    participant P721 as useVersionSync()
    participant P722 as prefetchQueue()
    participant P723 as generateSrcSet()
    participant P724 as preloadImages()
    participant P725 as batchLoad()
    participant P726 as splitWordByLineBreaks()
    participant P727 as generateMentionNotifications()
    participant P728 as parseTimeToSeconds()
    participant P729 as buildEnglishPrompt()
    participant P730 as parseTagsFromText()
    participant P731 as setPrimaryVersionOptimistic()
    participant P732 as .prefetchMany()
    participant P733 as formatErrorsForExport()
    participant P734 as formatDeeplinksForExport()
    participant P735 as .formatFinal()
    participant P736 as .formatSectionForDisplay()
    participant P737 as .parseCompoundTag()
    participant P738 as .validateLine()
    participant P739 as groupIntoEnhancedLines()
    participant P740 as extractLyricsForTimeRange()
    participant P741 as studioProjectToDAWProject()
    participant P742 as sectionsToLyrics()
    participant P743 as toggleSelectAll()
    participant P744 as analyzeGenerationDurations()
    participant P745 as cloneSections()
    participant P746 as getDownbeats()
    participant P747 as .addButtons()
    participant P748 as createList()
    participant P749 as addLineNumbers()
    participant P750 as formatList()
    participant P751 as createTable()
    P0->>+ P1: calls
    P1-->>- P0: return
    P1->>+ P2: calls
    P2-->>- P1: return
...
- [[handleFullAnalysis()]] `INFERRED`
- [[handleStudio()]] `INFERRED`
