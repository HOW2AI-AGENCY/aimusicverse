...
> God node · 319 connections · [D:\.MUSICVERSE\aimusicverse\src\components\ui\select.tsx](file:///D:/.MUSICVERSE/aimusicverse/src/components/ui/select.tsx#L7)
...
sequenceDiagram
    ...
    participant P542 as handleProjectDetails()
    participant P543 as handleTrackDetails()
    participant P544 as .getState()
    participant P545 as showCloudFiles()
    participant P546 as handleTrackDeepLink()
    participant P547 as handleProjectDeepLink()
    participant P548 as .getState()
    participant P549 as getMenuItem()
    participant P550 as handleAchievements()
    participant P551 as handleTransactions()
    participant P552 as handleArtistDetails()
    participant P553 as showCloudTracks()
    participant P554 as handleArtistDeepLink()
    participant P555 as handleProfileDeepLink()
    participant P556 as handlePlayTrack()
    participant P557 as handleShareTrack()
    participant P558 as fetchUserCredits()
    participant P559 as createChangelogEntry()
    participant P560 as deleteTrackWithCleanup()
    participant P561 as showFileDetails()
    participant P562 as handleInviteDeepLink()
    participant P563 as handleProjectShare()
    participant P564 as handleProjectStats()
    participant P565 as fetchUsersWithBalances()
    participant P566 as upsertUserCredits()
    participant P567 as updateTrack()
    participant P568 as handleMidiTrackCallback()
    participant P569 as handleArtistsCallback()
    participant P570 as handleArtistEdit()
    participant P571 as handleArtistTracks()
    participant P572 as showStemFiles()
    participant P573 as showMidiFiles()
    participant P574 as showMyRequests()
    participant P575 as handleProjectEdit()
    participant P576 as handleProjectStatusChange()
    participant P577 as handleProjectTracks()
    participant P578 as showTracksList()
    participant P579 as createArtist()
    participant P580 as getPresetById()
    participant P581 as fetchTracks()
    participant P582 as .saveToDatabase()
    participant P583 as buildSearchQuery()
    participant P584 as searchTracksAndProjects()
    participant P585 as handleArtistTogglePublic()
    participant P586 as handleArtistDeleteConfirm()
    participant P587 as getUserProfile()
    participant P588 as showStorageInfo()
    participant P589 as handleProjectDeleteConfirm()
    participant P590 as updateArtist()
    participant P591 as fetchGenerationLogs()
    participant P592 as createLyricVersion()
    participant P593 as restoreLyricVersion()
    participant P594 as updateProject()
    participant P595 as fetchTracksWithTagJoin()
    participant P596 as getProductsByType()
    participant P597 as cleanupTable()
    participant P598 as searchProjects()
    participant P599 as handleArtistDelete()
    participant P600 as getUserByTelegramId()
    participant P601 as handleProjectDelete()
    participant P602 as handleVoiceToTrack()
    participant P603 as handleDownloadMidi()
    participant P604 as getWizardState()
    participant P605 as fetchDeeplinkEvents()
    participant P606 as retryBatch()
    participant P607 as getLyricVersions()
    participant P608 as getSectionNotes()
    participant P609 as updateSectionNote()
    participant P610 as updatePlaylist()
    participant P611 as fetchPlaylistTracks()
    participant P612 as getMaxPosition()
    participant P613 as updatePreset()
    participant P614 as fetchTrackLikesWithUser()
    participant P615 as loadHistory()
    participant P616 as fetchPublicTracks()
    participant P617 as fetchPublicArtists()
    participant P618 as fetchFeaturedContent()
    participant P619 as loadUserTracks()
    participant P620 as getProducts()
    participant P621 as getProductByCode()
    participant P622 as getPaymentHistory()
    participant P623 as .resolveAudioUrl()
    participant P624 as sendNotifications()
    participant P625 as checkDatabase()
    participant P626 as getProjectResult()
    participant P627 as getTrackResult()
    participant P628 as .deleteState()
    participant P629 as getUserByTelegramId()
    participant P630 as getProfileData()
    participant P631 as handleToggleLike()
    participant P632 as getUserByTelegramId()
    participant P633 as handleVoiceToArrangement()
    participant P634 as handleVoiceToCover()
    participant P635 as handleVoiceToStems()
    participant P636 as fetchRecentBotEvents()
    participant P637 as fetchTrackAnalysis()
    participant P638 as createTempAnalysisTrack()
    participant P639 as fetchPublicArtists()
    participant P640 as getUpscaleStatus()
    participant P641 as getTrackBatches()
    participant P642 as getActiveUserBatches()
    participant P643 as fetchCreditTransactions()
    participant P644 as hasCheckedInToday()
    participant P645 as createSectionNote()
    participant P646 as getLyricVersionsBatch()
    participant P647 as fetchPlaylistById()
    participant P648 as getPresetsWithAuthors()
    participant P649 as createPreset()
    participant P650 as fetchProjectTracks()
    participant P651 as setPrimaryVersion()
    participant P652 as fetchReplacedSectionTasks()
    participant P653 as fetchSectionReplacementLogs()
    participant P654 as fetchTrackById()
    participant P655 as fetchFunnelData()
    participant P656 as fetchTasks()
    participant P657 as togglePlay()
    participant P658 as uploadFile()
    participant P659 as enrichTracksWithCreators()
    participant P660 as enrichTracksWithCreators()
    participant P661 as fetchDBHistory()
    participant P662 as fetchTrackChangelog()
    participant P663 as fetchVersionChangelog()
    participant P664 as fetchUserRecentChanges()
    participant P665 as fetchChangesByType()
    participant P666 as fetchPublicProjects()
    participant P667 as searchPublicContent()
    participant P668 as fetchTrackDetails()
    participant P669 as fetchTrackChangelog()
    participant P670 as fetchPrimaryVersion()
    participant P671 as updateVersion()
    participant P672 as getVersionCount()
    participant P673 as fetchTracksWithPrimaryVersions()
    participant P674 as getExperimentOrFlag()
    participant P675 as getFeaturedProducts()
    participant P676 as checkGenerationQueue()
    participant P677 as getMetrics()
    participant P678 as calculateFailureRate()
    participant P679 as .clearState()
    participant P680 as getDashboardData()
    participant P681 as getMediaGroupFiles()
    participant P682 as getStoredTranscription()
    participant P683 as checkIsAdmin()
    participant P684 as getFeaturePermission()
    participant P685 as createAudioAnalysis()
    participant P686 as saveGuitarRecording()
    participant P687 as fetchUserArtists()
    participant P688 as fetchArtistById()
    participant P689 as hasHdAudio()
    participant P690 as getHdAudioUrl()
    participant P691 as hasWatermark()
    participant P692 as getWatermarkedUrl()
    participant P693 as getBatchStatus()
    participant P694 as getUserBatchStats()
    participant P695 as fetchAchievements()
    participant P696 as fetchUserAchievements()
    participant P697 as fetchUserPlaylists()
    participant P698 as createPlaylist()
    participant P699 as fetchPlaylistTracksWithDetails()
    participant P700 as addTrackToPlaylist()
    participant P701 as getPresets()
    participant P702 as fetchUserProjects()
    participant P703 as fetchProjectById()
    participant P704 as createProject()
    participant P705 as getShortcuts()
    participant P706 as fetchTrackVersions()
    participant P707 as fetchTrackStems()
    participant P708 as fetchGuitarAnalysis()
    participant P709 as fetchGenerationTask()
    participant P710 as createTrack()
    participant P711 as fetchTask()
    participant P712 as handleAction()
    participant P713 as handleSelect()
    participant P714 as switchVersion()
    participant P715 as handleClick()
    participant P716 as fetchTaskStatus()
    participant P717 as fetchStatus()
    participant P718 as fetchPlatformStats()
    participant P719 as getChangelogCount()
    participant P720 as fetchPublicTrack()
    participant P721 as fetchPublicProject()
    participant P722 as fetchPublicArtist()
    participant P723 as fetchTrackVersions()
    participant P724 as fetchTrackStems()
    participant P725 as fetchTrackAnalysis()
    participant P726 as fetchTrackVersions()
    participant P727 as fetchVersion()
    participant P728 as createVersion()
    participant P729 as deleteVersion()
    participant P730 as loadProjects()
    participant P731 as checkTransactionStatus()
    participant P732 as ensureEntityOwner()
    participant P733 as canSendNotification()
    participant P734 as getChatIdForUser()
    participant P735 as checkIfNewUser()
    participant P736 as handleMore()
    participant P737 as handleMoreClick()
    participant P738 as handleValueCommit()
    participant P739 as handleVersionSelect()
    participant P740 as handleVersionSelect()
    participant P741 as handleToggle()
    participant P742 as handlePlayPause()
    participant P743 as handleMasterMute()
    participant P744 as handleSelect()
    P0->>+ P1: calls
    P1-->>- P0: return
    P1->>+ P2: calls
    P2-->>- P1: return
