...
## Corpus Check
- Large corpus: 2787 files · ~2,334,881 words. Semantic extraction will be expensive (many Claude tokens). Consider running on a subfolder, or use --no-semantic to run AST-only.

## Summary
- 18154 nodes · 24696 edges · 1734 communities (1429 shown, 305 thin omitted)
- Extraction: 78% EXTRACTED · 22% INFERRED · 0% AMBIGUOUS · INFERRED: 5364 edges (avg confidence: 0.8)
- Token cost: 217,603 input · 0 output

## Community Hubs (Navigation)
- [[_COMMUNITY_API Layer & Data Access|API Layer & Data Access]]
- [[_COMMUNITY_UI Dialogs & Actions|UI Dialogs & Actions]]
- [[_COMMUNITY_Edge Functions Core|Edge Functions Core]]
- [[_COMMUNITY_Suno Integration Pipeline|Suno Integration Pipeline]]
- [[_COMMUNITY_Bot Analysis Commands|Bot Analysis Commands]]
- [[_COMMUNITY_Audio Action Handlers|Audio Action Handlers]]
- [[_COMMUNITY_Audio Processing Functions|Audio Processing Functions]]
- [[_COMMUNITY_Callback & Task Management|Callback & Task Management]]
- [[_COMMUNITY_Auth & Authorization|Auth & Authorization]]
- [[_COMMUNITY_Bot Commands & Caching|Bot Commands & Caching]]
- [[_COMMUNITY_Audio Context & Cache|Audio Context & Cache]]
- [[_COMMUNITY_Broadcast & Moderation|Broadcast & Moderation]]
- [[_COMMUNITY_Audio Upload Pipeline|Audio Upload Pipeline]]
- [[_COMMUNITY_Social & Comments|Social & Comments]]
- [[_COMMUNITY_Unified Studio Shell|Unified Studio Shell]]
- [[_COMMUNITY_Staff Notation & Score|Staff Notation & Score]]
- [[_COMMUNITY_Telegram Payments & Config|Telegram Payments & Config]]
- [[_COMMUNITY_MIDI & Klangio Analysis|MIDI & Klangio Analysis]]
- [[_COMMUNITY_Studio Content & Editing|Studio Content & Editing]]
- [[_COMMUNITY_Audio Utils & Features|Audio Utils & Features]]
- [[_COMMUNITY_Admin Dashboard Pages|Admin Dashboard Pages]]
- [[_COMMUNITY_API Logger & Artists|API Logger & Artists]]
- [[_COMMUNITY_Player E2E Tests|Player E2E Tests]]
- [[_COMMUNITY_Media Generation Functions|Media Generation Functions]]
- [[_COMMUNITY_Lyrics Panel & Sync|Lyrics Panel & Sync]]
- [[_COMMUNITY_Tinkoff Payments|Tinkoff Payments]]
- [[_COMMUNITY_Notifications & Profiles|Notifications & Profiles]]
- [[_COMMUNITY_Visualizer & Analytics|Visualizer & Analytics]]
- [[_COMMUNITY_Stars & Rewards|Stars & Rewards]]
- [[_COMMUNITY_Generation E2E Tests|Generation E2E Tests]]
- [[_COMMUNITY_Notes Viewer Component|Notes Viewer Component]]
- [[_COMMUNITY_Main Layout & Navigation|Main Layout & Navigation]]
- [[_COMMUNITY_Lyrics Utils & Studio|Lyrics Utils & Studio]]
- [[_COMMUNITY_Unified Lyrics View|Unified Lyrics View]]
- [[_COMMUNITY_Waveform Timeline|Waveform Timeline]]
- [[_COMMUNITY_Chord Aware Player|Chord Aware Player]]
- [[_COMMUNITY_Project Creation Sheet|Project Creation Sheet]]
- [[_COMMUNITY_Accessibility & Classifier|Accessibility & Classifier]]
- [[_COMMUNITY_Lyrics Studio Page|Lyrics Studio Page]]
- [[_COMMUNITY_Track Naming & Metadata|Track Naming & Metadata]]
...
- `handleSubmit()` --calls--> `error`  [INFERRED]
  src/components/admin/BotMenuItemForm.tsx → supabase/functions/generate-thumbnails/index.ts
- `loadTemplate()` --calls--> `success`  [INFERRED]
  src/components/admin/BroadcastPanel.tsx → supabase/functions/suno-music-callback/index.ts

## Import Cycles
- 1-file cycle: `supabase/functions/telegram-bot/callbacks/media-group.ts -> supabase/functions/telegram-bot/callbacks/media-group.ts`
...
- **Music Generation Pipeline** — suno_ai_integration, supabase_backend, model_fallback_chain, error_handling_system [EXTRACTED 0.95]
- **Project Documentation System** — documentation_index, docs_navigation_guide, readme, project_status, roadmap [EXTRACTED 0.85]
- **Deployment Workflow** — ci_yml, docs_deployment_checklist, docs_deployment_guide [INFERRED 0.85]
- **UI Improvements Specification Suite** — 001_ui_improvements_spec, 001_ui_improvements_plan, 001_ui_improvements_tasks, 001_ui_improvements_data_model, 001_ui_improvements_research, 001_ui_improvements_quickstart, 001_ui_improvements_requirements [EXTRACTED 1.00]
- **Security Documentation Suite** — docs_security_checklist, docs_security_operations, concept_defense_in_depth [INFERRED 0.85]
- **Sprint A Reliability Implementation** — docs_optimization_plan, docs_sprint_a_progress, concept_exponential_backoff_retry, concept_model_fallback_chain [EXTRACTED 1.00]

## Communities (1734 total, 305 thin omitted)

### Community 0 - "API Layer & Data Access"
Cohesion: 0.02
Nodes (239): fetchRecentBotEvents(), fetchUsersWithBalances(), createAudioAnalysis(), fetchTrackAnalysis(), saveGuitarRecording(), fetchDeeplinkEvents(), markDeeplinkConversion(), trackAnalyticsEvent() (+231 more)

### Community 1 - "UI Dialogs & Actions"
Cohesion: 0.02
Nodes (177): loading, handleAddToProject(), handleSubmit(), handleSubmit(), handleSubmit(), handleDelete(), handleFileUpload(), handleSubmit() (+169 more)

### Community 2 - "Edge Functions Core"
Cohesion: 0.02
Nodes (158): { action, projectId, field, language }, { action, prompt, content }, { 
      ...
      stemMode,
      defaultParamFlag,
    }, AI_GATEWAY_URL, aiContent, aiData, aiResponse (+150 more)

### Community 3 - "Suno Integration Pipeline"
Cohesion: 0.03
Nodes (148): activeVersion, apiModel, apiType, artistData, artistName, audioBuffer, {
      audioFile,
      audioUrl,
      prompt,
      customMode = false,
...
### Community 4 - "Bot Analysis Commands"
Cohesion: 0.04
Nodes (147): analysisSessions, getAnalysisSession(), handleAnalyzeCallbacks(), handleAnalyzeCommand(), handleAnalyzeList(), handleAnalyzeSelect(), handleBeatAnalysis(), handleChordAnalysis() (+139 more)

### Community 5 - "Audio Action Handlers"
Cohesion: 0.03
Nodes (120): downloadAsBase64(), getFileUrl(), getUserProfile(), handleAddInstrumentalAction(), handleAddVocalsAction(), handleAudioActionCallback(), handleCoverAction(), handleEditStyleAction() (+112 more)

### Community 6 - "Audio Processing Functions"
Cohesion: 0.02
Nodes (132): analysis, ANALYSIS_SYSTEM_PROMPT, analysisMetadata, arousal, { audio, language = 'ru' }, {
      audio_url,
      audio_base64,
      user_id,
      file_name = 'audio.mp3',
      ...
      action,
      user_classification,
    }, { audio_url, constant_tempo = false, use_dbn = false }, { audio_url, track_id, analyze_style = true } (+124 more)

### Community 7 - "Callback & Task Management"
Cohesion: 0.02
Nodes (113): audioClipsData, audioFileName, { callbackType, taskId, task_id, data: audioData }, cleanedTitle, clipAudioUrl, clipImageUrl, clips, { code, msg, data } (+105 more)

### Community 8 - "Auth & Authorization"
Cohesion: 0.02
Nodes (103): authenticateWithTelegram(), authorize(), getAuthenticatedUser(), isServiceRoleToken(), log, requireAdmin(), requireAuth(), setSession() (+95 more)

### Community 9 - "Bot Commands & Caching"
Cohesion: 0.04
Nodes (50): setAnalysisSession(), cacheResponse(), evictOldEntries(), getCacheSize(), DEFAULT_COMMANDS, getBotCommands(), saveBotCommands(), updateBotCommands() (+42 more)

### Community 10 - "Audio Context & Cache"
Cohesion: 0.03
Nodes (79): clearAudioCache(), analyserNode, audioContext, audioNodesResult, connectedAudioElement, disconnectAudio(), ensureAudioRoutedToDestination(), getAudioContext() (+71 more)

### Community 11 - "Broadcast & Moderation"
Cohesion: 0.03
Nodes (83): actionLabel, actionUrl, auddApiKey, { audioBase64, audioUrl, returnData }, batch, batchSize, binaryString, body (+75 more)

### Community 12 - "Audio Upload Pipeline"
Cohesion: 0.04
Nodes (51): getFileUrl(), handleAudioMessage(), handleAutoUploadWithPipeline(), handleCloudUploadWithAnalysis(), isAudioMessage(), logger, processAudioUpload(), showAudioClassificationPromptInternal() (+43 more)

### Community 13 - "Social & Comments"
Cohesion: 0.03
Nodes (57): useAuth(), CommentForm(), FollowButton(), TrackDetailsTab(), PAGE_SIZE, useActivityFeed(), useFeedSummary(), useFollowingIds() (+49 more)

### Community 14 - "Unified Studio Shell"
Cohesion: 0.02
Nodes (83): abortController, {
    activeStems,
    limitedStems,
    ...
    dismissWarning,
    capabilities,
  }, addStemToProjectIfMissing, audioEngine, audioTracks, autoSave, channels, currentVersions (+75 more)

### Community 15 - "Staff Notation & Score"
Cohesion: 0.03
...
### Community 16 - "Telegram Payments & Config"
Cohesion: 0.05
Nodes (60): buildDynamicKeyboard(), buildKeyboard(), createButton(), DEFAULT_IMAGES, formatMenuCaption(), getMainMenuKeyboard(), getMenuImageUrl(), getMenuItem() (+52 more)

### Community 17 - "MIDI & Klangio Analysis"
Cohesion: 0.03
Nodes (67): API_BASE, apiEndpoints, attempt, { audio_url, mode, model, outputs, vocabulary, user_id, title, stem_type }, avgInterval, baseEndpoint, baseRetryDelay, beatData (+59 more)

### Community 18 - "Studio Content & Editing"
Cohesion: 0.03
Nodes (68): { 
    activeTask: separationTask, 
    progress: separationProgress, 
    isProcessing: isSeparationProcessing 
  }, [addTrackDrawerOpen, setAddTrackDrawerOpen], [addVocalsDrawerOpen, setAddVocalsDrawerOpen], animationFrameRef, audio, audioRef, canReplaceSection, [currentAudioUrl, setCurrentAudioUrl] (+60 more)

### Community 19 - "Audio Utils & Features"
Cohesion: 0.04
Nodes (57): info, clearAudioCacheViaSW(), precacheAudioUrls(), registerAudioServiceWorker(), sendToServiceWorker(), checkIsAdmin(), getFeaturePermission(), getSubscriptionStatus() (+49 more)

### Community 20 - "Admin Dashboard Pages"
Cohesion: 0.03
Nodes (62): AdminAlerts, AdminBot, AdminBroadcast, AdminDashboard, AdminEconomy, AdminFeedback, AdminLayout, AdminOverview (+54 more)

### Community 21 - "API Logger & Artists"
Cohesion: 0.05
Nodes (53): COST_TABLE, logApiCall(), json, generateArtistPortrait(), createArtistWithPortrait(), searchArtists(), updateArtistPortrait(), escapeMarkdown() (+45 more)

### Community 22 - "Player E2E Tests"
Cohesion: 0.03
Nodes (60): accessibleControls, artwork, artworkCount, body, bodyBox, buttonCount, buttons, compactCount (+52 more)

### Community 23 - "Media Generation Functions"
Cohesion: 0.04
Nodes (50): artStyle, attempts, binaryData, bpmKey, colorPalette, composition, conceptHint, contentPreview (+42 more)

### Community 24 - "Lyrics Panel & Sync"
Cohesion: 0.04
Nodes (51): activeLine, {
    activeLineIndex,
    currentTime: syncedTime,
    constants,
  }, activeLineRef, adjustedTime, container, containerRect, { createVersion, isCreating }, currentLinePos (+43 more)

### Community 25 - "Tinkoff Payments"
Cohesion: 0.05
Nodes (49): accessToken, chatId, { data: authData, error: authError }, { data: authUser, error: authUserError }, { data: existingProfile, error: profileCheckError }, { data: product, error: productError }, { data: result, error: processError }, { data: signInData, error: signInError } (+41 more)

### Community 26 - "Notifications & Profiles"
Cohesion: 0.04
Nodes (50): audioMessage, audioResult, audioSource, BOT_MENTION, botDeepLink, canSend, caption, { 
...
### Community 27 - "Visualizer & Analytics"
Cohesion: 0.05
Nodes (33): animate(), idleInterval, [levels, setLevels], rafRef, generateMidiFromNotes(), parseNotesCsv(), canDecrement, canIncrement (+25 more)

### Community 28 - "Stars & Rewards"
Cohesion: 0.04
Nodes (43): ACTION_REWARDS, botToken, creditsGranted, creditsSpent, creditsToDeduct, currentBalance, dailyEarned, { data: creditTransactions } (+35 more)

### Community 29 - "Generation E2E Tests"
Cohesion: 0.04
Nodes (48): ariaCount, ariaElements, body, bodyBox, buttonA, buttonB, buttonCount, charCounter (+40 more)

### Community 30 - "Notes Viewer Component"
Cohesion: 0.04
...
### Community 31 - "Main Layout & Navigation"
Cohesion: 0.04
...
### Community 32 - "Lyrics Utils & Studio"
Cohesion: 0.05
Nodes (38): filterStructuralTagWords(), isStructuralTag(), splitWordByLineBreaks(), STRUCTURAL_TAG_PATTERNS, activeIdx, [activeLineIndex, setActiveLineIndex], calculateReplacementBounds(), containerRef (+30 more)

### Community 33 - "Unified Lyrics View"
Cohesion: 0.05
...
### Community 34 - "Waveform Timeline"
Cohesion: 0.05
Nodes (42): audioContext, barHeight, barProgress, barWidth, blockSize, canvas, canvasRef, colors (+34 more)

### Community 35 - "Chord Aware Player"
Cohesion: 0.05
Nodes (39): audio, audioRef, barHeight, barWidth, canvas, canvasRef, chordColors, ctx (+31 more)

### Community 36 - "Project Creation Sheet"
Cohesion: 0.05
...
### Community 37 - "Accessibility & Classifier"
Cohesion: 0.08
Nodes (33): runAccessibilityAudit(), buildCompletedActionKeyboard(), buildUploadedActionKeyboard(), consumePendingClassification(), formatDuration(), formatFileSize(), getFileUrl(), getGenderLabel() (+25 more)

### Community 38 - "Lyrics Studio Page"
Cohesion: 0.05
...
### Community 39 - "Track Naming & Metadata"
Cohesion: 0.07
Nodes (30): sanitizeTrackTitle(), buildHashtags(), buildSimpleCaption(), buildTelegramMetadata(), buildVersionCaption(), formatDuration(), getModeEmoji(), getModeLabel() (+22 more)

### Community 40 - "Community 40"
Cohesion: 0.14
Nodes (37): togglePlay(), togglePlay(), togglePlayback(), togglePlayPause(), togglePlayback(), playRegion(), togglePlayPause(), togglePlayback() (+29 more)

### Community 41 - "Community 41"
Cohesion: 0.06
Nodes (32): handleChannel(), BOT_CONFIG, CACHE_TTL, cachedConfig, cacheTimestamp, CHANNEL_URL, CHANNEL_USERNAME, DEFAULT_MESSAGES (+24 more)

### Community 42 - "Community 42"
Cohesion: 0.05
Nodes (36): corsHeaders, activityIds, aggregatedMetrics, archiveCutoffDate, archiveCutoffIso, archivedRecords, BATCH_SIZE, checkAuth() (+28 more)

### Community 43 - "Community 43"
Cohesion: 0.05
Nodes (37): addNote, containerRef, deleteNote, dragNote, dragStartPos, [editMode, setEditMode], gridLines, gridRef (+29 more)
...
Cohesion: 0.05
Nodes (35): ANALYSIS_STEPS, analysisIntervalRef, [analysisProgress, setAnalysisProgress], [analysisResult, setAnalysisResult], [analysisStep, setAnalysisStep], audio, [audioDuration, setAudioDuration], [audioFile, setAudioFile] (+27 more)
...
Cohesion: 0.16
Nodes (29): handleApp(), handleAchievementsDeepLink(), handleAnalyzeDeepLink(), handleArtistDeepLink(), handleDeepLink(), handleInviteDeepLink(), handleLeaderboardDeepLink(), handlePaymentDeepLink() (+21 more)
...
Cohesion: 0.07
Nodes (31): cloudStorage, getItems(), getJSON(), getTelegramCloudStorage(), isCloudStorageAvailable(), log, setItem(), setJSON() (+23 more)
...
Cohesion: 0.06
Nodes (32): { activeTrack, isPlaying, playTrack, pauseTrack }, creatorName, { data: album, isLoading: albumLoading }, { data: tracks, isLoading: tracksLoading }, handlePlayAll(), handlePlayTrack(), handleShare(), { id } (+24 more)

### Community 55 - "Community 55"
Cohesion: 0.07
Nodes (30): getItem(), getPromptUsageCount(), incrementPromptUsage(), INSPIRATION_PROMPTS, calculateRetentionDays(), FIRST_GENERATION_DATE_KEY, FIRST_GENERATION_KEY, getFirstGenerationDate() (+22 more)
...
Cohesion: 0.07
Nodes (30): cooldownCache, DEDUPE_TIMEOUT_MS, delay(), formatNotificationMessage(), getProgressBar(), getStatusInfo(), isProcessing, log (+22 more)
...
Cohesion: 0.06
Nodes (31): { activeReference }, [advancedOpen, setAdvancedOpen], [artistDialogOpen, setArtistDialogOpen], { artists }, [audioActionDialogOpen, setAudioActionDialogOpen], chordInfo, [closeConfirmOpen, setCloseConfirmOpen], form (+23 more)
...
Cohesion: 0.06
Nodes (17): AudioClipBlock(), GuestModeBanner(), guestLogger, GuestModeContext, useGuestMode(), ScreenshotModeBanner(), ShareSheet(), useFirstGeneratedTrack() (+9 more)
...
Cohesion: 0.10
Nodes (22): createProjectControls(), createShareMenu(), getMainBanner(), CACHE_TTL, cachedCustomImages, cacheTimestamp, FALLBACK_IMAGES, getMenuImage() (+14 more)
...
Nodes (21): canProceed(), progress, {
    ...
    reset,
    isGenerating,
  }, STEPS, EnhancedProfileSetup(), STEPS, cloneSections(), HISTORY_DEBOUNCE_MS (+13 more)

### Community 82 - "Community 82"
Cohesion: 0.09
Nodes (16): APIError, AudioError, err(), ERROR_METADATA, GenerationError, InsufficientCreditsError, NetworkError, ok() (+8 more)
...
Cohesion: 0.07
Nodes (25): accessLog, cacheHits, cacheMisses, DB_NAME, DB_VERSION, dbPromise, getCacheStats(), getRecommendedQuality() (+17 more)
...
Cohesion: 0.08
Nodes (25): cleanAudioCache(), cleanLyricsWizardState(), cleanPlaybackPositions(), cleanSessionStorage(), cleanStemAudioReference(), cleanupStaleData(), clearAllAppStorage(), LOCAL_STORAGE_KEYS_TO_VALIDATE (+17 more)
...
Cohesion: 0.08
Nodes (17): FeatureGate(), FeatureWithBadge(), status, MidiTranscriptionActions(), STEM_ICONS, STEM_LABELS, MobileTrackActionSheet(), useCreditsLimits() (+9 more)

### Community 93 - "Community 93"
Cohesion: 0.13
Nodes (23): handleGenerate(), supabase, buildMessage(), createDivider(), createErrorMessage(), createHeader(), createKeyValue(), createList() (+15 more)

### Community 94 - "Community 94"
Cohesion: 0.08
Nodes (27): showProgress, [audioDuration, setAudioDuration], [audioFile, setAudioFile], [audioPreviewUrl, setAudioPreviewUrl], availableModels, clearAudio(), [durationError, setDurationError], handleFileSelect() (+19 more)

### Community 95 - "Community 95"
Cohesion: 0.08
Nodes (23): addMetric, bgColor, color, { data: metrics, isLoading, refetch }, [dateRange, setDateRange], [days, setDays], DEVICE_ICONS, handleCollectMetrics() (+15 more)

### Community 96 - "Community 96"
Cohesion: 0.11
Nodes (5): componentDidCatch(), errorCode, getDerivedStateFromError(), userMessage, LyricsParser
...
Cohesion: 0.07
Nodes (27): altCount, body, bodyBox, criticalErrors, errors, focusedElement, h1, h1Count (+19 more)
...
Cohesion: 0.19
Nodes (24): deleteAndSendNewMenuPhoto(), setActiveMenuMessageId(), handleNavigationAnalyze(), handleNavigationCallback(), handleNavigationGenerate(), handleNavigationHelp(), handleNavigationLibrary(), handleNavigationMain() (+16 more)

### Community 101 - "Community 101"
Cohesion: 0.09
Nodes (15): MandatoryProfileSetup(), PrivacySettings(), ProfileSetupGuard(), SmartAlertContext, SmartAlertProvider(), useAntiSpam(), useKeyboardAware(), useKeyboardAwareContainer() (+7 more)

### Community 102 - "Community 102"
Cohesion: 0.07
Nodes (25): [autoGenerateTracklist, setAutoGenerateTracklist], [createdProjectId, setCreatedProjectId], { createProject, isCreating }, [description, setConcept], [generatedTracksCount, setGeneratedTracksCount], { generateTracklist, isGenerating, tracks }, [genre, setGenre], GENRES (+17 more)

### Community 103 - "Community 103"
Cohesion: 0.08
Nodes (18): MobilePlayerPage(), CompactPlayer, FullscreenPlayer, ResizablePlayer(), log, useAudioPerformanceMonitor(), useDebouncedAudioTime(), log (+10 more)
...
Nodes (24): {
    ...
    isDeleting,
    isResolving,
  }, [editContent, setEditContent], [editingNoteId, setEditingNoteId], [editType, setEditType], filteredNotes, [filters, setFilters], groupedNotes, handleCreateNote (+16 more)
...
Cohesion: 0.07
Nodes (26): [activeWordIndex, setActiveWordIndex], [copied, setCopied], { currentTime, isPlaying }, currentWord, el, hasTimestampedLyrics, hiddenLinesCount, idx (+18 more)

### Community 108 - "Community 108"
Cohesion: 0.07
Nodes (17): useHapticFeedback(), useGestures(), useLikeComment(), useLongPress(), DEFAULT_SLOTS, KEY_TO_MIDI, SCALES, ToneModule (+9 more)
...
Cohesion: 0.08
Nodes (23): activeAudio, [activeVersion, setActiveVersion], animationRef, currentNewUrl, [currentTime, setCurrentTime], effectiveVolume, handleVariantSwitch(), haptic (+15 more)
...
Cohesion: 0.08
Nodes (17): GenerateFormReferences(), usePlanTrackStore, getModelCost(), useAudioReference(), AUTO_SAVE_DELAY_MS, defaultDraft, DRAFT_EXPIRY_MS, DRAFT_KEY (+9 more)
...
Cohesion: 0.08
Nodes (23): audio, audioLevel, audioRef, chunksRef, {
    currentChord,
    chordHistory,
    chromagram,
    isListening,
    ...
    stopListening,
    clearHistory,
  }, handleDownload(), [isPlaying, setIsPlaying], [isRecording, setIsRecording] (+15 more)
...
Cohesion: 0.11
Nodes (23): getNextVersionLabel(), [newTrackName, setNewTrackName], nextVersion, operationDescriptions, operationLabels, [selectedAction, setSelectedAction], cleanupOldEntries(), clearWaveformCache() (+15 more)

### Community 122 - "Community 122"
Cohesion: 0.13
Nodes (14): WorkflowEngine, WORKFLOWS, [currentStep, setCurrentStep], handleAction(), handleNext(), handleSkip(), interval, isCompleted (+6 more)

### Community 123 - "Community 123"
Cohesion: 0.08
Nodes (22): goHome(), card, goHome(), result, TEST_ID, boot(), bottomNav, box (+14 more)

### Community 124 - "Community 124"
Cohesion: 0.14
Nodes (22): detectIntent(), extractMusicStyle(), getSuggestedAction(), getSuggestedResponse(), INTENT_PATTERNS, isMusicPrompt(), checkUploadPending(), cleanupSessions() (+14 more)

### Community 125 - "Community 125"
Cohesion: 0.08
Nodes (16): ContentHubTabs(), LyricsTab, ProjectsTab, tabs, useIsMobile(), MobileDialogOrSheet(), isFromLinkedTrack, LYRICS_STATUS_CONFIG (+8 more)

### Community 126 - "Community 126"
Cohesion: 0.13
Nodes (22): handleManualCreate(), chunk(), createProject(), GENRES, getWizardStep(), handleBack(), handleDescriptionInput(), handleTitleInput() (+14 more)
...
Cohesion: 0.12
Nodes (23): trackButtonClick(), trackEvent(), trackFeatureUsed(), trackGeneration(), trackGenerationMetrics(), trackOnboardingStep(), trackPageView(), trackTrackLiked() (+15 more)
...
Cohesion: 0.09
Nodes (24): A/B Track Versioning, CI/CD Pipeline, Formatting Guide, Navigation Guide, Documentation Index, Gamification System, Global Audio Player, Model Fallback Chain (+16 more)
...
Cohesion: 0.08
Nodes (23): [activeTab, setActiveTab], filteredHistory, filteredInspiration, filteredSaved, handleCopy(), handleDeleteHistory(), handleDeleteSaved(), handleSelectHistory() (+15 more)
...
Cohesion: 0.08
Nodes (19): [activeTab, setActiveTab], [copied, setCopied], DEFAULT_STYLE, emoji, getSectionTypeColor(), hasNoTags, Icon, info (+11 more)
...
Cohesion: 0.08
Nodes (21): bars, containerRef, [dragStartX, setDragStartX], endPercent, getTimeFromPosition, handleContainerClick, handleDragStart, handleMove() (+13 more)
...
Cohesion: 0.14
Nodes (21): clearActiveMenu(), deleteActiveMenu(), deleteAndSendNewMenu(), getActiveMenuMessageId(), getMenuState(), logger, sendNotification(), supabase (+13 more)

### Community 143 - "Community 143"
Cohesion: 0.09
Nodes (22): [audioDuration, setAudioDuration], [audioFile, setAudioFile], [audioPreviewUrl, setAudioPreviewUrl], availableModels, clearAudio(), [continueAt, setContinueAt], [durationError, setDurationError], handleFileSelect() (+14 more)

### Community 144 - "Community 144"
Cohesion: 0.09
Nodes (20): animationRef, audio, audioRef, beatHeight, canvas, canvasRef, ctx, [currentTime, setCurrentTime] (+12 more)
...
Cohesion: 0.09
Nodes (21): cancelled, canvasRef, container, containerRef, draw, [error, setError], { generatePeaks }, { get: getCached, set: setCached } (+13 more)
...
Cohesion: 0.09
Nodes (21): [currentIndex, setCurrentIndex], currentSlide, [currentSlide, setCurrentSlide], currentSlideData, [direction, setDirection], goNext, goPrev, goToSlide (+13 more)

### Community 151 - "Community 151"
Cohesion: 0.09
Nodes (13): DesktopFullscreenPlayer(), getGlobalAudioRef(), globalAudio, useAudioTime(), cacheCleanupRun, useGlobalAudioPlayer(), PLAY_DURATION_THRESHOLD, PLAY_MILESTONES (+5 more)
...
Cohesion: 0.09
Nodes (15): Projects(), statusLabels, typeLabels, VALID_TABS, useArtists(), useAuditLog(), useProjectDetailData(), useProjectGeneratedTracks() (+7 more)

### Community 154 - "Community 154"
Cohesion: 0.14
Nodes (5): analysisOptions, { analyze, isAnalyzing, status, currentStep }, handleAnalyze(), [lastAnalyzedType, setLastAnalyzedType], AudioAnalysisService

### Community 155 - "Community 155"
Cohesion: 0.10
Nodes (19): audio, audioRef, chunksRef, [copiedProgression, setCopiedProgression], {
    currentChord,
    chordHistory,
    chromagram,
    isListening,
    ...
    clearHistory,
    exportProgression,
  }, generateStyleDescription, handleComplete(), handleCopyProgression() (+11 more)
...
Cohesion: 0.09
Nodes (13): GlobalGenerationIndicator(), useDebounce(), useActiveGenerations(), useFailedGenerations(), log, useGenerationRealtime(), log, useLibraryData() (+5 more)

### Community 158 - "Community 158"
Cohesion: 0.09
Nodes (20): activeIndex, colors, containerRef, handleClick, [hoveredSection, setHoveredSection], isActive, isHovered, [isLoading, setIsLoading] (+12 more)
...
Cohesion: 0.09
Nodes (21): initSentry(), containerRef, getSeekTimeFromPosition, handleClick, handleTouchEnd, handleTouchMove, handleTouchStart, haptic (+13 more)
...
Cohesion: 0.10
Nodes (19): Comp, contextValue, handleKeyDown(), isMobile, { isMobile, state }, { isMobile, state, openMobile, setOpenMobile }, open, [_open, _setOpen] (+11 more)
...
Cohesion: 0.19
Nodes (20): BOT_USERNAME, buildPlaylistShareCaption(), buildTrackCaption(), buildTrackShareCaption(), canDownloadFile(), canShareToStory(), canShareURL(), downloadTrack() (+12 more)
...
Cohesion: 0.10
Nodes (20): [audioElement, setAudioElement], { audioList, isLoading, deleteAudio, saveAudio, updateAnalysis }, [deleteConfirmId, setDeleteConfirmId], dragCounterRef, filteredAudio, handleDragEnter, handleDragLeave, handleDragOver (+12 more)

### Community 169 - "Community 169"
Cohesion: 0.10
Nodes (12): ActionIcon, positionClasses, UnifiedFAB(), useBottomSheetGestures(), useHaptic(), useMusicLabStudio(), useOptimisticUpdate(), usePullToRefresh() (+4 more)
...
Cohesion: 0.10
Nodes (18): defaultProps, initialRender, initialRenderCount, likeButton, mockTrack, onPlay, onPlay1, onPlay2 (+10 more)

### Community 173 - "Community 173"
Cohesion: 0.10
Nodes (19): ACTION_WIDTH, [actionTriggered, setActionTriggered], closeSwipe(), dragDirectionRef, handleActionClick, handleDrag(), handleDragEnd(), [isOpen, setIsOpen] (+11 more)
...
Cohesion: 0.10
Nodes (14): audio, audioRef, checkBounds(), [currentTime, setCurrentTime], duration, formatTime, handleSaveAsTrack(), interval (+6 more)
...
Cohesion: 0.12
Nodes (18): completeOnboarding(), handleOnboardingCallback(), showOnboardingStep(), startOnboarding(), supabase, { data: adminAuth }, { data: profile }, { data: stats, isLoading: statsLoading } (+10 more)

### Community 181 - "Community 181"
Cohesion: 0.11
Nodes (19): createInteractive(), animationStyles, bgColorStyles, cardStyles, colorStyles, elevationStyles, focusStyles, getAnimation() (+11 more)

### Community 182 - "Community 182"
Cohesion: 0.10
Nodes (9): supabase, addLineNumbers(), createTable(), decodeHtmlEntities(), formatList(), highlightText(), htmlToMarkdown(), sanitizeMarkdown() (+1 more)
...
Cohesion: 0.12
Nodes (12): AdminTracks(), AdminUsers(), useAdminAuth(), useAdminBalance(), ADMIN_TAB_OPTIONS, useAdminDashboard(), useAdminTracks(), useAdminStats() (+4 more)
...
Cohesion: 0.20
Nodes (16): addCredits(), deductCredits(), fetchSunoApiBalance(), fetchUserCredits(), logCreditTransaction(), recordCheckin(), upsertUserCredits(), ACTION_REWARDS (+8 more)
...
Cohesion: 0.10
Nodes (15): baseOpacity, DOUBLE_TAP_DELAY, DRAG_CLOSE_THRESHOLD, heightPercent, HORIZONTAL_SWIPE_THRESHOLD, HORIZONTAL_VELOCITY_THRESHOLD, isCenter, MobileFullscreenPlayer() (+7 more)
...
Cohesion: 0.10
Nodes (18): animationRef, audio, { data: lyricsData }, handleClose, handleProgressDismiss, isActive, [isAdvancedOpen, setIsAdvancedOpen], isMobile (+10 more)
...
Cohesion: 0.10
Nodes (19): circumference, config, diameter, displayMessage, Icon, iconSize, isActive, isCompleted (+11 more)
...
Cohesion: 0.12
Nodes (7): captureAudioError(), detectPlatform(), isSentryEnabled, SENTRY_DSN, setTag(), setUser(), setUserContext()
...
Cohesion: 0.14
Nodes (11): AppError, BLOCKED_ARTIST_PATTERNS, checkForBlockedArtists(), detectErrorCodeFromMessage(), ERROR_CODE_MESSAGES, FALSE_POSITIVE_WORDS, getEnhancedErrorInfo(), getRetryDelayForError() (+3 more)
...
Cohesion: 0.11
Nodes (18): authButton, authCookies, authCount, authState, body, cookies, emailInput, errorCount (+10 more)

### Community 208 - "Community 208"
Cohesion: 0.11
Nodes (16): artistName, audioRef, [avatarUrl, setAvatarUrl], [bio, setBio], { createArtist, isCreating }, [genreTags, setGenreTags], [isGeneratingPortrait, setIsGeneratingPortrait], isMobile (+8 more)
...
Cohesion: 0.11
Nodes (13): [activeTab, setActiveTab], campaignData, { data: events, isLoading: eventsLoading, refetch: refetchEvents }, { data: stats, isLoading: statsLoading, refetch: refetchStats }, { data: summary, isLoading: summaryLoading, refetch: refetchSummary }, DeeplinkAnalyticsPanel(), funnelData, heatmapData (+5 more)

### Community 211 - "Community 211"
Cohesion: 0.11
Nodes (15): [activeTab, setActiveTab], [addVocalsOpen, setAddVocalsOpen], audio, audioRef, [currentTime, setCurrentTime], handleCopyTags(), hasMidi, hasPdf (+7 more)

### Community 212 - "Community 212"
Cohesion: 0.11
Nodes (14): { activeTrack, isPlaying, playTrack, pauseTrack }, [copied, setCopied], coverUrl, handleCopyLink(), handleCreatorClick(), { hapticFeedback }, [imageError, setImageError], isCurrentlyPlaying (+6 more)

### Community 213 - "Community 213"
Cohesion: 0.11
Nodes (14): analysis, analyzeLine(), analyzeRhythm(), COMMON_PATTERNS, hasIssues, isEmpty, isEven, [isExpanded, setIsExpanded] (+6 more)
...
Cohesion: 0.11
Nodes (10): getTelegramOffset(), Toaster(), isSelected, themeOptions, ThemeSettings(), getToastStyles(), Z_INDEX, applyTheme() (+2 more)
...
Cohesion: 0.12
Nodes (15): [activeSection, setActiveSection], handleAddSection(), handleDragEnd(), handleExport(), handleSave(), handleSelectTag(), handleUpdateSection(), [importText, setImportText] (+7 more)

### Community 220 - "Community 220"
Cohesion: 0.11
Nodes (17): backdropOpacity, containerRef, [currentSnapPoint, setCurrentSnapPoint], DRAG_CLOSE_THRESHOLD, handleClose, handleDragEnd, height, isBottomSheet (+9 more)
...
Cohesion: 0.11
Nodes (16): [analyzeProgress, setAnalyzeProgress], audio, audioRef, [audioUrl, setAudioUrl], checkCachedAnalysis, chunksRef, interval, [isAnalyzing, setIsAnalyzing] (+8 more)

### Community 232 - "Community 232"
Cohesion: 0.13
Nodes (16): CACHE_VERSION, cacheAudioViaSW(), getCachedAudioBlob(), isAudioCached(), isRegistering, isServiceWorkerSupported(), SW_PATH, swRegistration (+8 more)

### Community 233 - "Community 233"
Cohesion: 0.11
Nodes (12): QuickQueueActions(), HISTORY_STORAGE_KEY, MAX_HISTORY_ITEMS, MIN_LISTEN_DURATION, usePlaybackHistory(), log, QUEUE_STATE_STORAGE_KEY, QUEUE_STORAGE_KEY (+4 more)
...
Cohesion: 0.14
Nodes (16): handleLike(), hapticImpact(), handleToggleExpand(), { activeTrack, isPlaying, playTrack, pauseTrack, addToQueue }, handleAddToQueue(), handleLike(), handlePlay(), handleShare() (+8 more)
...
Cohesion: 0.11
Nodes (16): availableStems, config, [error, setError], FORMAT_OPTIONS, Icon, isSelected, [isTranscribing, setIsTranscribing], MODEL_OPTIONS (+8 more)
...
Cohesion: 0.11
Nodes (16): activeColor, angle, arcLength, centerRef, DISABLED_COLOR, getAngleFromCenter, handlePointerDown, handlePointerMove (+8 more)
...
Cohesion: 0.11
Nodes (15): buildEnglishPrompt(), buildPromptFromChannels(), DURATION_OPTIONS, GENRE_PRESETS, INSTRUMENT_PRESETS, KEY_OPTIONS, MOOD_PRESETS, QUICK_MIX_PRESETS (+7 more)

### Community 247 - "Community 247"
Cohesion: 0.12
Nodes (6): cancelIdleCallback, chunkArray(), getAdaptiveQuality(), getVisibleRange(), isSlowConnection(), processBatched()

### Community 248 - "Community 248"
Cohesion: 0.11
Nodes (15): [activeTab, setActiveTab], [analysisError, setAnalysisError], [analysisStage, setAnalysisStage], audioLevel, [currentStep, setCurrentStep], interval, {
    isAnalyzing,
    isRecording,
    analysisResult,
    recordedAudioUrl,
    ...
    analyzeGuitarRecording,
    clearRecording,
  }, [linkDialogOpen, setLinkDialogOpen] (+7 more)
...
Cohesion: 0.12
Nodes (14): handleCancel(), handleSelect(), Icon, handleSelect(), toggle(), triggerHapticFeedback(), containerRef, handleFullscreen() (+6 more)

### Community 251 - "Community 251"
Cohesion: 0.19
Nodes (15): createTempAnalysisTrack(), deleteTempAnalysisTrack(), invokeMidiTranscription(), uploadAudioForAnalysis(), analyzeAudioFile(), detectBPM(), detectChords(), detectKey() (+7 more)
...
Cohesion: 0.12
Nodes (14): containerRef, [currentTime, setCurrentTime], durationDisplay, fileFormat, fileSize, [isLoading, setIsLoading], [isPlaying, setIsPlaying], [isReady, setIsReady] (+6 more)
...
Cohesion: 0.12
Nodes (15): { audioList, isLoading }, [audioList, setAudioList], audioRef, filteredAudio, filteredList, fullSourceId, handleSelect(), [isLoading, setIsLoading] (+7 more)

### Community 257 - "Community 257"
Cohesion: 0.12
Nodes (11): calculateSimilarity(), handleCreateSimilar, handleExploreMore, handleTrackClick, { hapticFeedback }, { recommendations, isLoading }, { trackEvent }, usePersonalizedRecommendations() (+3 more)

### Community 258 - "Community 258"
Cohesion: 0.13
Nodes (14): deleteSelectedNotes, handleKeyDown(), redo, undo, handleKeyDown(), handlePlayPause, handleSeek, acceptLineSuggestion() (+6 more)

### Community 259 - "Community 259"
Cohesion: 0.12
Nodes (12): [activeAnalysisTab, setActiveAnalysisTab], audio, audioRef, [currentTime, setCurrentTime], displayedChords, [expandedSections, setExpandedSections], handleCopyTags(), isMobile (+4 more)

### Community 260 - "Community 260"
Cohesion: 0.12
Nodes (11): [audioElement, setAudioElement], audioRef, [detailRecording, setDetailRecording], [editingId, setEditingId], [editTitle, setEditTitle], fullSourceId, handleDelete(), { pauseTrack, isPlaying: globalIsPlaying } (+3 more)
...
Cohesion: 0.12
Nodes (12): accountNavItems, adminNavItems, contentNavItems, GenerateSheet, mainNavItems, Sidebar(), SIDEBAR_COLLAPSED_KEY, studioNavItems (+4 more)

### Community 264 - "Community 264"
Cohesion: 0.12
Nodes (15): audio, audioRef, [currentTime, setCurrentTime], duration, handleEnded(), [isLoaded, setIsLoaded], [isLooping, setIsLooping], [isMuted, setIsMuted] (+7 more)
...
Cohesion: 0.15
Nodes (16): hapticNotification(), canDownload, canShare, [copied, setCopied], deepLink, handleCopy(), handleRewardShare(), handleShare() (+8 more)
...
Cohesion: 0.14
Nodes (12): createSunoError(), detectErrorCode(), ERROR_MESSAGES, FAQ_URLS, getRetryDelay(), isRetryableError(), mapSunoError(), SunoError (+4 more)

### Community 270 - "Community 270"
Cohesion: 0.13
Nodes (10): CACHE_TTL, cachedFormat, generateSrcSet(), getOptimizedImageUrl(), getTrackCoverUrl(), imageCache, MAX_CACHE_SIZE, preloadImages() (+2 more)

### Community 271 - "Community 271"
Cohesion: 0.23
Nodes (15): startSpan(), setAIAttributes(), trackAudioExtension(), trackCustomGeneration(), trackInstrumentalGeneration(), trackLyricsGeneration(), trackSectionRegeneration(), trackSimpleGeneration() (+7 more)
...
Cohesion: 0.12
Nodes (16): achievementsToCheck, bonusCredits, { count: purchaseCount }, currentExp, { data: achievement }, { data: referrerCredits }, { data: totalSpent }, ECONOMY (+8 more)

### Community 274 - "Community 274"
Cohesion: 0.14
Nodes (8): calculateBonusPercent(), calculateGenerationCost(), calculateReferralReward(), DEFAULT_GENERATION_COST, ECONOMY, getGenerationCost(), MODEL_COSTS, starsToCredits()
...
Cohesion: 0.12
Nodes (16): afterTime, beforeTime, eightDaysAgo, entry, entry1, entry2, entry25, getPromise (+8 more)

### Community 277 - "Community 277"
Cohesion: 0.12
Nodes (3): focusRingClasses, generateA11yId(), getContrastRatio()

### Community 278 - "Community 278"
Cohesion: 0.12
Nodes (15): analyserDisconnectSpy, closeSpy, ctx, ctx1, ctx2, element1, element2, err (+7 more)

### Community 279 - "Community 279"
Cohesion: 0.13
Nodes (14): [audioFile, setAudioFile], audioRef, [audioUrl, setAudioUrl], chunksRef, currentStepIndex, handleConfirm(), handleRemove(), { hasSeenHint, markAsSeen } (+6 more)
...
Cohesion: 0.12
Nodes (15): { createProject, isCreating }, [genre, setGenre], handleCreate(), Icon, isCustomValid, isTemplateValid, isValid, [mode, setMode] (+7 more)
...
Cohesion: 0.12
Nodes (15): { addTrack, addClip, currentProject }, [audio], [customPrompt, setCustomPrompt], { data: analysis, isLoading: isAnalyzing, refetch: reanalyze }, [duration, setDuration], fullSourceId, [generatedUrl, setGeneratedUrl], generateMutation (+7 more)
...
Cohesion: 0.12
Nodes (14): ACCEPTED_TYPES, completedCount, [files, setFiles], handleFileSelect, inputRef, [isUploading, setIsUploading], { logAction }, MAX_FILE_SIZE (+6 more)
...
Cohesion: 0.12
Nodes (15): { data: allVersions }, { data: deletedTasks, error: tasksError }, { data: deletedTracks, error: tracksError }, { data: existingTracks }, { data: rateLimitCleanup, error: rateLimitError }, { data: staleTasks }, { data: stuckCleanup, error: stuckError }, { data: versionCleanup, error: versionCleanupError } (+7 more)
...
Cohesion: 0.13
Nodes (14): containerRef, [currentTime, setCurrentTime], [duration, setDuration], [isLoading, setIsLoading], [isPlaying, setIsPlaying], [isReady, setIsReady], mounted, { pauseTrack, isPlaying: globalIsPlaying } (+6 more)

### Community 313 - "Community 313"
Cohesion: 0.13
Nodes (12): allSelected, colorClass, Icon, {
    isProcessing,
    progress,
    status,
    results,
    ...
    isStarting,
    isCancelling,
  }, result, selected, [separateMode, setSeparateMode], someSelected (+4 more)
...
Cohesion: 0.14
Nodes (11): AUDIO_ERROR_MESSAGES, GlobalAudioProvider(), log, useOptimizedAudioPlayer(), log, MAX_AGE_DAYS, MAX_STORED_POSITIONS, MIN_SAVE_POSITION (+3 more)
...
Nodes (11): config, { 
    ...
    wasDismissed,
    isPaused,
  }, decrement, DEFAULT_ANNOUNCEMENTS, { hapticFeedback }, Icon, interval, [progress, setProgress] (+3 more)

### Community 323 - "Community 323"
Cohesion: 0.15
Nodes (14): handleStopRecording(), activeSlots, gradientColors, handleInitialize(), handlePlay(), handleRecord(), handleUseAsReference(), haptic (+6 more)
...
Cohesion: 0.14
Nodes (9): [isActivating, setIsActivating], [isDismissed, setIsDismissed], { isEligible, trialDays, isLoading }, navigate(), queryClient, { user }, getGlobalNavigate(), globalNavigate (+1 more)
...
Cohesion: 0.13
Nodes (13): bars, containerRef, [dragStartX, setDragStartX], endPercent, getTimeFromPosition, handleContainerClick, handleDragStart, handleMove() (+5 more)
...
Cohesion: 0.14
Nodes (13): completed, [currentStep, setCurrentStep], handleComplete(), handleNext(), handleSkip(), Icon, isLastStep, ONBOARDING_STEPS (+5 more)

### Community 332 - "Community 332"
Cohesion: 0.13
Nodes (14): activeTracksCount, bitrateOptions, [format, setFormat], formatOptions, handleCancelExport, handleExport(), { isExporting, exportProgress, exportMix, cancelExport, downloadBlob }, isMobile (+6 more)
...
Cohesion: 0.14
Nodes (8): composedLogger, useUnifiedStudioStore, UnifiedStudioPage(), useAutoSave(), useProjectTrackSync(), useStudioProject(), useStudioStemSync(), useUnifiedStudio()

### Community 336 - "Community 336"
Cohesion: 0.13
Nodes (12): clearRemixData(), getRemixData(), REMIX_DATA_KEY, setRemixData(), canRemix, [generateOpen, setGenerateOpen], handleRemixClick(), canRemix (+4 more)
...
Cohesion: 0.13
Nodes (14): audioRef, cancelAnimationFrameSpy, i, initialRenderCount, mockAudio, mockError, onEnded, playResult (+6 more)
...
Cohesion: 0.32
Nodes (13): checkContrastRatio(), adjustColorForContrast(), colors, darkenColor(), getAccessibleTextColor(), getContrastRatio(), getLuminance(), getWcagRating() (+5 more)
...
Cohesion: 0.14
Nodes (13): { data: stems, isLoading: stemsLoading, refetch: refetchStems }, [generationProgress, setGenerationProgress], genreTags, handleSeparateFirst(), hasVocalStem, [isGenerating, setIsGenerating], isMobile, moodTags (+5 more)
...
Cohesion: 0.14
Nodes (12): cleanupIfNeeded(), skipIfNoPlayer(), cb, closeBtn, ensureMounted(), expandZone, fs, fsBox (+4 more)
...
Cohesion: 0.16
Nodes (12): [currentStep, setCurrentStep], handleComplete(), handleNext(), handleSkip(), { hapticFeedback }, [isVisible, setIsVisible], progress, shouldShow (+4 more)
...
Cohesion: 0.16
Nodes (11): PaywallContext, PaywallProvider(), SESSION_KEY, COOLDOWN_MS, getLastShownAt(), HARD_TRIGGER_GENERATIONS, setLastShownAt(), SOFT_TRIGGER_GENERATIONS (+3 more)
...
Cohesion: 0.14
Nodes (12): ENGINE_MODEL_NAMES, [error, setError], hasFiles, [isTranscribing, setIsTranscribing], klangioModels, log, [progress, setProgress], [progressPercent, setProgressPercent] (+4 more)
...
Cohesion: 0.14
Nodes (13): { addTrack, addClip, currentProject }, [audio], [duration, setDuration], fullSourceId, [generatedUrl, setGeneratedUrl], generateMutation, handleAddToTimeline(), handleGenerate() (+5 more)
...
Cohesion: 0.14
Nodes (13): duration, handlePlayPause, handleSeek, handleSkipBack, handleSkipForward, handleStop, handleVolumeChange, haptic (+5 more)
...
Cohesion: 0.21
Nodes (13): ASSIGNMENTS_KEY, assignToExperiment(), clearAssignments(), EXPERIMENTS, getExperimentAssignments(), getVariant(), isControl(), isInVariant() (+5 more)
...
Cohesion: 0.20
Nodes (13): BLURHASH_COMPONENTS_X, BLURHASH_COMPONENTS_Y, BLURHASH_SAMPLE_SIZE, extractDominantColorSimple(), generateBlurhashFromBuffer(), generateSimpleBlurhash(), generateStorageTransformUrls(), generateThumbnails() (+5 more)

### Community 389 - "Community 389"
Cohesion: 0.25
Nodes (4): ChildLogger, createLogger(), logger, serializeError()

### Community 390 - "Community 390"
Cohesion: 0.14
Nodes (13): avgFPS, benchmarkResult, fpsSamples, height, i, maxScrolls, measureFrame(), result (+5 more)

### Community 391 - "Community 391"
Cohesion: 0.17
Nodes (13): UI Improvements Data Model, UI Improvements Implementation Plan, UI Improvements Requirements Checklist, UI Improvements Research, UI Improvements Specification, UI Improvements Tasks (47 tasks), Component Refactoring (sub-500 lines), Design Tokens (color, z-index, spacing) (+5 more)

### Community 392 - "Community 392"
Cohesion: 0.18
Nodes (11): isUnified, normalized, stats, unified, Rewards, referralKeys, useApplyReferralCode(), useReferralLink() (+3 more)

### Community 393 - "Community 393"
Cohesion: 0.17
Nodes (8): stopRecording(), stopRecording(), stopRecording(), stopRecording(), handleStopRecording(), handleStopRecording(), createClickSound(), MemoryTracker
...
Cohesion: 0.15
Nodes (12): getAudioCacheSize(), allCached, [cacheSize, setCacheSize], checkAvailability(), formatBytes(), handlePrecache(), interval, { isOnline, isOfflineCapable, checkOfflineAvailability } (+4 more)
...
Cohesion: 0.15
Nodes (12): { audioList, isLoading }, audioRef, displayList, fullSourceId, handleSelect(), [isExpanded, setIsExpanded], isPlaying, isSelected (+4 more)

### Community 400 - "Community 400"
Cohesion: 0.15
Nodes (11): contentRef, element, [isExpanded, setIsExpanded], [isOpen, setIsOpen], lineHeight, maxHeight, [needsExpansion, setNeedsExpansion], newIds (+3 more)
...
Cohesion: 0.15
Nodes (11): [dismissed, setDismissed], DRAFT_EXPIRY_MS, DRAFT_KEY, [draft, setDraft], handleDismiss(), { hapticFeedback }, parsed, preview (+3 more)
...
Cohesion: 0.15
Nodes (10): BASELINE_METRICS, getProgress(), Icon, label, lighthouseScores, [metrics], progress, status (+2 more)
...
Cohesion: 0.15
Nodes (11): handlePrev(), [currentStep, setCurrentStep], { hapticFeedback }, Icon, isLastStep, nextStep, prevStep(), progress (+3 more)
...
Cohesion: 0.15
Nodes (9): [completedSections, setCompletedSections], [currentStep, setCurrentStep], handleExport, hasLyrics, hasMidi, hasNotation, [isExporting, setIsExporting], [options, setOptions] (+1 more)

### Community 418 - "Community 418"
Cohesion: 0.15
Nodes (11): animationRef, audio, audioRef, isActive, [isPlaying, setIsPlaying], isPreviewing, letter, [progress, setProgress] (+3 more)
...
Cohesion: 0.15
Nodes (4): createFallbackSections(), useFallbackSections(), useStemSeparation(), useStudioCallbacks()

### Community 425 - "Community 425"
Cohesion: 0.15
Nodes (12): ALERT_COOLDOWNS, ALERT_PRIORITIES, LAST_ALERT_KEY, MAX_ALERTS_ON_PAGE_LOAD, MAX_ALERTS_PER_SESSION, MIN_ALERT_INTERVAL, QUIET_ROUTES, SECTION_LABELS (+4 more)
...
Cohesion: 0.23
Nodes (10): cleanupRegistry(), DEDUP_WINDOW_MS, displayError(), errorRegistry, generateFingerprint(), getErrorTitle(), reportError(), sendToSentry() (+2 more)
...
Cohesion: 0.15
Nodes (8): formatRemainingTime(), calculateProgress(), formatDuration, formatTime, formatTimePrecise, parseTimeToSeconds(), formatDurationValue(), formatDuration()
...
Cohesion: 0.17
Nodes (8): handleApply(), containerVariants, { data: lyricsData }, detectedSections, handleClose(), itemVariants, {
    startTime,
    endTime,
    sectionDuration,
    maxDuration,
...
Cohesion: 0.20
Nodes (11): Alert, AlertDescription, AlertTitle, alertVariants, handleCancel(), handleConfirm(), Icon, [isConfirming, setIsConfirming] (+3 more)
...
Cohesion: 0.17
Nodes (6): useStudioAudioEngine(), useStudioAudioSetup(), DEFAULT_EFFECTS, useStudioEffectsEngine(), useStudioMixer(), useStudioPlayer()
...
Cohesion: 0.21
Nodes (3): AudioBufferPool, bufferPoolInstance, DEFAULT_CONFIG
...
Cohesion: 0.17
Nodes (10): { activeTrack, isPlaying, playTrack, pauseTrack, addToQueue }, coverUrl, duration, handleAddToQueue(), handleShare(), hasHD, isCurrentTrack, isTrackPlaying (+2 more)
...
Cohesion: 0.17
Nodes (10): buttonVariant, container, Icon, iconSizes, { impact }, isMobile, scrollRef, [showLeftFade, setShowLeftFade] (+2 more)
...
Cohesion: 0.17
Nodes (9): [addVocalsOpen, setAddVocalsOpen], audio, audioRef, [currentTime, setCurrentTime], displayedChords, handleCopyTags(), [isPlaying, setIsPlaying], [showAllChords, setShowAllChords] (+1 more)
...
Cohesion: 0.17
Nodes (10): [activeTab, setActiveTab], appleMusicUrl, artworkUrl, [audioUrl, setAudioUrl], fileInputRef, handleUrlRecognize(), isMobile, {
    isRecognizing,
    isRecording,
    result,
    recognizeFromUrl,
...
Cohesion: 0.17
Nodes (7): componentDidCatch(), componentWillUnmount(), context, { error, errorType, retryCount }, log, reason, Tone
...
Cohesion: 0.17
Nodes (10): handleClick(), iconSizes, isDisabled, sizeStyles, variantStyles, actions, availableActions, [isExpanded, setIsExpanded] (+2 more)
...
Cohesion: 0.17
Nodes (10): ActionIcon, Container, containerProps, description, Icon, preset, presets, sizeClasses (+2 more)

### Community 486 - "Community 486"
Cohesion: 0.17
Nodes (9): AudioHubRecorder, AudioHubUploader, AudioRecordDialog, GuitarRecordDialog, LyricsAIChatAgent, MusicLab(), PromptDJMixer, RealtimeChordVisualizer (+1 more)
...
Cohesion: 0.17
Nodes (10): creditPackages, { data: products, isLoading, error }, handler(), { isAdmin, isLoading: roleLoading }, [purchasingProduct, setPurchasingProduct], queryClient, subscriptions, { user } (+2 more)
...
Cohesion: 0.18
Nodes (10): trapFocus(), componentDidMount(), checkAllLoaded(), handleKeyDown(), handleSeek, handleSkip(), loadStemAsync(), storePause (+2 more)
...
Cohesion: 0.18
Nodes (9): [activeTab, setActiveTab], [advancedSettings, setAdvancedSettings], isProcessing, [loading, setLoading], [lyrics, setLyrics], [negativeTags, setNegativeTags], progress, [style, setStyle] (+1 more)
...
Cohesion: 0.22
Nodes (9): { createPlaylist, isCreating }, [description, setDescription], handleSubmit(), { hapticFeedback }, [isPublic, setIsPublic], [title, setTitle], addTrackToPlaylist(), createPlaylist() (+1 more)
...
Cohesion: 0.18
Nodes (10): { apiBalance }, apiCredits, coverageRatio, { data: summary, isLoading: summaryLoading }, { data: users, isLoading: usersLoading, refetch }, exportUsers(), filteredUsers, [orderBy, setOrderBy] (+2 more)
...
Cohesion: 0.20
Nodes (9): EDIT_LYRICS_ACTIONS, handleAction(), { hapticFeedback }, Icon, navigate, NEW_LYRICS_ACTIONS, quickActions, { unreadCount } (+1 more)

### Community 528 - "Community 528"
Cohesion: 0.20
Nodes (10): handleNext(), handleSkip(), handleTryNow(), { 
    isActive, 
    currentStep, 
    nextStep, 
    prevStep, 
    ...
    completeOnboarding,
    goToStep
  }, isFirstStep, isLastStep, navigate, progress (+2 more)
...
Cohesion: 0.18
Nodes (8): audioRef, { data: mainTrack }, { data: versions, isLoading }, { 
    isProcessing, 
    createVersionFromTrack, 
    setVersionAsPrimary, 
    deleteVersion 
  }, meta, { pauseTrack, isPlaying: globalIsPlaying }, [playingId, setPlayingId], sourceId
...
Cohesion: 0.22
Nodes (8): getStoredTheme(), getSystemTheme(), getTelegramTheme(), hexToHsl(), resolveTheme(), THEME_STORAGE_KEY, ThemeContext, themeLogger

### Community 545 - "Community 545"
Cohesion: 0.27
Nodes (8): DEFAULT_FLAGS, featureFlagsCache, getFeatureFlags(), getUserIdForRollout(), isFeatureEnabled(), loadFeatureFlagsFromEnv(), logFeatureFlags(), simpleHash()

### Community 546 - "Community 546"
Cohesion: 0.36
Nodes (9): calculateGapScore(), extractLyricsForTimeRange(), findBestEndPosition(), findBestStartPosition(), fuzzyWordMatch(), levenshteinDistance(), matchSectionToWords(), normalizeForMatching() (+1 more)
...
Cohesion: 0.22
Nodes (6): calculateStatistics(), measureLoadTime(), measureMemory(), runBenchmark(), runBenchmarkSuite(), withRenderCount()

### Community 555 - "Community 555"
Cohesion: 0.18
Nodes (10): defaultProps, element, initialRender, mockLine, onClick1, onClick2, onDoubleClick, { rerender } (+2 more)
...
Cohesion: 0.31
Nodes (8): subscribeToBatchUpdates(), fetchGenerationStats(), getInterval(), subscribeToGenerationLogs(), subscribeToPresetUpdates(), subscribeToUserPresets(), subscribeToGenerationTask(), channel
...
Cohesion: 0.20
Nodes (9): CheckIcon, checkIcons, { data: health, isLoading, refetch, isFetching }, [isSendingAlert, setIsSendingAlert], OverallIcon, statusBgColors, statusColors, StatusIcon (+1 more)
...
Cohesion: 0.20
Nodes (7): calculateForecast(), { data: paymentData, isLoading }, FORECAST_PERIODS, { forecast, trend, growthRate, projectedTotal, confidence }, [forecastDays, setForecastDays], projectionStartDate, projectionStartIndex
...
Nodes (8): audio, audioRef, {
    ...
    clearRecording,
  }, isMobile, [isPlaying, setIsPlaying], [open, setOpen], { pauseTrack, isPlaying: globalIsPlaying }, sourceId
...
Cohesion: 0.20
Nodes (9): Icon, [iconIndex, setIconIndex], ICONS, interval, [progress, setProgress], startTime, STATUS_MESSAGES, [statusMessage, setStatusMessage] (+1 more)
...
Cohesion: 0.20
Nodes (8): convertDateFnsFormat(), format(), formatDate(), formatRubles(), PricingCard(), formatCurrency(), easingFunctions, useSmoothCounter()
...
Cohesion: 0.20
Nodes (9): frame(), confettiTimer, fireConfetti(), Icon, info, [showContent, setShowContent], TIER_INFO, timer (+1 more)
...
Cohesion: 0.20
Nodes (6): MixPresetsMenu(), defaultMixPresets, getStoredPresets(), savePresets(), STORAGE_KEY, useMixPresets()
...
Nodes (9): {
    ...
    resetChords,
    resetBeats,
  }, [extendedChords, setExtendedChords], handleDetectBeats, handleDetectChords, handleSaveAll, hasSaveableResults, isLoading, [isOpen, setIsOpen] (+1 more)
...
Cohesion: 0.20
Nodes (7): [analysis, setAnalysis], [analyzing, setAnalyzing], [copiedIndex, setCopiedIndex], handleCopyPart(), [optimizedPrompt, setOptimizedPrompt], [optimizing, setOptimizing], [prompt, setPrompt]

### Community 620 - "Community 620"
Cohesion: 0.20
Nodes (4): QualityActions(), getVisibleActions(), isActionAvailable(), audio
...
Cohesion: 0.20
Nodes (8): backdrop, hardware, imageOverlay(), interactive, media, overlayText, pill, surface
...
Cohesion: 0.20
Nodes (8): BOOT_LOG, bootLog(), error, errorMsg, mainLogger, root, rootElement, updateKeyboardHeight()
...
Cohesion: 0.31
Nodes (8): getDashboardData(), getGreeting(), getStreakEmoji(), getTierEmoji(), handleDashboard(), supabase, handleQuickActionsCallbacks(), handleStart()

### Community 634 - "Community 634"
Cohesion: 0.29
Nodes (8): checkRateLimitDb(), checkRateLimitFallback(), fallbackCache, getRateLimitInfo(), isRateLimited(), now, RateLimitConfigs, rateLimitStore
...
Cohesion: 0.31
Nodes (6): closeStudioContext(), createAudioContext(), getAudioContextClass(), getOrCreateStudioContext(), safeCloseAudioContext(), studioAudioContext

### Community 646 - "Community 646"
Cohesion: 0.22
Nodes (6): MockAudioElement, initWavesurfer(), initWavesurfer(), handlePlay(), init(), init()

### Community 647 - "Community 647"
Cohesion: 0.22
Nodes (7): [addVocalsDialogOpen, setAddVocalsDialogOpen], [analysisProgress, setAnalysisProgress], [editedLyrics, setEditedLyrics], [isAnalyzing, setIsAnalyzing], [isEditingLyrics, setIsEditingLyrics], [isSaving, setIsSaving], { updateAnalysis }

### Community 648 - "Community 648"
Cohesion: 0.25
Nodes (7): actions, handleAction(), navigate, onClick, handleClick(), handleClick(), handleAction()
...
Cohesion: 0.25
Nodes (5): DEFAULT_SHORTCUTS, getShortcuts(), resetShortcuts(), updateShortcuts(), validateShortcutsConfig()

### Community 660 - "Community 660"
Cohesion: 0.22
Nodes (8): COLORS, { data: dailyStats }, { data: stats, isLoading: statsLoading, refetch }, { data: topUsers }, [days, setDays], modelSuccessRate, successRate, TIME_PERIODS
...
Cohesion: 0.22
Nodes (6): COLORS, { data: gamificationData, isLoading: gamificationLoading }, { data: paymentData, isLoading: paymentLoading, refetch: refetchPayment }, formatCurrency(), isLoading, [period, setPeriod]
...
Cohesion: 0.22
Nodes (8): containerRef, [isLoading, setIsLoading], [isReady, setIsReady], lastSeekRef, mounted, progress, timeSinceSeek, wavesurferRef
...
Cohesion: 0.22
Nodes (8): analysisResult, { analyzeGuitarRecording, progress, progressPercent }, audioRef, hasAnalysis, [isPlaying, setIsPlaying], [isReanalyzing, setIsReanalyzing], [reanalysisProgress, setReanalysisProgress], { saveRecording, toAnalysisResult }
...
Cohesion: 0.22
Nodes (4): Icon, score, SECTION_CONFIG, sectionData
...
Cohesion: 0.25
Nodes (8): handleOpen(), handleSelect(), [open, setOpen], { patterns }, selectedOption, handleNotificationClick(), handleComplete(), setOpen

### Community 677 - "Community 677"
Cohesion: 0.22
Nodes (5): blur, handleCancel(), inputRef, [isFocused, setIsFocused], { patterns }
...
Cohesion: 0.22
Nodes (8): duration, generateWaveformData(), isPlayed, [playProgress, setPlayProgress], progressRef, start, update(), [waveform]
...
Cohesion: 0.22
Nodes (7): config, isActive, isSelected, panelVariants, QuickCompare(), VERSION_CONFIG, useStudioAudio()
...
Cohesion: 0.22
Nodes (8): canPlayFromHere, contextData, handleAddToQueue(), handlePlayFromHere(), handlePlayNext(), { playNext, addTrack, queue, playFromIndex }, trackIndex, trackList
...
Cohesion: 0.22
Nodes (8): displayCount, [open, setOpen], positionClasses, showBadge, sizeClasses, statusColors, { unreadCount }, variantClasses
...
Cohesion: 0.31
Nodes (8): commonShortcuts, getRegisteredShortcuts(), globalRegistry, matchesKeyCombo(), parseKeyCombo(), useKeyboardShortcuts(), usePlayerShortcuts(), useStudioKeyboardShortcuts()
...
Cohesion: 0.28
Nodes (5): average(), fetchRUMMetricsSummary(), getSessionId(), metricsStore, parseInterval()
...
Cohesion: 0.28
Nodes (7): createPayment(), fromStarsProduct(), getProduct(), getRecommendedGateway(), isStarsAvailable(), log, createInvoice()
...
Cohesion: 0.25
Nodes (7): ACHIEVEMENT_ICONS, { data: achievements }, { data: userAchievements }, { data: userCredits }, IconComponent, nearAchievements, { user }
...
Cohesion: 0.25
Nodes (7): DURATION_PRESETS, [expiresAt, setExpiresAt], handlePresetClick(), [isLoading, setIsLoading], [reason, setReason], SUBSCRIPTION_TIERS, [tier, setTier]
...
Cohesion: 0.29
Nodes (5): StorageError, getRecoveryAction(), showErrorWithRecovery(), useAsyncWithRecovery(), useErrorRecovery()
...
Cohesion: 0.29
Nodes (5): CHORD_TEMPLATES, computeChromagram(), cosineSimilarity(), detectChord(), NOTE_NAMES
...
Nodes (7): charPercentage, {
    ...
    isGenerating,
    setIsGenerating,
  }, copyToClipboard(), finalLyrics, highlightedLyrics, MAX_LYRICS_LENGTH, sanitizeConfig
...
Cohesion: 0.25
Nodes (6): completed, resetOnboarding(), [showOnboarding, setShowOnboarding], steps, STORAGE_KEY, timer
...
Cohesion: 0.25
Nodes (3): useTrackVersions(), useVersionSwitcher(), VersionComparison()

### Community 754 - "Community 754"
Cohesion: 0.25
Nodes (7): canShare, [copied, setCopied], deepLink, handleShare(), [loading, setLoading], [shareUrl, setShareUrl], { webApp }
...
Cohesion: 0.25
Nodes (7): availableFormats, FILE_FORMATS, handleDownload(), handleOpen(), isSending, [sendingFile, setSendingFile], url
...
Cohesion: 0.25
Nodes (5): handleMasterMute(), handlePlayPause(), handleProgressClick(), haptic, progress
...
Cohesion: 0.25
Nodes (7): [copied, setCopied], hiddenCount, openFullLyrics(), parsed, SECTION_COLORS, [sheetOpen, setSheetOpen], visibleSections
...
Nodes (7): { 
    ...
    repeat,
    toggleRepeat
  }, handleSpeedChange(), handleToggleLoop(), isCurrentTrack, isLooping, [playbackSpeed, setPlaybackSpeed], speedOptions

### Community 774 - "Community 774"
Cohesion: 0.25
Nodes (7): [copied, setCopied], displayText, [expanded, setExpanded], isLong, lines, toggleExpand(), truncatedText
...
Cohesion: 0.32
Nodes (7): DESKTOP_AUDIO_LIMIT, detectAudioCapabilities(), detectPlatform(), MOBILE_AUDIO_LIMIT, prioritizeStemsByType(), STEM_PRIORITY, useMobileAudioFallback()
...
Cohesion: 0.25
Nodes (5): Library(), log, useLibraryDeepLinks(), log, useLibraryHandlers()
...
Cohesion: 0.52
Nodes (6): canPlayAudioFormat(), detectMobileBrowser(), getAudioFormatFromUrl(), getBrowserAudioSupport(), isAudioFormatSupported(), logAudioDiagnostics()
...
Cohesion: 0.29
Nodes (3): LikeButton(), LikeButton(), useLikeTrack()
...
Cohesion: 0.29
Nodes (4): audioEventListeners, emitAudioStateChange(), registerStudioAudio(), studioAudioSources
...
Cohesion: 0.29
Nodes (5): createTimer(), debugLog(), debugWarn(), getChangedKeys(), useRenderTime()

### Community 863 - "Community 863"
Cohesion: 0.29
Nodes (6): createGlass(), getGlass(), glass, glassButton, glassSurface, gradientGlass

### Community 864 - "Community 864"
Cohesion: 0.38
Nodes (6): HAPTIC_GUIDE, hapticSelectionChanged(), isHapticAvailable(), isHapticSupported(), MIN_HAPTIC_VERSION, smartHaptic()

### Community 865 - "Community 865"
Cohesion: 0.29
Nodes (3): formatBytes(), getFileUrl(), STORAGE_BUCKETS
...
Cohesion: 0.57
Nodes (6): createQuickGenConfirmKeyboard(), getPresetById(), handleConfirmQuickGen(), handleQuickActionsCallback(), handleQuickGenPreset(), QUICK_PRESETS
...
Cohesion: 0.33
Nodes (5): challenges, { data: stats, isLoading }, isCompleted, progress, { user }
...
Cohesion: 0.33
Nodes (3): paddingMap, PageContainer(), sectionSpacing
...
Cohesion: 0.40
Nodes (4): QUICK_PRESETS, QuickStartOverlay(), useUserJourneyState(), useUserJourneyStore
...
Cohesion: 0.40
Nodes (5): [copied, setCopied], handleOpenTelegram(), [open, setOpen], triggerHapticFeedback(), { webApp, hapticFeedback }
...
Cohesion: 0.33
Nodes (4): hasMultipleOptions, [isSharing, setIsSharing], { shareToStory }, trackLink
...
Cohesion: 0.33
Nodes (5): Display, Heading, Prose, Text, variantClasses
...
Cohesion: 0.33
Nodes (5): BUFFER_HEALTH_THRESHOLDS, log, STALL_DETECTION_INTERVAL, STALL_THRESHOLD, useBufferMonitor()
...
Cohesion: 0.33
Nodes (3): useAudioUpscale(), useTrackActionsState(), useVideoGenerationStatus()
...
Cohesion: 0.33
Nodes (5): button, mockClearError, mockCreateInvoice, mockOpenInvoice, retryButton
...
Cohesion: 0.40
Nodes (3): AuthContext, authLogger, timeoutWarningLogged
...
Cohesion: 0.40
Nodes (4): { concept, setTheme, setGenre, setMood, setLanguage }, generateThemeIdea(), [isGeneratingTheme, setIsGeneratingTheme], toggleMood()
...
Cohesion: 0.40
Nodes (4): AUTO_SCROLL_RESUME_DELAY, PROGRAMMATIC_SCROLL_RESET_DELAY, useLyricsChat(), USER_SCROLL_THRESHOLD
...
Cohesion: 0.40
Nodes (3): KeyboardShortcutsProvider(), ShortcutsContext, ShortcutsHelpContent()
...
Cohesion: 0.40
Nodes (4): gridClass, staggerDelay, style, TrackCardSkeleton
...
Cohesion: 0.40
Nodes (4): log, RADIO_FETCH_LIMIT, TRACKS_THRESHOLD, useRadioMode()
...
Cohesion: 0.40
Nodes (3): PlayerTestComponent(), state, user
...
Cohesion: 0.50
Nodes (3): chordNotes, hasValidChord, NOTE_LABELS
...
Cohesion: 0.50
Nodes (3): handleClick(), handleMoreClick(), { patterns }
...
Cohesion: 0.50
Nodes (3): stemColors, StemLoadingProgress, StemTrackLoadingSkeleton
...
Cohesion: 0.50
Nodes (3): audioTracks, exportTracks, {
    isMobile,
    projectId,
    projectName,
    sourceTrackId,
...
Cohesion: 0.50
Nodes (3): changeTypeIcons, changeTypeLabels, useLyricsVersioning()
...
Cohesion: 0.50
Nodes (3): log, STATUS_CONFIG, useProjectGenerationTracking()
...
Cohesion: 0.67
Nodes (3): handleTimeUpdate(), handleTimeUpdate(), onTimeUpdate

### Community 1206 - "Community 1206"
Cohesion: 0.67
Nodes (3): Defense in Depth Security Model, Security Checklist, Security Operations Guide

### Community 1207 - "Community 1207"
Cohesion: 0.67
Nodes (3): Exponential Backoff Retry Logic, Model Fallback Chain (V5 to V3.5), Sprint A: Reliability and Stability

### Community 1208 - "Community 1208"
Cohesion: 0.67
Nodes (3): Git Hygiene Issues (2215+ Changes commits), Repository Audit Report, Stale Branches List

### Community 1339 - "Community 1339"
Cohesion: 0.67
Nodes (3): Architecture Analysis, Layered Architecture Pattern, Zustand over Redux Decision

### Community 1340 - "Community 1340"
Cohesion: 0.67
Nodes (3): handleStartRecording(), handleMicrophoneClick(), startRecording

## Knowledge Gaps
- **10466 isolated node(s):** `config`, `shadows`, `CACHE_NAME`, `MAX_CACHE_SIZE_MB`, `AUDIO_EXTENSIONS` (+10461 more)
...
- **Why does `error` connect `UI Dialogs & Actions` to `API Layer & Data Access`, `Edge Functions Core`, `Bot Analysis Commands`, `Audio Action Handlers`, `Auth & Authorization`, `Bot Commands & Caching`, `Audio Context & Cache`, `Broadcast & Moderation`, `Audio Upload Pipeline`, `Telegram Payments & Config`, `Studio Content & Editing`, `Audio Utils & Features`, `API Logger & Artists`, `Community 548`, `Accessibility & Classifier`, `Community 41`, `Community 557`, `Community 559`, `Community 47`, `Community 51`, `Community 566`, `Community 55`, `Community 1082`, `Community 59`, `Community 67`, `Community 89`, `Community 93`, `Community 94`, `Community 96`, `Community 609`, `Community 100`, `Community 622`, `Community 113`, `Community 119`, `Community 633`, `Community 634`, `Community 122`, `Community 126`, `Community 130`, `Community 646`, `Community 136`, `Community 142`, `Community 143`, `Community 658`, `Community 148`, `Community 154`, `Community 160`, `Community 165`, `Community 170`, `Community 175`, `Community 196`, `Community 710`, `Community 714`, `Community 205`, `Community 219`, `Community 224`, `Community 227`, `Community 230`, `Community 239`, `Community 1263`, `Community 250`, `Community 258`, `Community 267`, `Community 269`, `Community 839`, `Community 336`, `Community 357`, `Community 359`, `Community 376`, `Community 384`, `Community 388`, `Community 900`, `Community 938`, `Community 430`, `Community 436`, `Community 448`, `Community 463`, `Community 979`, `Community 472`, `Community 479`, `Community 483`, `Community 494`, `Community 1525`?**
  _High betweenness centrality (0.125) - this node is a cross-community bridge._
- **Why does `map` connect `API Layer & Data Access` to `UI Dialogs & Actions`, `Community 513`, `Bot Analysis Commands`, `Audio Action Handlers`, `Audio Processing Functions`, `Bot Commands & Caching`, `Audio Context & Cache`, `Community 521`, `Audio Upload Pipeline`, `Telegram Payments & Config`, `MIDI & Klangio Analysis`, `Audio Utils & Features`, `Community 1043`, `API Logger & Artists`, `Community 536`, `Tinkoff Payments`, `Visualizer & Analytics`, `Lyrics Utils & Studio`, `Unified Lyrics View`, `Community 546`, `Community 547`, `Community 1059`, `Accessibility & Classifier`, `Community 1061`, `Lyrics Studio Page`, `Track Naming & Metadata`, `Community 47`, `Community 49`, `Community 1074`, `Community 567`, `Community 55`, `Community 60`, `Community 61`, `Community 574`, `Community 63`, `Community 579`, `Community 78`, `Community 80`, `Community 81`, `Community 87`, `Community 88`, `Community 92`, `Community 93`, `Community 96`, `Community 116`, `Community 121`, `Community 125`, `Community 126`, `Community 641`, `Community 1153`, `Community 136`, `Community 138`, `Community 654`, `Community 142`, `Community 147`, `Community 664`, `Community 154`, `Community 155`, `Community 156`, `Community 1187`, `Community 165`, `Community 182`, `Community 187`, `Community 706`, `Community 198`, `Community 710`, `Community 1229`, `Community 213`, `Community 219`, `Community 221`, `Community 230`, `Community 749`, `Community 240`, `Community 246`, `Community 247`, `Community 251`, `Community 257`, `Community 270`, `Community 799`, `Community 854`, `Community 347`, `Community 859`, `Community 349`, `Community 866`, `Community 868`, `Community 363`, `Community 894`, `Community 384`, `Community 390`, `Community 393`, `Community 409`, `Community 433`, `Community 434`, `Community 449`, `Community 965`, `Community 453`, `Community 984`, `Community 1005`, `Community 1009`, `Community 503`, `Community 505`, `Community 509`?**
  _High betweenness centrality (0.064) - this node is a cross-community bridge._
- **Why does `max` connect `Visualizer & Analytics` to `Community 384`, `UI Dialogs & Actions`, `Community 258`, `Bot Analysis Commands`, `Audio Processing Functions`, `Bot Commands & Caching`, `Audio Context & Cache`, `Broadcast & Moderation`, `Community 140`, `Audio Upload Pipeline`, `Community 654`, `Community 393`, `Community 142`, `Community 147`, `Community 404`, `Community 277`, `Community 280`, `Stars & Rewards`, `Lyrics Utils & Studio`, `Community 544`, `Waveform Timeline`, `Community 546`, `Accessibility & Classifier`, `Community 550`, `Community 40`, `Community 169`, `Community 686`, `Community 433`, `Community 53`, `Community 56`, `Community 186`, `Community 63`, `Community 579`, `Community 324`, `Community 329`, `Community 976`, `Community 209`, `Community 507`, `Community 213`, `Community 982`, `Community 729`, `Community 347`, `Community 247`, `Community 221`, `Community 93`, `Community 95`, `Community 96`, `Community 97`, `Community 867`, `Community 101`, `Community 106`, `Community 494`, `Community 243`, `Community 116`, `Community 631`, `Community 634`, `Community 251`, `Community 767`?**
  _High betweenness centrality (0.054) - this node is a cross-community bridge._
- **Are the 524 inferred relationships involving `error` (e.g. with `runAccessibilityAudit()` and `clearActiveMenu()`) actually correct?**
  _`error` has 524 INFERRED edges - model-reasoned connections that need verification._
- **Are the 448 inferred relationships involving `from` (e.g. with `clearActiveMenu()` and `getActiveMenuMessageId()`) actually correct?**
  _`from` has 448 INFERRED edges - model-reasoned connections that need verification._
- **Are the 318 inferred relationships involving `Select` (e.g. with `switchVersion()` and `getActiveMenuMessageId()`) actually correct?**
  _`Select` has 318 INFERRED edges - model-reasoned connections that need verification._
- **Are the 267 inferred relationships involving `map` (e.g. with `runAccessibilityAudit()` and `fetchUsersWithBalances()`) actually correct?**
  _`map` has 267 INFERRED edges - model-reasoned connections that need verification._