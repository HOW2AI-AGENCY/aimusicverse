# Graph Report - D:\.MUSICVERSE\aimusicverse  (2026-07-04)

## Corpus Check
- 2393 files · ~3,008,707 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 17929 nodes · 25128 edges · 1416 communities detected
- Extraction: 77% EXTRACTED · 23% INFERRED · 0% AMBIGUOUS · INFERRED: 5778 edges (avg confidence: 0.8)
...
5. `now` - 215 edges
6. `success` - 151 edges
7. `sendMessage()` - 136 edges
8. `invoke()` - 134 edges
9. `editMessageText()` - 131 edges
10. `useAuth()` - 128 edges
...
- `abs` --calls--> `autoCorrelate()`  [INFERRED]
  D:\.MUSICVERSE\aimusicverse\scripts\clean-cache.mjs → D:\.MUSICVERSE\aimusicverse\src\components\guitar\GuitarTuner.tsx
- `abs` --calls--> `near()`  [INFERRED]
  D:\.MUSICVERSE\aimusicverse\scripts\clean-cache.mjs → D:\.MUSICVERSE\aimusicverse\tests\e2e\generation.dialog-zindex.spec.ts
- `fetchClaimedMissionActions()` --calls--> `like`  [INFERRED]
  D:\.MUSICVERSE\aimusicverse\src\api\credits.api.ts → D:\.MUSICVERSE\aimusicverse\supabase\functions\mcp\index.ts
- `formatMidiMetadata()` --calls--> `round`  [INFERRED]
  D:\.MUSICVERSE\aimusicverse\src\api\midi.api.ts → D:\.MUSICVERSE\aimusicverse\tests\unit\components\lyrics\LyricsVisualEditorCompact.templates.test.tsx
...
Cohesion: 0.0
Nodes (1256): authorize(), getAuthenticatedUser(), isServiceRoleToken(), requireAdmin(), requireAuth(), validateRequest(), corsHeaders, calculateGenerationCost() (+1248 more)
...
Cohesion: 0.0
Nodes (1003): runAccessibilityAudit(), clearActiveMenu(), deleteActiveMenu(), getActiveMenuMessageId(), getMenuState(), handleSubmit(), bulkAwardCredits(), checkAdminRole() (+995 more)

### Community 2 - "Community 2"
_This domain is responsible for managing user interactions related to music preferences and suggestions._
Cohesion: 0.0
Nodes (618): handleFileUpload(), uploadAudioForAnalysis(), COST_TABLE, logApiCall(), cameraInputRef, fileInputRef, generatePortraitMutation, handleFileInputChange() (+610 more)

### Community 3 - "Community 3"
_This domain manages user achievements, icons, and related data for tracking progress and engagement._
Cohesion: 0.0
Nodes (357): AddTrackDialog(), getDefaultTrackName(), AlertDialog(), Rewards, a, active, b, customPool (+349 more)
...
Cohesion: 0.01
Nodes (407): extractJSON(), parseAIResponse(), parseChatResponse(), parseFullAnalysis(), parseLyricsResponse(), parseProducerReview(), AnnouncementContext, announcementLogger (+399 more)

### Community 5 - "Community 5"
_This domain is responsible for managing accessibility features and rhythmic elements in a user interface._
Cohesion: 0.01
Nodes (345): deleteAndSendNewMenu(), deleteAndSendNewMenuPhoto(), logger, sendNotification(), setActiveMenuMessageId(), supabase, detectIntent(), extractMusicStyle() (+337 more)

### Community 6 - "Community 6"
_This domain manages audio playback features, including version control, volume settings, and playback state._
Cohesion: 0.01
Nodes (335): activeAudio, [activeVersion, setActiveVersion], animationRef, currentNewUrl, [currentTime, setCurrentTime], effectiveVolume, handleVariantSwitch(), haptic (+327 more)
...
Cohesion: 0.01
Nodes (242): handleCancel(), handleSelect(), Icon, { addTrack }, [createProjectOpen, setCreateProjectOpen], filteredProjects, handleAddToProject(), [loading, setLoading] (+234 more)
...
Cohesion: 0.01
Nodes (183): checkContrastRatio(), idCounter, useId(), usePrefersReducedMotion(), useReducedMotionConfig(), useAudioElement(), AudioUpscaleButton(), CommentForm() (+175 more)

### Community 9 - "Community 9"
_This domain is responsible for managing user interactions and visual elements within a web application._
Cohesion: 0.01
Nodes (229): gotoIndex(), OVERLAY_SELECTOR, pressHotkey(), ta, toggled, beforeEnd, OVERLAY, phaseResult (+221 more)
...
Cohesion: 0.01
Nodes (174): closeStudioContext(), createAudioContext(), getAudioContextClass(), getOrCreateStudioContext(), safeCloseAudioContext(), studioAudioContext, analyserRef, { analyze: runReferenceAnalysis } (+166 more)
...
Cohesion: 0.01
Nodes (131): formatAsMeasureBeat(), generateGridPositions(), getBeatDuration(), getMeasurePosition(), getNearestGridPosition(), getSubdivisionDuration(), isOnGrid(), snapToGrid() (+123 more)
...
Cohesion: 0.02
Nodes (122): addVocalsMutation, [advancedSettings, setAdvancedSettings], handleSubmit(), [loading, setLoading], [lyrics, setLyrics], [negativeTags, setNegativeTags], progress, [showProgress, setShowProgress] (+114 more)
...
Cohesion: 0.02
Nodes (120): addLyricsTags(), executeAiTool(), generateLyrics(), improveLyrics(), sendAiChatMessage(), handleReset(), handleToggle(), interval (+112 more)
...
Cohesion: 0.02
Nodes (116): ACTION_TYPES, createMutation, EMOJI_OPTIONS, [formData, setFormData], handleChange(), handleImageUpload(), handleSubmit(), isSubmitting (+108 more)
...
Cohesion: 0.02
Nodes (101): changeSubscription, DURATION_PRESETS, [expiresAt, setExpiresAt], handlePresetClick(), isLoading, [reason, setReason], SUBSCRIPTION_TIERS, [tier, setTier] (+93 more)

### Community 16 - "Community 16"
_This domain is responsible for managing UI components, error handling, and data sorting in a user interface._
Cohesion: 0.02
Nodes (90): activeIndex, currentStage, currentStageIndex, [elapsedTime, setElapsedTime], [estimatedTotal, setEstimatedTotal], formatRemainingTime(), GENERATION_STAGES, Icon (+82 more)

### Community 17 - "Community 17"
_This domain is responsible for managing audio contexts and sound effects in a software application._
Cohesion: 0.03
Nodes (49): analysisOptions, { analyze, isAnalyzing, status, currentStep }, handleAnalyze(), [lastAnalyzedType, setLastAnalyzedType], AudioAnalysisService, AudioAnalysisServiceError, [addVocalsDialogOpen, setAddVocalsDialogOpen], [analysisProgress, setAnalysisProgress] (+41 more)

### Community 18 - "Community 18"
_This domain is responsible for managing user actions and navigation within a UI component._
Cohesion: 0.02
Nodes (92): AdminAlerts, AdminBot, AdminBroadcast, AdminDashboard, AdminEconomy, AdminFeedback, AdminLayout, AdminOverview (+84 more)

### Community 19 - "Community 19"
_This domain is responsible for managing audio recording, analysis, and workflow navigation for guitar recordings._
Cohesion: 0.02
Nodes (97): [activeTab, setActiveTab], [analysisError, setAnalysisError], [analysisStage, setAnalysisStage], audioLevel, [currentStep, setCurrentStep], handleSaveRecording(), handleStartRecording(), handleStopRecording() (+89 more)
...
Cohesion: 0.02
Nodes (81): AllVariants, Default, Destructive, meta, Success, Warning, actions, handleAction() (+73 more)

### Community 21 - "Community 21"
_This domain is responsible for managing administrative functions and user interactions within a digital platform._
Cohesion: 0.02
Nodes (79): [customMode, setCustomMode], isMobile, [loading, setLoading], [lyrics, setLyrics], [mood, setMood], moodPresets, [style, setStyle], [title, setTitle] (+71 more)
...
Cohesion: 0.03
Nodes (66): handleNotificationClick(), [open, setOpen], { unreadCount }, handleScan(), { isSupported, isScanning, scanQR }, [open, setOpen], accountNavItems, [accountOpen, setAccountOpen] (+58 more)
...
Cohesion: 0.03
Nodes (44): AdminRoute(), AdminTracks(), AdminUsers(), ContentHubTabs(), LyricsTab, ProjectsTab, tabs, COOLDOWN_HOURS (+36 more)
...
Cohesion: 0.03
Nodes (58): handleApplyOption(), handleClose(), handleGetOptions(), handleTranslate(), [isLoading, setIsLoading], [mode, setMode], [options, setOptions], resetState() (+50 more)
...
Cohesion: 0.03
Nodes (59): { activeReference }, [advancedOpen, setAdvancedOpen], [artistDialogOpen, setArtistDialogOpen], { artists }, [audioActionDialogOpen, setAudioActionDialogOpen], [closeConfirmOpen, setCloseConfirmOpen], form, GenerateFormCustom (+51 more)
...
Cohesion: 0.04
Nodes (42): GenerationWizard(), TWO_STEP_FLOW, INITIAL_DATA, STEPS_ORDER, useGenerationWizardStore, useWizardProgress(), IdeaStep(), QUICK_IDEAS (+34 more)

### Community 28 - "Community 28"
_This domain is responsible for handling audio recording, analysis, and playback functionalities._
Cohesion: 0.04
Nodes (36): focusRingClasses, generateA11yId(), trapFocus(), trapFocus(), CACHE_VERSION, cacheAudioViaSW(), clearAudioCacheViaSW(), getAudioCacheSize() (+28 more)
...
Cohesion: 0.04
Nodes (44): activeTracksCount, bitrateOptions, [format, setFormat], formatOptions, handleCancelExport, handleExport(), { isExporting, exportProgress, exportMix, cancelExport, downloadBlob }, [limiter, setLimiter] (+36 more)
...
Cohesion: 0.04
Nodes (43): computedNotesDuration, currentTime, defaultHeight, duration, effectiveBpm, effectiveMidiUrl, effectiveMusicXmlUrl, handleDownload (+35 more)
...
Cohesion: 0.04
Nodes (39): analysisIntervalRef, [analysisProgress, setAnalysisProgress], [analysisResult, setAnalysisResult], [analysisStep, setAnalysisStep], analyzeAudio(), { analyzeAudio: runAnalyzeAudio, transcribeLyrics: runTranscribeLyrics }, audio, [audioDuration, setAudioDuration] (+31 more)
...
Cohesion: 0.05
Nodes (40): [aiPanelOpen, setAiPanelOpen], enrichedTags, [globalTags, setGlobalTags], handleAddTags, handleBack, handleInsertLyrics, handleLoadTemplate, handleNewDocument (+32 more)
...
Cohesion: 0.06
Nodes (35): addLineBreak, addSection, applyTemplate, changeSectionType, clearSection, color, [currentSections, setCurrentSections], def (+27 more)
...
Cohesion: 0.06
Nodes (35): { activeStems, limitedStems, showFallbackWarning, dismissWarning }, audioEngine, audioTracks, autoSave, context, ctxTrackId, { data: lyricsData }, { data: replacedSectionsData } (+27 more)
...
Cohesion: 0.06
Nodes (31): extractTags(), {
    activeLineIndex,
    activeWordIndex,
    currentTime: syncedTime,
    constants,
  }, activeLineRef, adjusted, { data: lyricsData, isLoading }, el, [flashIndex, setFlashIndex], flashTimerRef (+23 more)
...
Cohesion: 0.07
Nodes (28): { artworkLayoutId }, bottomBase, bottomStyle, { currentTime, duration, buffered, seek }, { gestureHandlers }, handleClose, handleExpand, handleExpandKey (+20 more)
...
Cohesion: 0.07
Nodes (28): active, [audioDuration, setAudioDuration], description, [description, setDescription], { duration: probedDuration }, [file, setFile], [language, setLanguage], lastStepRef (+20 more)
...
Cohesion: 0.07
Nodes (27): { activeTrack, isPlaying, playTrack, pauseTrack }, { data: versions = [], isLoading: loading }, durMin, durSec, handleGoToLibrary, handleGoToStudio, handlePreview, handleSelect (+19 more)
...
Cohesion: 0.08
Nodes (24): activeTrack, aiSuggestBlock, AudioActionDialog, [audioDialogOpen, setAudioDialogOpen], bottomPadding, createBlock, discoverBlock, displayUser (+16 more)
...
Cohesion: 0.09
Nodes (20): autoSelect, { data: groupedProducts, isLoading, error }, displayProducts, featured, getSavingsText(), handleBack(), { isAdmin, isLoading: roleLoading }, isProcessing (+12 more)
...
Cohesion: 0.09
Nodes (21): charCountColor, el, end, handleApplyTemplate, { hapticFeedback }, hasError, Icon, lyricsValidation (+13 more)
...
Cohesion: 0.1
Nodes (18): activeGenCount, { data: activeGenerations = [] }, dismissHint, frame, [generateOpen, setGenerateOpen], GenerateSheet, handleGenerateClick, handleNavigate (+10 more)
...
Cohesion: 0.1
Nodes (13): CHART_COLORS, { data: metrics, isLoading, refetch, isRefetching }, { data: recentFailures, isLoading: failuresLoading }, duration, errorDistribution, formatDuration(), modelStats, PIE_COLORS (+5 more)
...
Cohesion: 0.1
Nodes (18): a, b, baseline, big, copy, EDM, fast, i (+10 more)
...
Cohesion: 0.1
Nodes (15): handleNavigate(), reducedMotion, cover, COVER_GRADIENTS, [deleteId, setDeleteId], { deleteProject, isLoading: isDeleting }, initials, [isLoading, setIsLoading] (+7 more)
...
Cohesion: 0.11
Nodes (17): availableStems, config, [error, setError], FORMAT_OPTIONS, handleTranscribe(), Icon, isSelected, MODEL_OPTIONS (+9 more)
...
Cohesion: 0.11
Nodes (13): chain, fromCalls, innerMock, invalidateSpy, origMock, queryClient, { result }, switchResult (+5 more)
...
Cohesion: 0.12
Nodes (14): [activeTab, setActiveTab], [copied, setCopied], getSectionTypeColor(), handleCopy(), hasNoTags, Icon, info, parsed (+6 more)
...
Cohesion: 0.12
Nodes (16): cn(), config, handleToggle(), haptic, hardwareStems, Icon, [isExpanded, setIsExpanded], [isHardwareMode, setIsHardwareMode] (+8 more)
...
Cohesion: 0.2
Nodes (14): createNotification(), deleteNotificationsByGroup(), log, notifyAchievement(), notifyFeatureAnnouncement(), notifyGenerationComplete(), notifyGenerationFailed(), notifyGenerationProgress() (+6 more)
...
Cohesion: 0.16
Nodes (16): Design System/Colors, MusicVerse AI Color Palette, CSS Variables Theming (light/dark), Design System/Introduction, Design Principles (Consistent / Reusable / Accessible / Efficient), Design System Sections (Design System / UI / Components / Pages), Design System/Typography, Typography Heading Hierarchy (h1-h4) (+8 more)

### Community 173 - "Community 173"
_This domain manages the playback controls and timeline interactions for media looping and navigation._
Cohesion: 0.16
Nodes (14): addInstrumentalMutation, [advancedSettings, setAdvancedSettings], handleOpenStudio(), handleOpenTrack(), handlePlayTrack(), handleSubmit(), instrumentalProgress, loading (+6 more)
...
Cohesion: 0.16
Nodes (13): authenticateWithTelegram(), { enableGuestMode }, handleAuth(), handleGuestMode(), { isAuthenticated, loading, authenticateWithTelegram }, [isAuthenticating, setIsAuthenticating], log, navigate (+5 more)
...
Cohesion: 0.15
Nodes (11): config, getCleanCharCount(), index, newContent, newSection, newSections, SECTION_TYPES, sectionsToLyrics() (+3 more)
...
Cohesion: 0.14
Nodes (11): blob, FailingAudio, file, fromInsertSelectSingleMock, originalAudio, originalFetch, r, ref (+3 more)
...
Cohesion: 0.15
Nodes (11): completedTasks, { data: activeTasks = [] }, [elapsedTime, setElapsedTime], estimatedProgress, failedTasks, interval, latestCompleted, latestFailed (+3 more)
...
Cohesion: 0.18
Nodes (5): calculateBonusPercent(), calculateReferralReward(), ECONOMY, MODEL_COSTS, starsToCredits()

### Community 242 - "Community 242"
_This domain is responsible for managing user interactions and state changes in a graphical user interface._
Cohesion: 0.15
Nodes (10): buildEnglishPrompt(), DURATION_OPTIONS, GENRE_PRESETS, INSTRUMENT_PRESETS, KEY_OPTIONS, MOOD_PRESETS, QUICK_MIX_PRESETS, SCALE_OPTIONS (+2 more)
...
Nodes (11): {
    ...
    isLoading,
    error,
  }, err, { isAdmin, isLoading: roleLoading }, [purchasingProduct, setPurchasingProduct], queryClient, response, result, token (+3 more)
...
Cohesion: 0.15
Nodes (12): avgFPS, benchmarkResult, fpsSamples, height, i, item, maxScrolls, result (+4 more)
...
Cohesion: 0.18
Nodes (10): [duration, setDuration], { generate, isGenerating, sfx, error, reset }, isTerminal, [key, setKey], [model, setModel], preview, [prompt, setPrompt], SFX_KEYS (+2 more)
...
Cohesion: 0.2
Nodes (8): BASE_CONFIG, calls, controller, { getRecommendedSegmentTimes }, originalFetch, out, r, svc
...
Cohesion: 0.22
Nodes (3): GC_TIMES, queryKeys, STALE_TIMES
...
Cohesion: 0.22
Nodes (5): i, makeStore(), s, store, withHistory()
...
Cohesion: 0.25
Nodes (6): [activeTab, setActiveTab], currentArtists, { data: publicArtists }, listContainer, listItem, selected
...
Cohesion: 0.25
Nodes (6): barProgress, handleDownload, isPassed, {
    isPlaying,
    currentTime,
...
Cohesion: 0.43
Nodes (7): andThen(), err(), isErr(), isOk(), map(), mapErr(), ok()
...
Cohesion: 0.25
Nodes (7): Animated, Complete, Default, Empty, Half, meta, WithLabel
...
Cohesion: 0.25
Nodes (5): boosted, boostPromise, { result }, { result, setDescription, setStyle }, { result, setStyle }
...
Cohesion: 0.29
Nodes (5): handlePresetClick, { hapticFeedback }, Icon, navigate, visiblePresets
...
Cohesion: 0.29
Nodes (6): e, failure, invoked, original, r, r2
...
Cohesion: 0.33
Nodes (2): listContainer, listItem
...
Cohesion: 0.33
Nodes (4): helper, mockedUseCustomVoices, pendingVoice, readyVoice
...
Cohesion: 0.4
Nodes (4): isLoading, [message, setMessage], sendMessage, [title, setTitle]
...
Cohesion: 0.4
Nodes (4): chordInfo, newStyle, project, track
...
Cohesion: 0.5
Nodes (3): EmptyLibraryState, EmptyPlaylistState, EmptySearchResults
...
Cohesion: 0.67
Nodes (2): normalizeNotes(), rowToResult()
...
Cohesion: 0.67
Nodes (2): createLazyRoute(), lazyLoad()
...
## Knowledge Gaps
- **9890 isolated node(s):** `restrictedImports`, `techDebtWarnRules`, `reactHooksWarnRules`, `shadows`, `visualizer` (+9885 more)
  These have ≤1 connection - possible missing edges or undocumented components.
- **Thin community `Community 932`** (2 nodes): `tailwind.config.ts`, `shadows`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 933`** (2 nodes): `layer-boundary.js`, `noSupabaseFromInComponent`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 934`** (2 nodes): `ConfirmationDialog()`, `ConfirmationDialog.tsx`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 935`** (2 nodes): `TrackDetailDialog.tsx`, `TrackDetailDialog()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 936`** (2 nodes): `ActorCard()`, `ActorCard.tsx`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 937`** (2 nodes): `AdminUserCreditsDialog()`, `AdminUserCreditsDialog.tsx`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 938`** (2 nodes): `SubscriptionTiersManager.tsx`, `tiers`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 939`** (2 nodes): `ForecastPanel.tsx`, `{ data, isLoading }`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 940`** (2 nodes): `TelemetryOverview.tsx`, `COLORS`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 941`** (2 nodes): `AdminDashboardHeader()`, `AdminDashboardHeader.tsx`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 942`** (2 nodes): `TracksTab.tsx`, `TracksTab()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 943`** (2 nodes): `UsersTab.tsx`, `UsersTab()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 944`** (2 nodes): `TierCreditsSection.tsx`, `TierCreditsSection()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 945`** (2 nodes): `TierDisplaySection.tsx`, `TierDisplaySection()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 946`** (2 nodes): `TierTelegramSection.tsx`, `TierTelegramSection()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 947`** (2 nodes): `WebVitalsReporter.tsx`, `WebVitalsReporter`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 948`** (2 nodes): `navigate`, `ArtistDetailPreview.tsx`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 949`** (2 nodes): `AudioRecordDialog`, `AudioRecordDialog.tsx`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 950`** (2 nodes): `MiniWaveform.tsx`, `MiniWaveform`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 951`** (2 nodes): `ReferenceAnalysisDisplay.tsx`, `renderStatusBadge()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 952`** (2 nodes): `DesktopContentHubLayout.tsx`, `layoutRatio`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 953`** (2 nodes): `VirtualizedLyricsList.tsx`, `handleCopy`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 954`** (2 nodes): `dialog-shared.tsx`, `DialogBackdrop()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 955`** (2 nodes): `SubscriptionRequiredDialog.tsx`, `SubscriptionRequiredDialog()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 956`** (2 nodes): `DrumEffects.tsx`, `[selectedTrack, setSelectedTrack]`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 957`** (2 nodes): `DrumKitSelector.tsx`, `DrumKitSelector`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 958`** (2 nodes): `DrumPadGrid.tsx`, `DrumPad`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 959`** (2 nodes): `PatternBank.tsx`, `PatternBank`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 960`** (2 nodes): `{ data: credits, isLoading }`, `CreditsBalance.tsx`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 961`** (2 nodes): `SoundToggle.tsx`, `SoundToggle()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 962`** (2 nodes): `isAssistant`, `ChatMessageBubble.tsx`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 963`** (2 nodes): `PrivacyToggle.tsx`, `handleChange()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 964`** (2 nodes): `TitleSection.tsx`, `TitleSection`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 965`** (2 nodes): `VocalsToggle.tsx`, `handleChange()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 966`** (2 nodes): `ContextHints`, `ContextHints.tsx`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 967`** (2 nodes): `HomeSection.tsx`, `HomeSection()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 968`** (2 nodes): `TracksGridSection.tsx`, `displayTracks`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 969`** (2 nodes): `YouStrip.tsx`, `GamificationBar`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 970`** (2 nodes): `MobileNavDrawer.tsx`, `MobileNavDrawer`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 971`** (2 nodes): `SafeAreaContainer.tsx`, `SafeAreaContainer`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 972`** (2 nodes): `SafeAreaSkeletonPlaceholder.tsx`, `SafeAreaSkeletonPlaceholder`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 973`** (2 nodes): `DesktopContentLayout.tsx`, `isMobile`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 974`** (2 nodes): `DesktopToolsGridLayout.tsx`, `DesktopToolsGridLayout`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 975`** (2 nodes): `LazySection.tsx`, `LazySection`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 976`** (2 nodes): `PullToRefreshWrapper.tsx`, `PullToRefreshWrapper`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 977`** (2 nodes): `DurationBadge.tsx`, `DurationBadge`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 978`** (2 nodes): `TrackBadges.tsx`, `hasContent`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 979`** (2 nodes): `ViewModeToggle.tsx`, `ViewModeToggle`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 980`** (2 nodes): `SynchronizedWord.tsx`, `cleanWord`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 981`** (2 nodes): `GenrePicker.tsx`, `cn()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 982`** (2 nodes): `StructurePicker.tsx`, `cn()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 983`** (2 nodes): `EditableLyricsContent.tsx`, `EditableLyricsContent()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 984`** (2 nodes): `HookResultCard.tsx`, `HookResultCard()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 985`** (2 nodes): `RhythmResultCard.tsx`, `RhythmResultCard()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 986`** (2 nodes): `TagsResultCard.tsx`, `TagsResultCard()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 987`** (2 nodes): `ProducerToolPanel.tsx`, `ProducerToolPanel()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 988`** (2 nodes): `MashupFormFields.tsx`, `MashupFormFields`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 989`** (2 nodes): `MobileSearchBar.tsx`, `MobileSearchBar`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 990`** (2 nodes): `MobileFormField.tsx`, `MobileFormField`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 991`** (2 nodes): `MobileSelect.tsx`, `MobileSelect`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 992`** (2 nodes): `NodeDetails.tsx`, `NodeDetails()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 993`** (2 nodes): `ActiveTabIndicator()`, `ActiveTabIndicator.tsx`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 994`** (2 nodes): `FeatureDescriptions.ts`, `FEATURE_DESCRIPTIONS`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 995`** (2 nodes): `SmartAlertProviderWrapper.tsx`, `SmartAlertProviderWrapper()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 996`** (2 nodes): `OnboardingStateMachine.ts`, `transitionOnboarding()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 997`** (2 nodes): `OnboardingStepCard.tsx`, `OnboardingStepCard()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 998`** (2 nodes): `onboardingSteps.ts`, `ONBOARDING_STEPS`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 999`** (2 nodes): `TutorialStep.tsx`, `StepIcon`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1000`** (2 nodes): `PaymentMethodSelector.tsx`, `cn()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1001`** (2 nodes): `StarsPaymentButton.tsx`, `StarsPaymentButton()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1002`** (2 nodes): `SubscriptionCard.tsx`, `cn()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1003`** (2 nodes): `DoubleTapSeekFeedback.tsx`, `Icon`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1004`** (2 nodes): `FullscreenBackground.tsx`, `backgroundUrl`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1005`** (2 nodes): `SwipeChevronIndicator.tsx`, `Icon`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1006`** (2 nodes): `VersionBadge.tsx`, `VersionBadge`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1007`** (2 nodes): `WaveformProgressBar.tsx`, `WaveformProgressBar`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1008`** (2 nodes): `{ artworkLayoutId }`, `CoverPage.tsx`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1009`** (2 nodes): `BalanceIndicator`, `BalanceIndicator.tsx`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1010`** (2 nodes): `ProfileStats.tsx`, `ProfileStats()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1011`** (2 nodes): `ProfileSetupStep4Banner.tsx`, `ProfileSetupStep4Banner()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1012`** (2 nodes): `ProjectSettingsSheet.tsx`, `ProjectSettingsSheet`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1013`** (2 nodes): `ProjectTemplateSelector.tsx`, `PROJECT_TEMPLATES`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1014`** (2 nodes): `ShareProjectCard.tsx`, `ShareProjectCard()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1015`** (2 nodes): `LiveVisualizer.tsx`, `LiveVisualizer()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1016`** (2 nodes): `QuickStartSheet.tsx`, `QUICK_START_PRESETS`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1017`** (2 nodes): `Visualizer.tsx`, `Visualizer`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1018`** (2 nodes): `UserStatsSection.tsx`, `{ data: stats, isLoading }`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1019`** (2 nodes): `PrivacyTab.tsx`, `PrivacyTab()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1020`** (2 nodes): `ProfileTab.tsx`, `ProfileTab()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1021`** (2 nodes): `KeyboardShortcutsDialog.tsx`, `KeyboardShortcutsDialog`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1022`** (2 nodes): `LyricsAutoScroll.tsx`, `LyricsAutoScroll`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1023`** (2 nodes): `TranscriptionInProgress.tsx`, `TranscriptionInProgress`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1024`** (2 nodes): `navigate`, `CleanStudioLayout.tsx`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1025`** (2 nodes): `StudioHeader.tsx`, `navigate`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1026`** (2 nodes): `StudioPlayerBar.tsx`, `progress`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1027`** (2 nodes): `UnifiedStudioLayout.tsx`, `isMobile`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1028`** (2 nodes): `Playhead.tsx`, `left`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1029`** (2 nodes): `TimelineRuler.tsx`, `markers`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1030`** (2 nodes): `MobileActionsContent.tsx`, `MobileActionsContent`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1031`** (2 nodes): `MobileStudioPlayerBar.tsx`, `MobileStudioPlayerBar`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1032`** (2 nodes): `StudioPresetsSheet.tsx`, `StudioPresetsSheet`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1033`** (2 nodes): `UnifiedStudioMobile.tsx`, `UnifiedStudioMobile`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1034`** (2 nodes): `NoteTypeBadge.tsx`, `NoteTypeBadge()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1035`** (2 nodes): `types.ts`, `NOTE_TYPES`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1036`** (2 nodes): `StudioShellHeader.tsx`, `cn()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1037`** (2 nodes): `StudioShellMobileNav.tsx`, `StudioShellMobileNav`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1038`** (2 nodes): `StudioShellTransportBar.tsx`, `StudioShellTransportBar`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1039`** (2 nodes): `useStudioDialogState.ts`, `useStudioDialogState()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1040`** (2 nodes): `useStudioShellState.ts`, `useStudioShellState()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1041`** (2 nodes): `TagMenu.tsx`, `TagMenu()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1042`** (2 nodes): `AddToHomeScreen()`, `AddToHomeScreen.tsx`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1043`** (2 nodes): `QuickQueueButton.tsx`, `QuickQueueButton`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1044`** (2 nodes): `TrackCommentsSection.tsx`, `[isExpanded, setIsExpanded]`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1045`** (2 nodes): `types.ts`, `VARIANT_CONFIGS`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1046`** (2 nodes): `UnifiedTrackCard.tsx`, `UnifiedTrackCard`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1047`** (2 nodes): `CardCoverActionBar()`, `CardCoverActionBar.tsx`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1048`** (2 nodes): `CardFollowButton`, `CardFollowButton.tsx`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1049`** (2 nodes): `PlayingIndicator.tsx`, `PlayingIndicator`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1050`** (2 nodes): `MinimalVariant.tsx`, `{
    sheetOpen,
    setSheetOpen,
    isHovered,
    isCurrentlyPlaying,
  ...
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1051`** (2 nodes): `EditableTrackTitle.tsx`, `EditableTrackTitle`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1052`** (2 nodes): `RenameTrackDialog.tsx`, `RenameTrackDialog()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1053`** (2 nodes): `DeleteActions.tsx`, `DeleteActions()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1054`** (2 nodes): `VersionsSection.tsx`, `VersionsSection`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1055`** (2 nodes): `TrackLyricsSection.tsx`, `TrackLyricsSection`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1056`** (2 nodes): `TrackPromptSection.tsx`, `TrackPromptSection`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1057`** (2 nodes): `TrackReferencesSection.tsx`, `hasReferences`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1058`** (2 nodes): `TrackStatsGrid.tsx`, `TrackStatsGrid`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1059`** (2 nodes): `ShareToStoryButton.tsx`, `ShareToStoryButton()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1060`** (2 nodes): `TrackStudioSection.tsx`, `TrackStudioSection()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1061`** (2 nodes): `badgeVariants`, `badge.tsx`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1062`** (2 nodes): `Checkbox`, `checkbox.tsx`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1063`** (2 nodes): `FloatingMainButton.tsx`, `FloatingMainButton()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1064`** (2 nodes): `input.tsx`, `Input`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1065`** (2 nodes): `progress.tsx`, `hasLabel`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1066`** (2 nodes): `pull-to-refresh-indicator.tsx`, `isReady`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1067`** (2 nodes): `resizable.tsx`, `ResizablePanelGroup()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1068`** (2 nodes): `separator.tsx`, `Separator`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1069`** (2 nodes): `SkeletonPage.tsx`, `PageHeader()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1070`** (2 nodes): `slider.tsx`, `Slider`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1071`** (2 nodes): `table.tsx`, `Table`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1072`** (2 nodes): `tabs.tsx`, `Tabs`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1073`** (2 nodes): `textarea.tsx`, `Textarea`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1074`** (2 nodes): `visually-hidden.tsx`, `VisuallyHidden`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1075`** (2 nodes): `voice-input-button.tsx`, `{ isRecording, isProcessing, toggleRecording }`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1076`** (2 nodes): `safe-area.tsx`, `SafeArea`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1077`** (2 nodes): `WaveformCanvas.tsx`, `WaveformCanvas`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1078`** (2 nodes): `useAdminDailyStats.ts`, `useAdminDailyStats()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1079`** (2 nodes): `useAudioLevel.ts`, `useAudioLevel()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1080`** (2 nodes): `useBPMGrid.ts`, `useBPMGrid()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1081`** (2 nodes): `useEnhancedKeyboard.ts`, `useEnhancedKeyboard()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1082`** (2 nodes): `useHomePageEffects.ts`, `useHomePageEffects()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1083`** (2 nodes): `useLyricsRecognition.ts`, `useLyricsRecognition()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1084`** (2 nodes): `useMusicRecognition.ts`, `useMusicRecognition()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1085`** (2 nodes): `useOnlineStatus.ts`, `useOnlineStatus()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1086`** (2 nodes): `usePublicArtists.ts`, `usePublicArtists()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1087`** (2 nodes): `useReplacedSections.ts`, `useReplacedSections()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1088`** (2 nodes): `useScrollLock.ts`, `useScrollLock()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1089`** (2 nodes): `useStudioData.ts`, `useStudioData()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1090`** (2 nodes): `useSwipeActions.ts`, `useSwipeActions()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1091`** (2 nodes): `useTinkoffPayment.ts`, `useTinkoffPayment()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1092`** (2 nodes): `useTrackChangelog.tsx`, `useTrackChangelog()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1093`** (2 nodes): `useTrackVersionManagement.tsx`, `useTrackVersionManagement()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1094`** (2 nodes): `useUpsellThrottle.ts`, `useUpsellThrottle()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1095`** (2 nodes): `useChangeUserSubscription.ts`, `useChangeUserSubscription()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1096`** (2 nodes): `useContentAnalytics.ts`, `useContentAnalytics()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1097`** (2 nodes): `usePaymentCohortAnalytics.ts`, `usePaymentCohortAnalytics()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1098`** (2 nodes): `useSendAdminMessage.ts`, `useSendAdminMessage()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1099`** (2 nodes): `useQuickConversions.ts`, `useQuickConversions()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1100`** (2 nodes): `useGenerateArtistPortrait.ts`, `useGenerateArtistPortrait()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1101`** (2 nodes): `useAudioVisualizer.ts`, `useAudioVisualizer()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1102`** (2 nodes): `useSimulatedStemLevels.ts`, `useSimulatedStemLevels()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1103`** (2 nodes): `useWaveform.ts`, `useWaveform()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1104`** (2 nodes): `useAudioActionAnalysis.ts`, `useAudioActionAnalysis()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1105`** (2 nodes): `useReferenceAudioAnalysis.ts`, `useReferenceAudioAnalysis()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1106`** (2 nodes): `useDeliveryTracking.ts`, `useDeliveryTracking()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1107`** (2 nodes): `useGenerateFormTypes.ts`, `classifyFailure()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1108`** (2 nodes): `useLyricsSync.ts`, `useLyricsSync()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1109`** (2 nodes): `useThemeIdea.ts`, `useThemeIdea()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1110`** (2 nodes): `useProjectDetailDialogs.ts`, `useProjectDetailDialogs()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1111`** (2 nodes): `useProjectDetailState.ts`, `useProjectDetailState()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1112`** (2 nodes): `useSectionReplacementHistory.ts`, `useSectionReplacementHistory()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1113`** (2 nodes): `useAddInstrumental.ts`, `useAddInstrumental()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1114`** (2 nodes): `useAddVocals.ts`, `useAddVocals()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1115`** (2 nodes): `useExportMidi.ts`, `useExportMidi()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1116`** (2 nodes): `useExtendMusic.ts`, `useExtendMusic()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1117`** (2 nodes): `useExtendTrack.ts`, `useExtendTrack()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1118`** (2 nodes): `useGenerateSfx.ts`, `useGenerateSfx()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1119`** (2 nodes): `useKlangioAnalyze.ts`, `useKlangioAnalyze()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1120`** (2 nodes): `useLatestStemTranscription.ts`, `useLatestStemTranscription()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1121`** (2 nodes): `useLoopRegion.ts`, `useLoopRegion()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1122`** (2 nodes): `useMultiTrackAudio.ts`, `useMultiTrackAudio()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1123`** (2 nodes): `useOptimisticVersions.ts`, `useOptimisticVersions()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1124`** (2 nodes): `useRemixTrack.ts`, `useRemixTrack()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1125`** (2 nodes): `useSourceTrack.ts`, `useSourceTrack()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1126`** (2 nodes): `useStemControls.ts`, `useStemControls()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1127`** (2 nodes): `useStudioHandlers.ts`, `useStudioHandlers()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1128`** (2 nodes): `useStudioRealtime.ts`, `useStudioRealtime()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1129`** (2 nodes): `useSunoFileUpload.ts`, `useSunoFileUpload()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1130`** (2 nodes): `useSunoMashup.ts`, `useSunoMashup()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1131`** (2 nodes): `useSunoPersona.ts`, `useSunoPersona()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1132`** (2 nodes): `useSunoUploadCover.ts`, `useSunoUploadCover()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1133`** (2 nodes): `useSunoUploadExtend.ts`, `useSunoUploadExtend()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1134`** (2 nodes): `useTelegramDocumentShare.ts`, `useTelegramDocumentShare()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1135`** (2 nodes): `useSetupTelegramWebhook.ts`, `useSetupTelegramWebhook()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1136`** (2 nodes): `useTelegramSecondaryButton.ts`, `useTelegramSecondaryButton()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1137`** (2 nodes): `useTelegramSettingsButton.ts`, `useTelegramSettingsButton()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1138`** (2 nodes): `useHeaderVersionSelector.ts`, `useHeaderVersionSelector()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1139`** (2 nodes): `useParentTrackLink.ts`, `useParentTrackLink()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1140`** (2 nodes): `useVoiceRecorder.ts`, `useVoiceRecorder()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1141`** (2 nodes): `types.ts`, `Constants`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1142`** (2 nodes): `sanitizeFilename.ts`, `sanitizeFilename()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1143`** (2 nodes): `shimmerAnimation.tsx`, `ShimmerLoader`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1144`** (2 nodes): `mashupStrings.ts`, `MASHUP_STRINGS`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1145`** (2 nodes): `index.ts`, `projectRef`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1146`** (2 nodes): `gestures-schema.ts`, `GestureSettingsSchema`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1147`** (2 nodes): `dashboard`, `AdminDashboard.tsx`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1148`** (2 nodes): `AudioHub`, `AudioHub.tsx`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1149`** (2 nodes): `AdminAlerts()`, `AdminAlerts.tsx`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1150`** (2 nodes): `AdminBroadcast()`, `AdminBroadcast.tsx`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1151`** (2 nodes): `AdminEconomy()`, `AdminEconomy.tsx`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1152`** (2 nodes): `{ data: stats }`, `AdminOverview.tsx`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1153`** (2 nodes): `AdminTariffs()`, `AdminTariffs.tsx`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1154`** (2 nodes): `AdminTelegram()`, `AdminTelegram.tsx`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1155`** (2 nodes): `AnalyticsDashboardPage()`, `AnalyticsDashboard.tsx`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1156`** (2 nodes): `LyricsEditor.tsx`, `haptic`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1157`** (2 nodes): `LyricsFooter.tsx`, `LyricsFooter()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1158`** (2 nodes): `LyricsHeader.tsx`, `haptic`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1159`** (2 nodes): `SortableProjectTrack.tsx`, `SortableProjectTrack()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1160`** (2 nodes): `TracksTabContent.tsx`, `sensors`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1161`** (2 nodes): `UIProviders.tsx`, `UIProviders`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1162`** (2 nodes): `Page.tsx`, `[user, setUser]`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1163`** (2 nodes): `gestures.ts`, `DEFAULT_GESTURE_SETTINGS`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1164`** (2 nodes): `track.ts`, `isPlayableTrack()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1165`** (2 nodes): `classes`, `cn-interactive.test.ts`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1166`** (2 nodes): `mockProduct`, `CreditPackageCard.test.tsx`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1167`** (1 nodes): `playwright.config.ts`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1168`** (1 nodes): `postcss.config.js`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1169`** (1 nodes): `vitest.shims.d.ts`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1170`** (1 nodes): `index.ts`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1171`** (1 nodes): `UnifiedTrackCard.contract.ts`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1172`** (1 nodes): `useRealtimeTrackUpdates.contract.ts`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1173`** (1 nodes): `useTrackActions.contract.ts`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1174`** (1 nodes): `useTrackData.contract.ts`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1175`** (1 nodes): `useTrackVersionSwitcher.contract.ts`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1176`** (1 nodes): `MobileBottomSheet.contract.ts`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1177`** (1 nodes): `MobileHeaderBar.contract.ts`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1178`** (1 nodes): `UnifiedScreenLayout.contract.ts`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1179`** (1 nodes): `VirtualizedTrackList.contract.ts`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1180`** (1 nodes): `contract_unified-dialog-types`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1181`** (1 nodes): `contract_unified-form-types`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1182`** (1 nodes): `contract_unified-skeleton-types`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1183`** (1 nodes): `vite-env.d.ts`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1184`** (1 nodes): `index.ts`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1185`** (1 nodes): `index.ts`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1186`** (1 nodes): `index.ts`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1187`** (1 nodes): `BotTab.tsx`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1188`** (1 nodes): `index.ts`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1189`** (1 nodes): `OverviewTab.tsx`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
...
- **Thin community `Community 1192`** (1 nodes): `index.ts`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1193`** (1 nodes): `TierPricingSection.tsx`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
...
- **Thin community `Community 1199`** (1 nodes): `index.ts`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1200`** (1 nodes): `BlogHeroSection.tsx`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
...
- **Thin community `Community 1204`** (1 nodes): `index.ts`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1205`** (1 nodes): `VirtualizedArtistsList.tsx`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1206`** (1 nodes): `VirtualizedProjectsList.tsx`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1207`** (1 nodes): `DialogHeader.tsx`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1208`** (1 nodes): `index.ts`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1209`** (1 nodes): `index.ts`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1210`** (1 nodes): `KitSelectorPro.tsx`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1211`** (1 nodes): `index.ts`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1212`** (1 nodes): `NetworkErrorState.tsx`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1213`** (1 nodes): `ServerErrorState.tsx`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1214`** (1 nodes): `TimeoutErrorState.tsx`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1215`** (1 nodes): `DesktopRewardsLayout.tsx`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1216`** (1 nodes): `GenerateFormActions.tsx`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1217`** (1 nodes): `GenerateFormCustom.tsx`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1218`** (1 nodes): `index.ts`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1219`** (1 nodes): `SectionLabel.tsx`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1220`** (1 nodes): `AudioActionPreviewSection.tsx`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1221`** (1 nodes): `AudioActionUploadSection.tsx`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1222`** (1 nodes): `ChatMessageList.tsx`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
...
- **Thin community `Community 1231`** (1 nodes): `index.ts`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1232`** (1 nodes): `AppHeader.tsx`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1233`** (1 nodes): `index.ts`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1234`** (1 nodes): `DesktopDashboardLayout.tsx`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1235`** (1 nodes): `index.ts`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1236`** (1 nodes): `LibraryDialogs.tsx`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1237`** (1 nodes): `index.ts`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1238`** (1 nodes): `GenerationProgressBadge.tsx`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1239`** (1 nodes): `index.ts`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1240`** (1 nodes): `LoadingOverlay.tsx`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1241`** (1 nodes): `index.ts`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1242`** (1 nodes): `SectionTypePicker.tsx`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1243`** (1 nodes): `index.ts`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1244`** (1 nodes): `SectionReferenceDisplay.tsx`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
...
- **Thin community `Community 1253`** (1 nodes): `index.ts`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1254`** (1 nodes): `MoreMenuHintTooltip.tsx`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1255`** (1 nodes): `index.ts`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1256`** (1 nodes): `NotificationPermissionPrompt.tsx`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1257`** (1 nodes): `AlertIllustrations.tsx`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
...
- **Thin community `Community 1264`** (1 nodes): `index.ts`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1265`** (1 nodes): `profile-setup.types.ts`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1266`** (1 nodes): `BannerRequiredDialog.tsx`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1267`** (1 nodes): `index.ts`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1268`** (1 nodes): `index.ts`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1269`** (1 nodes): `ProjectQuickActions.tsx`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1270`** (1 nodes): `ControlPanel.tsx`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1271`** (1 nodes): `GlobalControls.tsx`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1272`** (1 nodes): `index.ts`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1273`** (1 nodes): `QuickMixPresets.tsx`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1274`** (1 nodes): `index.ts`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1275`** (1 nodes): `index.ts`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1276`** (1 nodes): `UnifiedTrackCard.tsx`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1277`** (1 nodes): `index.ts`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1278`** (1 nodes): `LibrarySkeleton.tsx`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1279`** (1 nodes): `ProjectsSkeleton.tsx`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1280`** (1 nodes): `SettingsSkeleton.tsx`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1281`** (1 nodes): `ActivityFeed.tsx`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
...
- **Thin community `Community 1285`** (1 nodes): `index.ts`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1286`** (1 nodes): `SectionActions.tsx`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1287`** (1 nodes): `SectionValidation.tsx`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1288`** (1 nodes): `index.ts`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1289`** (1 nodes): `StemTrackSkeleton.tsx`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1290`** (1 nodes): `index.ts`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1291`** (1 nodes): `index.ts`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1292`** (1 nodes): `StudioDashboardSheet.tsx`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1293`** (1 nodes): `StudioShellHeader.tsx`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1294`** (1 nodes): `AddNoteForm.tsx`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1295`** (1 nodes): `index.ts`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1296`** (1 nodes): `StudioHeader.tsx`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1297`** (1 nodes): `StudioShellContent.tsx`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
...
- **Thin community `Community 1301`** (1 nodes): `index.ts`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1302`** (1 nodes): `track-card.types.ts`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
...
- **Thin community `Community 1306`** (1 nodes): `index.ts`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1307`** (1 nodes): `ActionGrid.tsx`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1308`** (1 nodes): `index.ts`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1309`** (1 nodes): `index.ts`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1310`** (1 nodes): `TrackCoverSection.tsx`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1311`** (1 nodes): `TrackStyleSection.tsx`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1312`** (1 nodes): `TrackInfoSection.tsx`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1313`** (1 nodes): `command.tsx`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1314`** (1 nodes): `skeleton-loader.tsx`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1315`** (1 nodes): `states.ts`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1316`** (1 nodes): `unified-empty-state.tsx`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1317`** (1 nodes): `ux-components.ts`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
...
- **Thin community `Community 1320`** (1 nodes): `index.ts`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1321`** (1 nodes): `index.ts`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1322`** (1 nodes): `PageSkeleton.tsx`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1323`** (1 nodes): `ProfileSkeleton.tsx`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1324`** (1 nodes): `ProjectCardSkeleton.tsx`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
...
- **Thin community `Community 1327`** (1 nodes): `index.ts`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1328`** (1 nodes): `ContextHelp.tsx`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1329`** (1 nodes): `TelegramContext.tsx`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1330`** (1 nodes): `index.ts`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1331`** (1 nodes): `types.ts`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1332`** (1 nodes): `common.ts`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1333`** (1 nodes): `use-is-mobile.ts`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1334`** (1 nodes): `use-mobile.tsx`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1335`** (1 nodes): `useAuth.tsx`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1336`** (1 nodes): `usePromptDJ.ts`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1337`** (1 nodes): `usePublicContent.ts`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
...
- **Thin community `Community 1356`** (1 nodes): `index.ts`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1357`** (1 nodes): `social.ts`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1358`** (1 nodes): `common.ts`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1359`** (1 nodes): `icons.ts`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
...
- **Thin community `Community 1364`** (1 nodes): `index.ts`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1365`** (1 nodes): `forms.ts`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1366`** (1 nodes): `player.ts`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1367`** (1 nodes): `LyricsStudio.tsx`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1368`** (1 nodes): `index.ts`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1369`** (1 nodes): `index.ts`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1370`** (1 nodes): `LyricsTagsPanels.tsx`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1371`** (1 nodes): `types.ts`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1372`** (1 nodes): `ProjectHeroSection.tsx`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1373`** (1 nodes): `ProjectMetaSection.tsx`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1374`** (1 nodes): `QuickActionsBar.tsx`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
...
- **Thin community `Community 1378`** (1 nodes): `index.ts`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1379`** (1 nodes): `lyrics-types.ts`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
...
- **Thin community `Community 1382`** (1 nodes): `index.ts`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1383`** (1 nodes): `voice-types.ts`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1384`** (1 nodes): `index.ts`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1385`** (1 nodes): `useUnifiedStudioStore.ts`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1386`** (1 nodes): `index.ts`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1387`** (1 nodes): `usePlaybackStore.ts`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1388`** (1 nodes): `Header.tsx`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1389`** (1 nodes): `index.ts`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1390`** (1 nodes): `activity.ts`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1391`** (1 nodes): `analytics.ts`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1392`** (1 nodes): `comment.ts`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1393`** (1 nodes): `guitar.ts`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1394`** (1 nodes): `index.ts`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1395`** (1 nodes): `notifications.ts`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1396`** (1 nodes): `profile.ts`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1397`** (1 nodes): `queue.ts`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1398`** (1 nodes): `social.ts`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1399`** (1 nodes): `starsPayment.ts`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1400`** (1 nodes): `studio-entities.ts`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1401`** (1 nodes): `telegram.d.ts`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1402`** (1 nodes): `MashupDialog.test.tsx`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1403`** (1 nodes): `e2e_test_auth`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1404`** (1 nodes): `e2e_test_generation`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1405`** (1 nodes): `e2e_test_player`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1406`** (1 nodes): `unified-store.test.ts`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1407`** (1 nodes): `Full Logic and Interface Analysis (RU)`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1408`** (1 nodes): `Music and Sound Wave Banner Image`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1409`** (1 nodes): `Accessibility Icon`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1410`** (1 nodes): `Discord Icon`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1411`** (1 nodes): `GitHub Icon`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1412`** (1 nodes): `Tutorials Icon`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1413`** (1 nodes): `YouTube Icon`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1414`** (1 nodes): `Storybook Banner Image`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1415`** (1 nodes): `payment_transactions`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.