...
#### Задача 1.3: CloudStorage для настроек и кэша
**Приоритет:** P1  
**Сложность:** M (8 часов)  
**Файлы:**
- `src/lib/cloudStorage.ts` (создать)
- `src/hooks/useCloudStorage.ts` (создать)

**Действия:**
- [ ] Создать обертку над Telegram CloudStorage API
- [ ] Реализовать кэширование:
  - Пользовательские настройки (theme, volume, haptic)
  - Последние воспроизведенные треки
  - Черновики генерации
  - Избранные стили и жанры
- [ ] Добавить fallback на localStorage
- [ ] Реализовать синхронизацию между устройствами

**Acceptance Criteria:**
- Настройки сохраняются в Telegram Cloud
- Синхронизация работает между устройствами пользователя
