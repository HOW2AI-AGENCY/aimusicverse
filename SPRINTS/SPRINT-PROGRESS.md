...
| **Sprint 042: Page Decomposition + Audio Pooling** | 🟡 В РАБОТЕ     | Quick Wins ✅ (3 lyrics bugs, structuredClone, console.log, fetch-warmup, schema-drift docs); usePreviewAudio hook ✅ (230 LOC); LyricsStudio 1098 → 999 LOC ✅ (sections extracted); **ProjectDetail 851 → 286 LOC ✅** (-565, -66%, 6 sub-components extracted); RecordingPreview migrated (1/28) ✅; осталось: ~26 usePreviewAudio миграций (динамические URL требуют `usePreviewPlaylist` hook), LyricsStudio дальнейшая декомпозиция (-599 LOC remaining), остальные god-файлы |
