...
| **Sprint 042: Page Decomposition + Audio Pooling** | 🟡 В РАБОТЕ     | Quick Wins ✅ (3 lyrics bugs, structuredClone, console.log, fetch-warmup, schema-drift docs); usePreviewAudio hook ✅ (240 LOC, +playUrl для dynamic URL); LyricsStudio 1098 → 999 LOC ✅ (sections extracted); **ProjectDetail 851 → 286 LOC ✅** (-565, -66%, 6 sub-components extracted); **10/28 usePreviewAudio миграций ✅** (RecordingPreview, InstrumentalResultHandler, TrackVersionsTab, TrackStemsTab, SavedRecordingsList, SFXGeneratorPanel, InstrumentalGeneratorPanel, CloudAudioPicker, AudioHubUploader); **usePromptDJEnhanced 1071 → 882 LOC ✅** (constants/types/defaults/promptBuilder extracted в `hooks/prompt-dj/`); осталось: ~18 usePreviewAudio миграций + LyricsStudio JSX decomposition + usePromptDJEnhanced 882 → <500; см. полный план: [SPRINTS/CLOSING_PLAN_2026-Q3-Q4.md](./CLOSING_PLAN_2026-Q3-Q4.md) |
