...
| **Sprint 051: Test Debt + God Files**              | 🔄 В РАБОТЕ         | **Phase A-C** ✅ Декомпозиция: studio.service 1137→4 модуля, studio.api 953→4 модуля, LyricsParser types extraction. **T055** 🔄 vitest config fix (tests/unit/ включён, +25 файлов), API тесты: generation.api (8), credits.api (44), tracks.api (52). Итого: 395→899 passing (+504). PR #636. **T056** ⏳ 0 файлов >1000 LOC (6 файлов 700-837 LOC остаются). Цель: 450+ unit-тестов ✅ достигнута, 0 файлов >1000 строк ⏳                                                                                                                                                                                                                                                                                                                                                                              |
...
<sub>📌 Unit Tests: 899 passing / 83 файлов — фактический прогон `npm test` 2026-07-06 (Sprint 051 T055: vitest config fix + API tests). Vitest include покрывает `src/**` + `tests/unit/**`. PR #636.</sub>
