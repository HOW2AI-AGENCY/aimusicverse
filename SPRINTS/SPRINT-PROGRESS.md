...
**Последнее обновление**: 2026-07-31 (post-audit sync — metrics corrected, Sprint 065/066/067 statuses). Верифицировано: **tsc 0 errors ✅, 1871 unit tests passed ✅ / 4 skipped / 31 todo** (176 файлов); **ESLint 0 errors / 426 warnings** (408 `react-hooks/*`, 84 `react-refresh/only-export-components`); **any 0/50 budget**; **0 files >800 LOC в src/**.
...
| **Sprint 040: Тесты + Export**                                  | ✅ ЗАВЕРШЁН             | **Phase A** 🔄 API+Service тесты: 27 файлов создано (21 API + 6 Service). 395→1273 passing тестов (+878). API покрытие 10%→72% (21/29). Service покрытие 2%→12% (7/49+1 existing). Осталось: 8 API файлов (с @ts-nocheck) + 42 Service файла. WAV/MP3/FLAC export, Service Worker, Lighthouse CI — Phase B.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                |
