...
| **Sprint 042: Page Decomposition + Audio Pooling** | 🟡 В РАБОТЕ     | Quick Wins ✅; usePreviewAudio hook ✅ (240 LOC + playUrl); LyricsHeader.tsx (LyricsStudio 999→853 LOC) + LyricsTagsPanels.tsx (853→788 LOC) + types extracted; **ProjectDetail 851 → 286 LOC ✅**; **17/28 usePreviewAudio миграций ✅** (RecordingPreview, InstrumentalResultHandler, TrackVersionsTab, TrackStemsTab, SavedRecordingsList, SFXGenerator, InstrumentalGenerator, CloudAudioPicker audio-record, AudioHubUploader, CloudAudioSelector audio-reference, CreateArtistDialog, SectionEditorSheet, SectionReplacementProgress, EnhancedVersionTimeline, ReplacementTimelineOverlay, CloudAudioPicker lyrics-workspace); **usePromptDJEnhanced 1071 → 882 LOC ✅**; см. план: [SPRINTS/CLOSING_PLAN_2026-Q3-Q4.md](./CLOSING_PLAN_2026-Q3-Q4.md) |
