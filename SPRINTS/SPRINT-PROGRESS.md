...
| **Sprint 042: Page Decomposition + Audio Pooling** | 🟡 В РАБОТЕ     | Quick Wins ✅ (3 lyrics bugs, structuredClone, console.log, fetch-warmup, schema-drift docs); usePreviewAudio hook ✅ (240 LOC, +playUrl для dynamic URL); LyricsStudio 1098 → 999 LOC ✅ (sections extracted); **ProjectDetail 851 → 286 LOC ✅** (-565, -66%, 6 sub-components extracted); **8/28 usePreviewAudio миграций ✅** (RecordingPreview, InstrumentalResultHandler, TrackVersionsTab, TrackStemsTab, SavedRecordingsList, SFXGeneratorPanel, InstrumentalGeneratorPanel); **usePromptDJEnhanced 1071 → 919 LOC ✅** (constants/types/defaults extracted в `hooks/prompt-dj/`); осталось: ~20 usePreviewAudio миграций + LyricsStudio/StudioShell/IntegratedStemTracks decomposition + usePromptDJEnhanced 919 → <500 |
