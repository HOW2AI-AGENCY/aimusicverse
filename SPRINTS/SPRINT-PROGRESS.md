...
| **Sprint 042: Page Decomposition + Audio Pooling** | 🟡 В РАБОТЕ     | Quick Wins ✅; usePreviewAudio hook ✅ (240 LOC + playUrl); LyricsHeader.tsx (LyricsStudio 999→853 LOC) + LyricsTagsPanels.tsx (853→788 LOC) + types extracted; **ProjectDetail 851 → 286 LOC ✅**; **13/28 usePreviewAudio миграций ✅** (RecordingPreview, InstrumentalResultHandler, TrackVersionsTab, TrackStemsTab, SavedRecordingsList, SFXGeneratorPanel, InstrumentalGeneratorPanel, CloudAudioPicker, AudioHubUploader, CloudAudioSelector, CreateArtistDialog, SectionEditorSheet); **usePromptDJEnhanced 1071 → 882 LOC ✅**; см. план: [SPRINTS/CLOSING_PLAN_2026-Q3-Q4.md](./CLOSING_PLAN_2026-Q3-Q4.md) |
