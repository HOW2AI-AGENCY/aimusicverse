...
**Последнее обновление**: 2026-07-14 (сессия: сверка расхождений в планах + Sprint 065 Generate v2 / Home Redesign / Visual Regression зафиксирован; переопределён бэклог 066–069. План работ: [WORKPLAN-2026-07-14.md](../WORKPLAN-2026-07-14.md)). Верифицировано: **tsc 0 errors ✅, 1810 unit tests passed ✅** (166 файлов); файловые метрики через `find`/`wc`. Нюанс установки зависимостей — WORKPLAN §5.

> 📌 **Важно**: Это документ отслеживает все спринты и их статусы. Для детального плана задач смотрите [BACKLOG.md](archived/BACKLOG.md).
...
| **Sprint 040: Тесты + Export**                                  | 🔄 В РАБОТЕ             | **Phase A** 🔄 API+Service тесты: 27 файлов создано (21 API + 6 Service). 395→1273 passing тестов (+878). API покрытие 10%→72% (21/29). Service покрытие 2%→12% (7/49+1 existing). Осталось: 8 API файлов (с @ts-nocheck) + 42 Service файла. WAV/MP3/FLAC export, Service Worker, Lighthouse CI — Phase B.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                |
...
| **Sprint 050: Main Green + Mobile Audit F1–F12**                | ✅ ЗАВЕРШЁН             | **Phase A:** A0 ✅ typecheck fix. A1 ✅ E2E stabilized (PR #657). A2 ✅ docs links. A3 ✅ migrations reconciled (20260709000000). A4 ✅ Branch Protection ACTIVE. A5 ✅ bun.lock already clean. **Phase B (F1–F12):** F1/F3/F4/F5/F8/F9/F10/F11/F12 ✅ closed (useKeyboardAware, Radix UI, getTrackCoverUrl, QueueSheet, LibraryFilterChips, dead-code removal, LazyImage a11y). F2/F6/F7 low-priority verification deferred. **B6** ✅ lamejs/qrcode/canvas-confetti all lazy-loaded.                                                                                                                                                                                                                                                                                                                     |
| **Sprint 051: Test Debt + God Files**                           | ✅ ЗАВЕРШЁН             | **Phase A-C** ✅ Декомпозиция: studio.service 1137→4 модуля, studio.api 953→4 модуля, LyricsParser types extraction. **T055** ✅ vitest config fix + API тесты: 395→925 passing (+530). PR #636 MERGED. **T056** ✅ декомпозиция god-файлов: 12/12 файлов декомпозированы (errorHandling 828→413, IntegratedStemTracks 837→694, LyricsParser 742→558, LyricsVisualEditorCompact 833→705, UnifiedNotesViewer 774→735, LyricsVisualEditor 749→574, AudioAnalysisService 739→514, deeplink-tracker 734→691, PromptHistory 703→665 + UnifiedNotesViewer 837→5 файлов, LyricsVisualEditorCompact 757→4 файла, IntegratedStemTracks 738→3 файла). PRs #638-#644 MERGED. 1497 unit tests passing. Все файлы <700 LOC.                                                                                             |
...
| **Sprint 053: Suno API Sounds + MIDI + Boost**                  | ✅ ЗАВЕРШЁН             | Edge: `suno-sounds`, `suno-sounds-callback`, `suno-midi`, `suno-midi-callback`, `suno-midi-details` ✅. `suno-boost-style` подключён через `useGenerateFormBoostStyle` ✅. UI: `SfxGeneratorSheet` ✅, `useSunoSounds` ✅, `useSunoMidi` ✅. Storybook stories ✅. Telegram `/sfx` ⏳. Детальный план: [SPRINTS/SPRINT-053-PLAN.md](./archived/SPRINT-053-PLAN.md)                                                                                                                                                                                                                                                                                                                                                                                                                                         |
| **Sprint 054: Suno API Details Suite**                          | ✅ ЗАВЕРШЁН             | **(Исправлено 2026-07-07 — было ошибочно "planned", см. [PROGRESS-AUDIT-2026-07-07.md](../docs/audit/PROGRESS-AUDIT-2026-07-07.md)).** Edge: 6 details-эндпоинтов (`suno-{music,cover,video,wav,lyrics,separation}-details`) реализованы. `suno-check-status` (449 LOC) удалён как dead code вместо рефакторинга — zero client callers. UI: `useSunoTaskDetails` generic polling hook + 7 тестов. Suno API покрытие 24/28 → **28/28 (100%)**. Детальный план: [SPRINTS/SPRINT-054-PLAN.md](./archived/SPRINT-054-PLAN.md)                                                                                                                                                                                                                                                                                  |
| **Sprint 055: UX/UI Audit — Critical Fixes**                    | ✅ ЗАВЕРШЁН (Phase A+B) | **(Исправлено 2026-07-07 — было ошибочно "in progress", см. [PROGRESS-AUDIT-2026-07-07.md](../docs/audit/PROGRESS-AUDIT-2026-07-07.md)).** По итогам UX-аудита интерфейса/форм/путей пользователя (2026-07-04). **Phase A (P0, 5/5)** ✅ Save Draft, generation cancellation, deeplink `startapp=generate`, Welcome Bonus idempotency, analytics events. **Phase B (P1, 6/6)** ✅ Dual CTA, footer summary, hint positioning, keyboard-aware badge, Stepper, VoiceInput, Home sticky CTA. **Phase C** — 4/5 (1 отложен до Sprint 056). Итого 13/13 core tasks. Подробно: [SPRINT-055-PLAN.md](./archived/SPRINT-055-PLAN.md)                                                                                                                                                                               |
| **Sprint 056: GenerateSheet Redesign + Storybook**              | ✅ ЗАВЕРШЁН             | **A1-A5** ✅ GenerateSheet restructuring → thin orchestrator; Header/Body/Footer shell components; ReferenceChipsRow consolidation; AdvancedSettings card-based layout; wizard code cleanup. **B1-B6** ✅ Storybook stories (6/6): GenerateSheet, AdvancedSettings, LyricsAssistantSheet, LyricsVisualEditor, ReferenceChipsRow, ValidationReasonsSheet. **C1-C4** ⏳ Integration & Testing (deferred — requires Storybook runtime). **D1-D4** ✅ Documentation: COMPONENTS.md, THIN-ORCHESTRATOR-PATTERN.md, GENERATESHEET-MIGRATION-GUIDE.md, CHANGELOG. PR #647 MERGED.                                                                                                                                                                                                                                 |
| **Сессия 2026-07-08: AI Agent Activity Panel + Cleanup**        | ✅ ЗАВЕРШЕНО            | **AI Agent Activity Panel** ✅: компонент `AIAgentActivityPanel.tsx`, типы, интеграция в `LyricsAIChatAgent` и `MobileAIAgentPanel`. **Dead-code cleanup** ✅: удалены `src/lib/a11y*`, `src/components/suno/*`, неиспользуемые `src/lib/*` модули, `withHistory.ts`, `branded.ts`, 4 устаревших теста. **Tooling** ✅: починка `count-any.mjs` (`existsSync` guard), форматирование `.claude/settings.json`. Метрики: tsc 0, 1484 unit tests, 0/50 any, 0 files >800 LOC.                                                                                                                                                                                                                                                                                                                                 |
| **Сессия 2026-07-09: 9Router Cleanup + Sprint 057**             | ✅ ЗАВЕРШЕНО            | **9Router cleanup** ✅: удалены `src/services/ninerouter/`, `src/services/lyrics/ninerouter-lyrics.service.ts`, `src/services/lyrics/ai-lyrics-router.service.ts`, `src/hooks/useNineRouter.ts`. Ссылки удалены из CLAUDE.md, README.md, PROJECT_STATUS.md, FUTURE_WORK_PLAN.md, .env.example. **Sprint 057 (E2E CI Green + Branch Protection)** ✅: E2E `generation.mobile-taps.spec.ts` исправлен, Branch Protection Phase 2 активен (ruleset 18581121). **Документация** ✅: README.md, PROJECT_STATUS.md, FUTURE_WORK_PLAN.md, SPRINT-PROGRESS.md обновлены. Метрики: tsc 0, 1489 unit tests (122 test files), 0/50 any, 0 files >800 LOC в `src/`, 1161 компонентов, 434 хука, 30 API, 37 сервисов, 24 stores.                                                                                        |
| **Sprint 058: i18n EN/RU Localization**                         | ⏳ ЗАПЛАНИРОВАН         | Установить `react-i18next`, создать `src/i18n/locales/{en,ru}.json`, мигрировать `MASHUP_STRINGS` как пилотный домен, переключатель языка в настройках, EN перевод                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                         |
| **Sprint 059: Bundle Optimization + Unit Tests**                | ⏳ ЗАПЛАНИРОВАН         | Пересмотр `manualChunks` в vite.config.ts, выявление oversized chunks через `npm run size:why`, tree-shaking, цель: total bundle ≤1.8 MB. API/Service unit tests: 1800+ (сейчас 1489)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      |
| **Sprint 060: Design Polish**                                   | ⏳ ЗАПЛАНИРОВАН         | Search box на главной, skeleton loading states, route transition animation, border-radius hierarchy, nav simplification                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    |
| **Sprint 062: UI/UX Audit — P0/P1 Fixes**                       | ✅ ЗАВЕРШЁН             | **Phase A** ✅: Suspense fallback spinners, HomeQuickCreate options differentiation, gradient fallback, touch target fixes. **Phase B** ✅: Error Boundary, i18n placeholder, PullToRefresh scope, Waveform shimmer. **Phase C** ✅: Step indicator, Volume slider inline hover, GenerateSheet h-dvh, HomeSearchBar memo. Подробно: [SPRINT-062-PLAN.md](./SPRINT-062-PLAN.md)                                                                                                                                                                                                                                                                                                                                                                                                                             |
| **Sprint 063: Homepage UX Audit P0/P1**                         | ✅ ЗАВЕРШЁН             | P0/P1 фиксы главной по итогам UX-аудита (см. [FUTURE_WORK_PLAN.md](../FUTURE_WORK_PLAN.md))                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                |
| **Sprint 064: P2 Polish**                                       | ✅ ЗАВЕРШЁН             | P2 polish: tablet cols, error/retry states, «More» label, text-tertiary contrast, PrivacyToggle touch target                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                               |
| **Sprint 065: Generate v2 + Home Redesign + Visual Regression** | 🔄 В РАБОТЕ             | **A1–A8 ✅ (в `main`):** редизайн формы генерации (`GenerateFormSimple`, `CollapsibleFormHeader`, `GenerateSheetFooter`, `ReferenceChipsRow`), мобильный synth-hero (`HomeMobileSynthHero` +190, `Index.tsx`), общий `BrandEmptyState` (+141), выравнивание Community/ProjectsTab, инфраструктура визуальной регрессии (`playwright.visual.config.ts`, `tests/visual/home.spec.ts`, `quality-check.yml`), рефактор edge `mcp/index.ts`, миграция `65ceef14`. **Closure (B1–B5) 🔄:** typecheck/тесты, эталонные визуальные снимки, Storybook для новых компонентов, docs sync. План: [WORKPLAN-2026-07-14.md](../WORKPLAN-2026-07-14.md) §2                                                                                                                                                                |
| **Sprint 066: Dependency Health + Build Hygiene**               | ⏳ ЗАПЛАНИРОВАН         | Разрешить конфликт vite@8 ↔ `@storybook/react-vite@8.6` (чистый `npm ci` без `--legacy-peer-deps`), `npm audit` fix, синхронизация версий стека в `CLAUDE.md`/`README.md`, один lockfile                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   |
| **Sprint 067: Edge Functions Decomposition**                    | ⏳ ЗАПЛАНИРОВАН         | ≥10 файлов >800 LOC в `supabase/functions/` (suno-music-callback 1330, telegram-bot/deep-links 1327, send-telegram-notification 1132, klangio-analyze 1084 …). По файлу за раз под защитой тестов. Цель: 0 файлов >800 LOC                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 |
| **Sprint 068: Test & Story Coverage**                           | ⏳ ЗАПЛАНИРОВАН         | Unit → цель после реального замера (184 тест-файла), обязательные тесты новых TanStack-мутаций, Storybook 31→50+, визуальная регрессия за пределы Home (Library/Studio/Generate)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           |
| **Sprint 069: Bundle + Performance Budgets**                    | ⏳ ЗАПЛАНИРОВАН         | Total bundle 2.11 MB → ≤1.8 MB (пересмотр `manualChunks`, `size:why`), Lighthouse/CWV бюджеты в CI, проверка eager JS ≤508 KB после редизайна                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              |
...
Снижение failure rate с 12% до <8%. [Детальный план](archived/SPRINT-034-036-PLAN.md)
...
Стабилизация E2E + начало экспортов. [Детальный план](archived/SPRINT-034-036-PLAN.md)
...
Рефакторинг + тесты + Service Worker. [Детальный план](archived/SPRINT-034-036-PLAN.md)
...
Инфраструктурное укрепление и улучшение DX. [Детальный план](archived/SPRINT-037-PLAN.md)
...
_Обновлено: 2026-07-07 (аудит прогресса — Sprint 054/055 в сводной таблице выше исправлены с "planned"/"in progress" на фактический "✅ завершён"; 1497 passing unit tests подтверждено живым прогоном `npx vitest run`, tsc 0 ошибок, any 0/50 — см. [PROGRESS-AUDIT-2026-07-07.md](../docs/audit/PROGRESS-AUDIT-2026-07-07.md)). Ранее: 2026-07-06 (Quality gate green ✅: typecheck+lint+format; 1431 passing unit tests; GenerateSheet design review; Sprint 056 Phase A-D ✅, Sprint 053-055 ✅, Sprint 050 Phase A-B ✅, Sprint 051 Phase A-C ✅)_

> 🔗 Навигация: [DOCUMENTATION_INDEX.md](../DOCUMENTATION_INDEX.md) • [PROJECT_STATUS.md](../PROJECT_STATUS.md) • [BACKLOG.md](archived/BACKLOG.md)
