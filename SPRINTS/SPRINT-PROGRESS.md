...
| **Sprint 050: Main Green + Mobile Audit F1–F12**   | 🔄 В РАБОТЕ             | **A0** ✅ P0-хотфикс typecheck (PR #576/#577). **A1** ✅ E2E stabilized — root cause: `useTelegramInit.ts` missed `127.0.0.1` as dev env; fixed + `networkidle`→`domcontentloaded` in 20 files (PR #657). **A2** ✅ docs links fixed. **A4** ✅ Branch Protection Phase 2 ACTIVE — enforcement=active, required checks: quality + build + E2E (chromium) + E2E (Mobile Chrome). Force-push blocked. **A3** ⏳ prod-migrations sync. **A5** ⏳ bun.lock cleanup. Фаза B: F1–F12 — после закрытия Phase A.                                                                                                                                                                                                                                                                                                   |
