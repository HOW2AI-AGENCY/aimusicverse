...
| **Sprint 040: Тесты + Export**                     | 🔄 В РАБОТЕ         | **Phase A** 🔄 API тесты: 15 файлов создано (payments, storage, audio-upscale, audio-watermark, sound-effects, midi-suno, suno-task-details, profiles, artists, notifications, voice-clone, playlists, studio-tracks, studio-transcription, studio-realtime). 395→1124 passing тестов. API покрытие 10%→62% (18/29). PR #649 MERGED. Осталось: 11 API файлов + Service слой (49 файлов). WAV/MP3/FLAC export, Service Worker, Lighthouse CI — Phase B.                                                                                                                                                                                                                                                                                                                                                     |
