...
- **Provider chain (strict order)**: `ErrorBoundaryWrapper > ErrorBoundary > CoreProviders > FeatureProviders > BrowserRouter > UIProviders > NavigationProvider` — defined in [`src/App.tsx`](src/App.tsx:174)
