...
- **Sprint 047** — Mobile Audit + Z-Index/Spacing/Scroll-Lock + Player Z-Stack. ✅ ЗАВЕРШЁН (4 коммита: `5d97fa1f` + `dd8e734e` + `c22f94c3` + `3b38092e`):
  ...
  - 12 functional flags (F1–F12) задокументированы в CHANGELOG.md — НЕ правились в этом спринте, переданы build-agent (useScrollLock wiring, focus-trap, keyboard avoidance, и др.).
