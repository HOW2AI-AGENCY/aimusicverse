...
export async function createMainMenuKeyboardAsync(): Promise<{ inline_keyboard: InlineKeyboardButton[][] }> {
  ...
  return {
    inline_keyboard: [[{ text: "🚀 Открыть студию", web_app: { url: BOT_CONFIG.miniAppUrl } }]],
  };
}
...
export function createGenerateKeyboard() {
  return {
    inline_keyboard: [
      ...
      [
        { text: "🎸 Рок", callback_data: "style_rock" },
        { text: "🎹 Поп", callback_data: "style_pop" },
      ],
      [
        { text: "🎺 Джаз", callback_data: "style_jazz" },
        { text: "🎧 Электроника", callback_data: "style_electronic" },
      ],
      [
        { text: "🎻 Классика", callback_data: "style_classical" },
        { text: "🎤 Хип-хоп", callback_data: "style_hiphop" },
      ],
