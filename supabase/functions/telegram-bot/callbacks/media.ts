...
export async function handleMediaCallbacks(
  ...
  if (
    data.startsWith("track_details_") ||
    data.startsWith("play_track_") ||
    data.startsWith("toggle_like_") ||
    data.startsWith("download_track_") ||
    data.startsWith("share_track_") ||
    data.startsWith("copy_link_")
  ) {
  ...
  if (
    ...
    data.startsWith("dl_") ||
    data.startsWith("share_") ||
    data.startsWith("like_") ||
    data.startsWith("track_") ||
    data.startsWith("share_link_")
  ) {
