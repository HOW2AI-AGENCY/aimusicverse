...
export const SmartLinks = {
  ...
  generateWithStyle: (style: string, mood?: string) =>
    buildSmartDeepLink({
      route: "/generate",
      params: {
        style,
  ...
  pricingWithPlan: (planId: "pro" | "premium") =>
    buildSmartDeepLink({
      route: "/pricing",
  ...
  studioWithTrack: (trackId: string, tab?: "stems" | "effects" | "export") =>
    buildSmartDeepLink({
  ...
  coverWithReference: (referenceUrl?: string) =>
    buildSmartDeepLink({
      route: "/generate",
      params: referenceUrl
        ? {
  ...
  /** Open lyrics wizard */
  lyricsWizard: (genre?: string, mood?: string) =>
    buildSmartDeepLink({
      route: "/lyrics",
      params: {
        ...(genre && { genre }),
  ...
  projectWithTab: (projectId: string, tab?: "tracks" | "lyrics" | "settings") =>
    buildSmartDeepLink({
  ...
  profileSection: (section?: "tracks" | "followers" | "following" | "achievements") =>
    buildSmartDeepLink({
      route: "/profile",
  ...
  /** Open Music Lab tool */
  musicLabTool: (tool: "drums" | "melody" | "chords" | "dj") =>
    buildSmartDeepLink({
