...
ФОРМАТ ОТВЕТА (строго JSON):
{
  "lyrics": "полный текст песни с тегами Suno ТОЛЬКО НА АНГЛИЙСКОМ (если генерируешь текст)",
  "title": "Название песни (2-5 слов, НЕ первая строка текста, БЕЗ тегов)",
  "style": "Стиль-промпт для Suno (жанр, настроение, инструменты - на английском, до 120 символов)",
...
⚠️ ВАЖНО:
- ВСЕ ТЕГИ В КВАДРАТНЫХ СКОБКАХ НА АНГЛИЙСКОМ: [Verse 1], [Chorus], [Bridge]
- Круглые скобки ТОЛЬКО для того, что ПОЁТСЯ: (ooh, aah), (la-la-la), (harmony)
- Название трека - креативное, отражает тему, НЕ первая строка!
- Style prompt на английском: "pop ballad, emotional, piano, strings"
...
Ответ:
{
  "lyrics": "[Intro] [Atmospheric]\\n\\n[Verse 1] [Soft] [Acoustic Guitar]\\nВолны шепчут имя твоё...",
  "title": "Шёпот волн",
  "style": "indie pop, dreamy, acoustic guitar, ocean vibes, emotional female vocal",
