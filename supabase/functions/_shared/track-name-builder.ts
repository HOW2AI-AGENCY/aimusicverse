...
// Legacy constant - use getBotMention() for dynamic value
// Kept for backward compatibility only
export const APP_HANDLE = getBotMention();
...
export class TrackNameBuilder {
   ...
   */
  private static buildDisplayTitle(title: string, performer: string, context: TrackNameContext): string {
