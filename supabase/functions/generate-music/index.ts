          ...
          messages: [
            {
              role: "system",
              content:
                "You are a music prompt enhancement AI. Transform user descriptions into detailed, professional music generation prompts. Include genre, mood, instruments, tempo, and style details. Keep it concise but rich.",
            },
            {
              role: "user",
