...
export const STRUCTURE_TAGS: SunoMetaTag[] = [
  { value: "Intro", label: "Интро", hint: "Вступление песни", example: "[Intro]" },
  {
    ...
    label: "Инстр. интро",
    hint: "Инструментальное вступление",
...
export const TECHNIQUE_TAGS: SunoMetaTag[] = [
  {
    value: "fingerpicked guitar",
    label: "Пальцевая гитара",
    hint: "Перебор пальцами",
    example: "[fingerpicked guitar]",
  },
...
export const COMPOUND_TAG_TEMPLATES: SunoMetaTag[] = [
  {
    value: "Verse | Male Vocal | Intimate",
    label: "Куплет интимный",
    hint: "Мужской голос, интимно",
    example: "[Verse | Male Vocal | Intimate]",
  },
  {
    value: "Verse | Female Vocal | Powerful",
    label: "Куплет мощный",
    hint: "Женский вокал, мощный",
    example: "[Verse | Female Vocal | Powerful]",
  },
  {
    value: "Chorus | Full Band | Anthemic",
    label: "Припев антемный",
    hint: "Полный состав, гимновый",
    example: "[Chorus | Full Band | Anthemic]",
  },
  {
    value: "Chorus | Stacked Harmonies | Explosive",
    label: "Припев взрывной",
    hint: "Многоголосие, взрыв",
    example: "[Chorus | Stacked Harmonies | Explosive]",
  },
  {
    value: "Bridge | Whisper | Atmospheric | Piano Only",
    label: "Бридж атмосферный",
    hint: "Шёпот, атмосфера, пианино",
    example: "[Bridge | Whisper | Atmospheric | Piano Only]",
  },
  {
    value: "Pre-Chorus | Building | Soft Drums",
    label: "Пре-припев нарастающий",
    hint: "Нарастание, мягкие ударные",
    example: "[Pre-Chorus | Building | Soft Drums]",
  },
  {
    value: "Intro | Dark Synth | !fade_in",
    label: "Интро тёмное",
    hint: "Тёмный синт, плавное появление",
    example: "[Intro | Dark Synth | !fade_in]",
  },
  {
    value: "Outro | Fade Out | Echo",
    label: "Аутро с эхо",
    hint: "Затухание с эхом",
    example: "[Outro | Fade Out | Echo]",
  },
];
...
export const SOLO_DESCRIPTOR_TEMPLATES: SunoMetaTag[] = [
  {
    value: "Instrumental Solo: Electric Guitar | Shredding | High Gain",
    label: "Гитара шреддинг",
    hint: "Скоростное соло на перегрузе",
    example: "[Instrumental Solo: Electric Guitar | Shredding | High Gain]",
  },
  {
    value: "Instrumental Solo: Piano | Emotional | Rubato",
    label: "Пианино эмоциональное",
    hint: "Выразительное соло со свободным темпом",
    example: "[Instrumental Solo: Piano | Emotional | Rubato]",
  },
  {
    value: "Instrumental Solo: Synth | Modulated | Spacey",
    label: "Синт космический",
    hint: "Модулированный космический звук",
    example: "[Instrumental Solo: Synth | Modulated | Spacey]",
  },
  {
    value: "Instrumental Solo: Saxophone | Smooth | Jazz",
    label: "Саксофон джазовый",
    hint: "Гладкое джазовое соло",
    example: "[Instrumental Solo: Saxophone | Smooth | Jazz]",
  },
  {
    value: "Instrumental Break: Dark Synth | 8 bars | No Vocals",
    label: "Брейк 8 тактов",
    hint: "Инструментальная вставка без вокала",
    example: "[Instrumental Break: Dark Synth | 8 bars | No Vocals]",
  },
];
...
export const TRANSFORM_TAGS: SunoMetaTag[] = [
  ...
  {
    value: "Soft -> Explosive",
    label: "Мягко → Взрыв",
    hint: "Нарастание к кульминации",
    example: "[Soft -> Explosive]",
  },
  { value: "Sad -> Hopeful", label: "Грустно → Надежда", hint: "Эмоциональный сдвиг", example: "[Sad -> Hopeful]" },
  {
    value: "Calm -> Intense",
    label: "Спокойно → Интенсивно",
    hint: "Нарастание напряжения",
    example: "[Calm -> Intense]",
  },
  {
    value: "Acoustic -> Electric",
    label: "Акустика → Электро",
    hint: "Смена звучания",
    example: "[Acoustic -> Electric]",
  },
  {
    value: "Verse -> Breakdown",
    label: "Куплет → Брейкдаун",
    hint: "Переход в минимализм",
...
export const DRILL_TRAP_TAGS: SunoMetaTag[] = [
  ...
  {
    value: "Drill Glockenspiel",
    label: "UK Drill глокеншпиль",
    hint: "Характерная мелодия UK Drill",
    example: "[Drill Glockenspiel]",
  },
  ...
  {
    value: "Aggressive Delivery",
    label: "Агрессивная подача",
    hint: "Напористая манера исполнения",
    example: "[Aggressive Delivery]",
  },
...
export const ALL_SUNO_TAG_CATEGORIES: SunoTagCategory[] = [...SUNO_META_TAG_CATEGORIES, ...SUNO_V5_TAG_CATEGORIES];
