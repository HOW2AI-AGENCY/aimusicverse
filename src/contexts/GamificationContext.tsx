...
export function GamificationProvider({ children }: { children: ReactNode }) {
  ...
  useEffect(() => {
    if (pendingAchievement) {
      showAchievement(pendingAchievement.name, pendingAchievement.description, pendingAchievement.icon, {
  ...
  return <GamificationContext.Provider value={{ pendingAchievement }}>{children}</GamificationContext.Provider>;
}
