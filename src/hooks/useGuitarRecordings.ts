  ...
  const saveRecording = useMutation({
    mutationFn: async ({
      ...
      const recording = {
        ...
        beats: structuredClone(analysis.beats || []),
        downbeats: structuredClone(analysis.downbeats || []),
        key: analysis.key || null,
        chords: structuredClone(analysis.chords || []),
        strumming: structuredClone(analysis.strumming || []),
        ...
        notes: structuredClone(analysis.notes || []),
        generated_tags: analysis.generatedTags || [],
        style_description: analysis.styleDescription || null,
        style_analysis: structuredClone(analysis.style || {}),
        analysis_status: structuredClone(
          analysis.analysisComplete || { beats: false, chords: false, transcription: false },
        ),
      };
