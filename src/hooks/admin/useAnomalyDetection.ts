...
function detectZScoreAnomalies(data: MetricDataPoint[], config: MetricConfig, zThreshold: number = 2): Anomaly[] {
...
function detectThresholdAnomalies(data: MetricDataPoint[], config: MetricConfig): Anomaly[] {
...
function detectTrendAnomalies(data: MetricDataPoint[], config: MetricConfig, trendDays: number = 3): Anomaly[] {
