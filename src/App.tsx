...
const GenerationStatsPanel = lazy(() => import(/* webpackChunkName: "admin" */ "./components/admin/GenerationStatsPanel"));
const PerformanceDashboard = lazy(() => import(/* webpackChunkName: "admin" */ "./components/performance"));
const UserBalancesPanel = lazy(() => import(/* webpackChunkName: "admin" */ "./components/admin/UserBalancesPanel"));
const StarsPaymentsPanel = lazy(() => import(/* webpackChunkName: "admin" */ "./components/admin/StarsPaymentsPanel"));
const GenerationLogsPanel = lazy(() => import(/* webpackChunkName: "admin" */ "./components/admin/GenerationLogsPanel"));
const DeeplinkAnalyticsPanel = lazy(() => import(/* webpackChunkName: "admin" */ "./components/admin/DeeplinkAnalyticsPanel"));
const EnhancedAnalyticsPanel = lazy(() => import(/* webpackChunkName: "admin" */ "./components/admin/EnhancedAnalyticsPanel"));
const ModerationReportsPanel = lazy(() => import(/* webpackChunkName: "admin" */ "./components/admin/ModerationReportsPanel"));
