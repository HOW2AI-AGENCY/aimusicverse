 ...
 */
export async function loadAudioProgressive(url: string, options: StreamingLoaderOptions = {}): Promise<Blob> {
 ...
 */
export async function createOptimizedBlobUrl(url: string, options?: StreamingLoaderOptions): Promise<string> {
