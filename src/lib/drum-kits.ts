...
const kit808: DrumKit = {
  ...
  sounds: [
    ...
    },
    {
      ...
      color: "#3b82f6",
      type: "noise",
      params: { noise: { type: "white" }, envelope: { attack: 0.002, decay: 0.15, sustain: 0.02, release: 0.15 } },
    },
    {
      id: "clap",
      name: "Clap",
      ...
      color: "#8b5cf6",
      type: "noise",
      params: { noise: { type: "pink" }, envelope: { attack: 0.003, decay: 0.12, sustain: 0, release: 0.12 } },
    },
    {
      id: "hihat-c",
      name: "Closed HH",
  ...
  sounds: [
    {
      ...
      params: {
        ...
        octaves: 10,
        oscillator: { type: "sine" },
        envelope: { attack: 0.002, decay: 0.4, sustain: 0.01, release: 0.8 },
      },
    },
    {
      id: "snare",
      ...
      color: "#3b82f6",
      type: "noise",
      params: { noise: { type: "white" }, envelope: { attack: 0.002, decay: 0.2, sustain: 0.01, release: 0.18 } },
    },
    {
      id: "clap",
      name: "Clap",
      ...
      color: "#8b5cf6",
      type: "noise",
      params: { noise: { type: "pink" }, envelope: { attack: 0.004, decay: 0.08, sustain: 0, release: 0.08 } },
    },
    {
      id: "hihat-c",
      name: "Closed HH",
    ...
    },
    {
      ...
      params: {
        frequency: 400,
        envelope: { attack: 0.001, decay: 0.3, release: 0.12 },
        harmonicity: 5,
        modulationIndex: 35,
        resonance: 4500,
        octaves: 1.5,
    ...
    },
    {
      ...
      params: {
        ...
        octaves: 8,
        oscillator: { type: "sine" },
        envelope: { attack: 0.001, decay: 0.2, sustain: 0, release: 0.25 },
      },
    },
    {
      id: "ride",
  ...
  sounds: [
    {
      ...
      params: {
        ...
        octaves: 5,
        oscillator: { type: "sine" },
        envelope: { attack: 0.001, decay: 0.3, sustain: 0.05, release: 0.8 },
      },
    },
    {
      id: "snare",
      ...
      type: "noise",
      params: { noise: { type: "white" }, envelope: { attack: 0.001, decay: 0.15, sustain: 0.03, release: 0.2 } },
    },
    {
      id: "rimshot",
      name: "Rimshot",
      ...
      type: "synth",
      params: { oscillator: { type: "triangle" }, envelope: { attack: 0.001, decay: 0.05, sustain: 0, release: 0.05 } },
    },
    {
      id: "hihat-c",
      name: "Hi-Hat Closed",
    ...
    },
    {
      ...
      params: {
        ...
        octaves: 3,
        oscillator: { type: "sine" },
        envelope: { attack: 0.001, decay: 0.4, sustain: 0.02, release: 0.6 },
      },
    },
    {
      id: "tom-h",
  ...
  sounds: [
    {
      ...
      params: {
        ...
        octaves: 4,
        oscillator: { type: "sine" },
        envelope: { attack: 0.005, decay: 0.4, sustain: 0.02, release: 0.8 },
      },
    },
    {
      id: "snare",
      ...
      color: "hsl(var(--primary))",
      type: "noise",
      params: { noise: { type: "brown" }, envelope: { attack: 0.002, decay: 0.2, sustain: 0.01, release: 0.3 } },
    },
    {
      id: "shaker",
      name: "Shaker",
      ...
      color: "hsl(var(--accent))",
      type: "noise",
      params: { noise: { type: "pink" }, envelope: { attack: 0.005, decay: 0.08, sustain: 0, release: 0.08 } },
    },
    {
      id: "hihat-c",
      name: "Hi-Hat",
    ...
    },
    {
      ...
      params: {
        frequency: 350,
        envelope: { attack: 0.002, decay: 0.25, release: 0.1 },
        harmonicity: 3,
        modulationIndex: 20,
        resonance: 2500,
        octaves: 0.8,
    ...
    },
    {
      ...
      color: "hsl(var(--warning))",
      type: "synth",
      params: { oscillator: { type: "square" }, envelope: { attack: 0.001, decay: 0.02, sustain: 0, release: 0.02 } },
    },
    {
      id: "perc2",
      name: "Dust",
      ...
      color: "hsl(var(--warning))",
      type: "noise",
      params: { noise: { type: "brown" }, envelope: { attack: 0.001, decay: 0.03, sustain: 0, release: 0.03 } },
    },
    {
      id: "bass",
      name: "Sub",
  ...
  sounds: [
    {
      ...
      params: {
        ...
        octaves: 10,
        oscillator: { type: "sine" },
        envelope: { attack: 0.001, decay: 1.0, sustain: 0.05, release: 1.5 },
      },
    },
    {
      id: "snare",
      ...
      color: "#3b82f6",
      type: "noise",
      params: { noise: { type: "white" }, envelope: { attack: 0.001, decay: 0.14, sustain: 0, release: 0.12 } },
    },
    {
      id: "clap",
      name: "Clap",
      ...
      color: "#8b5cf6",
      type: "noise",
      params: { noise: { type: "white" }, envelope: { attack: 0.002, decay: 0.1, sustain: 0, release: 0.08 } },
    },
    {
      id: "hihat-c",
      name: "Hi-Hat",
    ...
    },
    {
      ...
      color: "#f59e0b",
      type: "synth",
      params: { oscillator: { type: "triangle" }, envelope: { attack: 0.001, decay: 0.03, sustain: 0, release: 0.03 } },
    },
    {
      id: "perc2",
      name: "Rim",
      ...
      color: "#fbbf24",
      type: "synth",
      params: { oscillator: { type: "square" }, envelope: { attack: 0.001, decay: 0.025, sustain: 0, release: 0.02 } },
    },
    {
      id: "808bass",
      name: "808 Bass",
      ...
      params: {
        ...
        octaves: 8,
        oscillator: { type: "sine" },
        envelope: { attack: 0.001, decay: 1.2, sustain: 0.15, release: 2.0 },
      },
    },
  ],
};
...
const kitEthnic: DrumKit = {
  ...
  sounds: [
    ...
    },
    {
      ...
      color: "hsl(var(--muted-foreground))",
      type: "noise",
      params: { noise: { type: "pink" }, envelope: { attack: 0.002, decay: 0.06, sustain: 0, release: 0.06 } },
    },
    {
      id: "claves",
      name: "Claves",
      ...
      color: "hsl(var(--muted-foreground))",
      type: "synth",
      params: { oscillator: { type: "sine" }, envelope: { attack: 0.001, decay: 0.08, sustain: 0, release: 0.08 } },
    },
    {
      id: "bongo-h",
      name: "Bongo High",
