...
const MOOD_PATTERNS =
  /\b(melanchol|happy|sad|dark|bright|aggressive|calm|dreamy|atmospheric|energetic|chill|upbeat|mellow|intense|romantic|nostalgic|epic|ethereal|groovy|funky|angry|peaceful|mysterious|playful|somber|triumphant)\b/i;
const VOCAL_PATTERNS =
  /\b(vocal|rap|sing|voice|female|male|choir|acapella|harmony|soprano|tenor|bass|alto|falsetto|whisper|scream|growl)\b/i;
...
const INSTRUMENT_PATTERNS =
  /\b(piano|guitar|drum|bass|synth|string|orchestra|violin|cello|brass|horn|flute|sax|organ|harp|percussion|808|beat|pad|arpeggio|lead|pluck)\b/i;
const STRUCTURE_PATTERNS =
  /\b(intro|verse|chorus|bridge|outro|drop|breakdown|build|hook|pre-chorus|interlude|solo|refrain)\b/i;
