      ...
      <AlertDialog open={open} onOpenChange={onOpenChange}>
        <AlertDialogContent>
          <AlertDialogHeader>
            ...
            <AlertDialogDescription asChild>
              <div className="space-y-4 text-left">
                <p>
                  Вы собираетесь опубликовать проект "{project.title}". После публикации проект станет доступен всем
                  пользователям.
                </p>
                ...
                <div className="bg-muted/50 rounded-lg p-4 space-y-3">
                  ...
                  <div className="flex items-center justify-between">
                    ...
                    <Badge variant={hasBanner ? "default" : "outline"}>{hasBanner ? "Добавлен" : "Отсутствует"}</Badge>
                  </div>
                ...
                {!isReadyToPublish && (
                  <div className="flex items-start gap-2 text-amber-500 bg-amber-500/10 rounded-lg p-3">
                    ...
                    <p className="text-sm">
                      Для публикации требуется хотя бы один готовый трек. Сгенерируйте треки перед публикацией.
                    </p>
                  </div>
                )}
          ...
          <AlertDialogFooter>
            ...
            <AlertDialogAction onClick={handlePublish} disabled={!isReadyToPublish || isPending} className="gap-2">
              {isPending ? (
                <>Публикация...</>
              ) : (
                <>
