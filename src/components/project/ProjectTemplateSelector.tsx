...
export function ProjectTemplateSelector({ onSelect, selectedId, className }: ProjectTemplateSelectorProps) {
  return (
          ...
          <div className="flex items-start gap-2.5">
            <div
              className={cn(
                ...
                selectedId === template.id ? "bg-primary text-primary-foreground" : "bg-primary/10 text-primary",
              )}
            >
              {template.icon}
            </div>
