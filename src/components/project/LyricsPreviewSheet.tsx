        ...
        <SheetContent side="bottom" className="h-[85vh] rounded-t-2xl">
          <SheetHeader className="pb-2">
            ...
            <SheetDescription className="flex items-center gap-2">
              {track.style_prompt && <span className="truncate">{track.style_prompt}</span>}
                  ...
                  {hasGeneratedLyrics && (
                    <div className="space-y-2">
                      ...
                      <div className="bg-primary/5 border border-primary/20 rounded-lg p-4">
                        <p className="whitespace-pre-wrap text-sm leading-relaxed">{cleanLyrics(generatedLyrics)}</p>
                      </div>
                    </div>
                  )}
                  ...
                  <div className="space-y-2">
                    ...
                    {isEditingLyrics ? (
                      ...
                      <div className="bg-muted/30 rounded-lg p-4">
                        <p className="whitespace-pre-wrap text-sm leading-relaxed">{draftLyrics}</p>
                      </div>
                    ) : (
                      <div className="bg-muted/20 rounded-lg p-8 text-center">
                        <FileText className="w-10 h-10 text-muted-foreground/50 mx-auto mb-3" />
                        <p className="text-muted-foreground text-sm">Текст песни ещё не написан</p>
                      </div>
                    )}
                  </div>
                </div>
