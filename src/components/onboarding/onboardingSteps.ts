...
export const ONBOARDING_STEPS: OnboardingStep[] = [
  {
    ...
    icon: Sparkles,
    features: ["Генерация полноценных треков с AI", "Профессиональное качество звука", "Неограниченные эксперименты"],
  ...
  },
  {
    ...
    icon: Music2,
    route: "/",
    features: ["Быстрые пресеты одним нажатием", "Простой и кастомный режимы", "A/B версии для сравнения"],
  ...
  },
  {
    ...
    icon: Library,
    route: "/library",
    features: ["Свайп влево — добавить в очередь", "Свайп вправо — сменить версию", "Экспорт в разных форматах"],
  ...
  },
  {
    ...
    icon: Wand2,
    route: "/library",
    features: ["AI-разделение на вокал, бас, ударные", "Замена секций трека", "Создание ремиксов"],
  ...
  },
  {
    ...
    icon: Trophy,
    features: ["Ежедневные бонусы за вход", "+3 кредита за публикацию", "Система уровней и наград"],
