/**
 * Optimized Mobile Track Studio Layout (without stems)
 * 
...
type Tab = 'player' | 'lyrics' | 'editor' | 'settings';

interface TrackStudioMobileOptimizedProps {
  trackTitle: string;
  isPlaying: boolean;
  currentTime: number;
  duration: number;
...
export function TrackStudioMobileOptimized({
  ...
  settingsContent,
  hasEditor,
}: TrackStudioMobileOptimizedProps) {
