...
export const StemSeparationProgress = memo(function StemSeparationProgress({
  ...
  const stemTypes =
    task.mode === "detailed" ? ["vocals", "drums", "bass", "piano", "guitar", "other"] : ["vocals", "instrumental"];
            ...
            return (
              <motion.div
                ...
                className={cn(
                  ...
                  isReady || isCompleted ? "bg-background border-border" : "bg-muted/30 border-transparent",
                )}
              >
