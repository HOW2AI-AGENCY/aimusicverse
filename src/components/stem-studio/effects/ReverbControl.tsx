...
import { RotateCcw, Waves } from "@/lib/icons";
...
export function ReverbControl({ settings, onChange, onPresetChange }: ReverbControlProps) {
    ...
    <div className="space-y-4">
      ...
      <div className="flex items-center justify-between gap-2">
        <div className="flex items-center gap-3">
          <Switch checked={settings.enabled} onCheckedChange={handleToggle} id="reverb-toggle" />
