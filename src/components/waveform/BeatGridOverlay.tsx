...
export const BeatGridOverlay = memo(function BeatGridOverlay({
  ...
  return (
    <div className={cn("absolute inset-0 pointer-events-none overflow-hidden", className)} style={{ height }}>
        ...
        return (
          <div
            ...
            className={cn(
              ...
              beat.isDownbeat ? "w-[2px] bg-primary/40" : "w-px bg-muted-foreground/20",
              isPassed && "opacity-60",
            )}
            style={{ left: `${position}%` }}
          />
