      ...
      <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.5 }}>
        ...
        >
          ...
          <div className="relative h-48 sm:h-64 overflow-hidden">
            ...
            {/* Featured badge */}
            <Badge className="absolute top-4 left-4 bg-primary/90">Рекомендуем</Badge>
          </div>
          ...
          <div className="relative p-6 -mt-16">
            ...
            {post.excerpt && <p className="text-muted-foreground line-clamp-2 mb-4">{post.excerpt}</p>}
        ...
        <div className="flex flex-col sm:flex-row">
          ...
          <div className="flex-1 p-4 flex flex-col">
            <div className="flex-1">
              ...
              {post.excerpt && <p className="text-muted-foreground text-sm line-clamp-2 mt-2">{post.excerpt}</p>}
            </div>
