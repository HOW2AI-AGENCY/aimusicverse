    ...
    return (
      <div className="space-y-3">
        ...
        <div className="p-6 rounded-xl bg-muted/30 border border-border text-center">
          ...
          <p className="text-sm text-muted-foreground mb-4">Создайте музыкальный клип для вашего трека</p>
    ...
    return (
      <div className="space-y-3">
        ...
        <div className="p-6 rounded-xl bg-muted/30 border border-primary/20 text-center">
          ...
          <p className="text-sm text-muted-foreground">Генерация видео может занять несколько минут...</p>
        </div>
      </div>
    );
  }
    ...
    return (
      <div className="space-y-3">
        ...
        <div className="p-6 rounded-xl bg-destructive/10 border border-destructive/20 text-center">
          ...
          <p className="text-sm text-destructive mb-2">{error || "Не удалось создать видеоклип"}</p>
