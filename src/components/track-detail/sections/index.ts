 ...
 * - TrackReferencesSection: Artist, Project, Audio references
 * - TrackStyleSection: Style and tags
 * - TrackPromptSection: Prompt with bookmark
 * - TrackLyricsSection: Lyrics display
 * - TrackTechnicalSection: Technical information
