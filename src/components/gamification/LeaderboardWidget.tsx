  ...
  return (
    <Card className="p-3 bg-gradient-to-br from-card/90 to-card/50 border-primary/10">
      <div className="flex items-center justify-between mb-3">
        ...
        <Button variant="ghost" size="sm" className="h-6 text-xs gap-1" onClick={() => navigate("/gamification")}>
      ...
      <div className="flex items-end justify-center gap-2 mb-3">
        {topThree.map((entry, index) => {
          ...
          return (
            ...
            >
              <div className={cn("relative", position === 1 && "mb-1")}>
                {position === 1 && (
      ...
      {userPosition && (
        ...
        >
          ...
          <span className="text-xs text-primary font-medium">{userCredits?.experience || 0} XP</span>
        </motion.div>
      )}
