  ...
  return (
    <div className={cn("flex gap-3 py-2", className)}>
      ...
      <div className="flex-1 min-w-0 flex flex-col justify-center gap-0.5">
        {/* Row 1: Title */}
        <h3 className="text-sm font-semibold truncate leading-tight">{track.title || "Без названия"}</h3>
        ...
        <div className="min-w-0 w-full">
          <ScrollableTagsRow style={track.style} tags={track.tags} onClick={handleTagClick} />
        </div>
      </div>
    </div>
  );
