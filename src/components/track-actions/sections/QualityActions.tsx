...
export function QualityActions({ track, state, onAction, variant, isProcessing }: QualityActionsProps) {
  ...
  if (hasHdAudio) {
    return (
      <Button variant="ghost" className="w-full justify-start gap-3 h-12 text-green-500" disabled>
  ...
  if (isUpscaling) {
    return (
      <Button variant="ghost" className="w-full justify-start gap-3 h-12" disabled>
