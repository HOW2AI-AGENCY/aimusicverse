...
export type HintContext = "library" | "player" | "studio" | "generation" | "social";
...
export const HINT_REGISTRY = {
  ...
  "quick-create-first": {
    ...
    message: "Нажмите «Создать трек», опишите музыку словами — AI создаст трек за минуту. Стоимость: 10–12 кредитов.",
    emoji: "✨",
    priority: 0,
    context: "generation",
  },
