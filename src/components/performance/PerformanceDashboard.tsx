...
export function PerformanceDashboard() {
  ...
  const {
    ...
    isLoading,
    refetch,
  } = usePerformanceMetrics(dateRange === "7d" ? 20 : dateRange === "30d" ? 60 : 180);
    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
        <div>
          ...
          <p className="text-sm text-muted-foreground mt-1">Track Core Web Vitals and bundle size over time</p>
        </div>
        ...
        <div className="flex items-center gap-2">
          ...
          <Button size="sm" onClick={handleCollectMetrics} disabled={addMetric.isPending}>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <CoreWebVitalsCard metric={latestMetric} previousMetric={previousMetric} isLoading={isLoading} />
        <LighthouseScoresCard metric={latestMetric} previousMetric={previousMetric} isLoading={isLoading} />
        <BundleSizeCard metric={latestMetric} previousMetric={previousMetric} isLoading={isLoading} />
      </div>
        ...
        <TabsContent value="vitals" className="space-y-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <PerformanceChart
              ...
              fields={[{ key: "cls", label: "CLS", color: "hsl(var(--chart-4))" }]}
              targetLine={0.1}
              isLoading={isLoading}
            />
            <PerformanceChart
              ...
              fields={[{ key: "tbt_ms", label: "TBT (ms)", color: "hsl(var(--chart-5))" }]}
              targetLine={300}
              isLoading={isLoading}
            />
          </div>
