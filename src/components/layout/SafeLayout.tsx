...
export function SafeLayout({
  ...
  return (
    <div
      className={cn("tg-safe-container", withHorizontalSafeArea && safeAreaClasses.safeHorizontal, className)}
      style={{
...
export function SafeBottom({ children, className, withBottomNav = false, extraPadding = 0 }: SafeBottomProps) {
