    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="sm:max-w-[500px]">
        <DialogHeader>
          ...
          <DialogDescription>Share "{track.title}" with others</DialogDescription>
        </DialogHeader>
        ...
        <div className="space-y-4 py-4">
          ...
          <div className="flex items-center gap-4 p-4 rounded-lg bg-muted/50">
            ...
            <div className="flex-1 min-w-0">
              ...
              {track.style && <p className="text-sm text-muted-foreground">{track.style}</p>}
          ...
          <div className="space-y-2">
            ...
            <div className="flex gap-2">
              <Input
                value={shareUrl}
                readOnly
                className={cn("flex-1 font-mono text-sm", loading && "animate-pulse")}
            ...
            <p className="text-xs text-muted-foreground">Anyone with this link can view and listen to this track</p>
          </div>

          {/* Share Actions */}
          <div className="grid grid-cols-2 gap-2">
            <Button variant="outline" className="gap-2" onClick={handleShare} disabled={loading || !shareUrl}>
              <Share2 className="h-4 w-4" />
              Поделиться
            </Button>

            {canShare && track.cover_url && (
              <Button variant="outline" className="gap-2" onClick={handleShareToStory}>
                <Camera className="h-4 w-4" />В историю
              </Button>
            )}
            ...
            <Button variant="outline" className="gap-2" onClick={handleOpenInBrowser} disabled={loading || !shareUrl}>
