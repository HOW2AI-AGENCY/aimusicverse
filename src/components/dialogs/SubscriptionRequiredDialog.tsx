...
export function SubscriptionRequiredDialog({
  ...
  return (
    <UnifiedDialog
      ...
      description={`Чтобы ${feature}, необходимо оформить подписку Pro или выше`}
      size="md"
      footer={
    ...
    >
      <div className="text-center mb-4">
        <motion.div
          className="mx-auto w-16 h-16 rounded-full bg-gradient-to-br from-amber-500/20 to-orange-500/20 flex items-center justify-center"
          initial={{ scale: 0 }}
          animate={{ scale: 1 }}
