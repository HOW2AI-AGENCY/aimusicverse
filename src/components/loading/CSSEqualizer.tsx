 ...
 */
export const CSSEqualizer = memo(function CSSEqualizer({ size = "md", className, barCount = 5 }: CSSEqualizerProps) {
  const sizes = sizeMap[size];

  return (
    <div className={cn("flex items-end justify-center", sizes.height, sizes.gap, className)} aria-hidden="true">
