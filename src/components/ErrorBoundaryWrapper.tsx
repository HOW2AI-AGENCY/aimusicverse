      ...
      return (
        <Card className="p-6 m-4">
          <div className="flex flex-col items-center text-center space-y-4">
            ...
            <p className="text-muted-foreground">{this.state.error?.message || "Произошла неожиданная ошибка"}</p>
            ...
            {isDev && this.state.error?.stack && (
              <details className="w-full text-left">
                ...
                <pre className="mt-2 p-2 bg-muted rounded text-xs overflow-auto max-h-40">{this.state.error.stack}</pre>
