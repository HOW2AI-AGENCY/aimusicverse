...
export function LyricsValidationAlert({ lyrics, onAutoFix, compact = false, className }: LyricsValidationAlertProps) {
    ...
    return (
      <div className={cn("flex items-center gap-2", className)}>
        ...
        {validation.canAutoFix && onAutoFix && (
          <Button variant="ghost" size="sm" className="h-6 px-2 text-xs gap-1" onClick={handleAutoFix}>
    ...
    >
      ...
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-3">
          <div className={cn("flex items-center justify-center w-10 h-10 rounded-full", getScoreBg(validation.score))}>
            {validation.score >= 80 ? (
          ...
          <div>
            <div className="flex items-center gap-2">
              <span className={cn("text-lg font-bold", getScoreColor(validation.score))}>{validation.score}</span>
      ...
      {/* Auto-fix button */}
      {validation.canAutoFix && onAutoFix && (
        <Button onClick={handleAutoFix} className="w-full gap-2" variant="secondary" size="sm">
