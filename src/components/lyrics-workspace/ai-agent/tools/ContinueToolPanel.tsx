          ...
          <>
            ...
            <div className="space-y-1.5">
              ...
              <div className="p-2 rounded-md bg-muted/30 border border-border/50">
                <p className="text-xs font-mono whitespace-pre-wrap text-muted-foreground">{lastLines || "..."}</p>
              </div>
            </div>
            ...
            {/* Execute Button */}
            <Button onClick={handleContinue} disabled={isLoading} className="w-full bg-sky-500 hover:bg-sky-600">
