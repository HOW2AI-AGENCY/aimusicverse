  ...
  return (
    <div className={cn("space-y-3", className)}>
      ...
      <div className="flex items-center gap-3">
        <Button variant="outline" size="icon" onClick={() => seek(0)} disabled={isLoading} className="h-9 w-9">
          <SkipBack className="h-4 w-4" />
        </Button>

        <Button variant="default" size="icon" onClick={togglePlay} disabled={isLoading} className="h-10 w-10">
          {isLoading ? (
