  ...
  return (
    <motion.button
      ...
      className={cn(
        ...
        product.is_featured && !isSelected && 'border-amber-500/50 bg-gradient-to-br from-amber-500/15 via-amber-500/5 to-transparent',
        isBestValue && !product.is_featured && !isSelected && 'border-green-500/50 bg-gradient-to-br from-green-500/15 via-green-500/5 to-transparent',
        className
      )}
    >
      ...
      <div className={cn(
        ...
        isSelected ? "bg-primary/30" : product.is_featured ? "bg-amber-500/30" : isBestValue ? "bg-green-500/30" : "bg-muted"
      )} />
      ...
      <div className="relative z-10">
        ...
        >
          <motion.span 
            ...
            animate={isSelected ? { 
              textShadow: ['0 0 10px rgba(var(--primary), 0)', '0 0 20px rgba(var(--primary), 0.3)', '0 0 10px rgba(var(--primary), 0)']
            } : {}}
          ...
          {pricePerTrack && (
            <motion.div 
              className={cn(
                ...
                isBestValue ? "bg-green-500/15 text-green-600 dark:text-green-400 font-medium" : "bg-muted text-muted-foreground"
              )}
              whileHover={{ scale: 1.02 }}
            >
