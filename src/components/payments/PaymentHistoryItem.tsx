...
import { 
  ...
  RefreshCw, Ban, Sparkles, Zap, Crown 
} from 'lucide-react';
        ...
        <CardContent className="p-4">
          <div className="flex items-start justify-between gap-4">
            ...
            <div className="flex items-start gap-3 flex-1 min-w-0">
              ...
              <div className="flex-1 min-w-0">
                <h4 className="font-semibold text-sm truncate">
                  {formatProductName(transaction.product_code)}
                </h4>
                ...
                {transaction.credits_granted && isCompleted && (
                  ...
                  >
                    ...
                    +{transaction.credits_granted.toLocaleString()} {language === 'ru' ? 'кредитов' : 'credits'}
                  </motion.p>
                )}
              </div>
            </div>
            ...
            <div className="flex flex-col items-end gap-2 flex-shrink-0">
              ...
              >
                <span className="mr-1.5" aria-hidden="true">{status.icon}</span>
