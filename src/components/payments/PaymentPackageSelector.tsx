...
export function PaymentPackageSelector({ products, selectedProduct, onSelect }: PaymentPackageSelectorProps) {
  ...
  const getProductLabel = (product: StarsProduct) => {
    if (product.is_featured)
      return { text: "Популярный", icon: TrendingUp, color: "bg-primary text-primary-foreground" };
            ...
            >
              ...
              <div className="flex-1 min-w-0">
                <div className="flex items-center gap-2">
                  <Zap
                    className={cn("w-4 h-4 transition-colors", isSelected ? "text-primary" : "text-muted-foreground")}
                  />
