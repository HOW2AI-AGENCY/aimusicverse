...
const faqItems: FAQItem[] = [
  {
    ...
    answer:
      'Нажмите на кнопку "+" в нижней навигации или "Создать трек" на главной странице. Опишите желаемый стиль музыки и нажмите "Сгенерировать".',
    category: "generation",
  },
  {
    id: "2",
  ...
  },
  {
    ...
    answer:
      'Откройте трек → меню "Ещё" → "Разделить на стемы". Это разделит трек на вокал, ударные, бас и другие инструменты.',
    category: "studio",
  },
  {
    id: "4",
  ...
  },
  {
    ...
    answer:
      'Откройте меню трека → "Поделиться". Вы можете отправить ссылку, скопировать её или поделиться в Telegram историях.',
    category: "sharing",
  },
  {
    id: "6",
    ...
    answer:
      "Кредиты — это валюта для генерации треков. Вы получаете их ежедневно при входе, за достижения и активность.",
    category: "credits",
  },
];
    ...
    <div className="flex flex-col h-full">
      ...
      <ScrollArea className="flex-1">
        <div className="p-4 space-y-6">
          ...
          <section>
            ...
            <div className="space-y-2">
              {filteredFaq.slice(0, 5).map((item) => (
                <motion.div key={item.id} initial={false} className="border rounded-lg overflow-hidden">
                  <button
          ...
          {/* Help Topics */}
          <section>
            <h3 className="text-sm font-semibold text-muted-foreground uppercase tracking-wider mb-3">Темы справки</h3>
          ...
          {/* Video Tutorials */}
          <section>
            <h3 className="text-sm font-semibold text-muted-foreground uppercase tracking-wider mb-3">Видео-уроки</h3>
          ...
          <section className="pb-4">
            <div className="bg-muted/50 rounded-xl p-4 text-center">
              ...
              <p className="text-sm text-muted-foreground mb-3">Напишите нам в Telegram</p>
