...
export function MonitoringHub({ onNavigateToTab }: MonitoringHubProps) {
  ...
  const overallStatus = hasCritical ? "critical" : isDegraded || warningCount > 0 ? "warning" : "good";
    ...
    <div className="space-y-4">
        ...
        <CardContent className="p-3 sm:p-4">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-3">
              ...
              <div>
                <div className={cn("text-base sm:text-lg font-semibold", config.color)}>{config.label}</div>
      ...
      <div className="grid grid-cols-2 sm:grid-cols-4 gap-2 sm:gap-3">
        ...
        <QuickStat
          ...
          status={perfStats.avgLcp > 4000 ? "critical" : perfStats.avgLcp > 2500 ? "warning" : "good"}
        />
      </div>
        ...
        <Card>
          <CardHeader className="pb-2">
            <div className="flex items-center justify-between">
              ...
              {onNavigateToTab && (
                <Button variant="ghost" size="sm" className="h-7 text-xs" onClick={() => onNavigateToTab("alerts")}>
            ...
            <div className="text-center">
              <div
                className={cn(
                  ...
                  (generationStats?.successRate || 100) >= 95
                    ? "text-green-500"
                    : (generationStats?.successRate || 100) >= 85
                      ? "text-yellow-500"
                      : "text-red-500",
                )}
              >
