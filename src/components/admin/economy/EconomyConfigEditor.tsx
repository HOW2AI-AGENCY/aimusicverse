...
const DEFAULT_VALUES: Record<string, number> = {
  ...
  STEM_SEPARATION_SIMPLE_COST: ECONOMY.STEM_SEPARATION_SIMPLE_COST,
  STEM_SEPARATION_DETAILED_COST: ECONOMY.STEM_SEPARATION_DETAILED_COST,
  REPLACE_SECTION_COST: ECONOMY.REPLACE_SECTION_COST,
