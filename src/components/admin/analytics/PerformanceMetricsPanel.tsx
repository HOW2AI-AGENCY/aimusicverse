...
export function PerformanceMetricsPanel({ timePeriod }: PerformanceMetricsPanelProps) {
  return (
    <div className="space-y-4">
              ...
              <CardContent className="p-4">
                <div className="flex items-start justify-between">
                  <div className="flex items-center gap-2">
                    ...
                    <div>
                      ...
                      <p className="text-xs text-muted-foreground">{threshold.name}</p>
                    </div>
                  </div>
                  <Badge variant={
                    rating === 'good' ? 'default' : 
                    ...
                    {rating === 'good' ? 'Хорошо' : 
                     rating === 'needs-improvement' ? 'Средне' : 
                     'Плохо'}
                  </Badge>
                </div>
                ...
                <div className="mt-4">
                  ...
                  <p className="text-xs text-muted-foreground mt-1">
                    {vital.samples.toLocaleString()} измерений
                  </p>
                </div>
      ...
      <Card>
        <CardHeader>
          <CardTitle className="text-base">Размер бандла</CardTitle>
        </CardHeader>
        <CardContent>
