...
export function QuickActionsPanel() {
  ...
  return (
    <>
      ...
      {/* Broadcast Dialog */}
      <UnifiedDialog variant="sheet" open={broadcastOpen} onOpenChange={setBroadcastOpen} title="Быстрая рассылка">
        <div className="space-y-4 p-4">
          ...
          <Button onClick={handleBroadcast} disabled={quickBroadcast.isPending} className="w-full">
      ...
      {/* Credit Dialog */}
      <UnifiedDialog variant="sheet" open={creditOpen} onOpenChange={setCreditOpen} title="Начислить кредиты">
        <div className="space-y-4 p-4">
          <div className="space-y-2">
            <Label>Количество кредитов</Label>
            <Input type="number" value={creditAmount} onChange={(e) => setCreditAmount(e.target.value)} min="1" />
          </div>
          <div className="space-y-2">
            <Label>Причина</Label>
            <Input
          ...
          <Button onClick={handleCredit} disabled={quickCredit.isPending} className="w-full">
      ...
      {/* Cost Dialog */}
      <UnifiedDialog variant="sheet" open={costOpen} onOpenChange={setCostOpen} title="Стоимость генерации">
        <div className="space-y-4 p-4">
          <div className="space-y-2">
            <Label>Новая стоимость (кредитов)</Label>
            <Input type="number" value={newCost} onChange={(e) => setNewCost(e.target.value)} min="1" />
          </div>
          <Button onClick={handleCostChange} disabled={updateConfig.isPending} className="w-full">
      ...
      <UnifiedDialog variant="sheet" open={featureOpen} onOpenChange={setFeatureOpen} title="Управление функцией">
        <div className="space-y-4 p-4">
          <div className="space-y-2">
