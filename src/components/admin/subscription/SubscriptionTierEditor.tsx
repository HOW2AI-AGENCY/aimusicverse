    ...
    <Sheet open={open} onOpenChange={onClose}>
      <SheetContent className="w-full sm:max-w-lg overflow-y-auto">
        <SheetHeader>
          ...
          <SheetDescription>Редактирование тарифного плана</SheetDescription>
        </SheetHeader>
        ...
        <ScrollArea className="h-[calc(100vh-10rem)] pr-4">
          <div className="space-y-6 py-6">
            ...
            <TierCreditsSection editedTier={editedTier} onUpdateField={onUpdateField} />

            <Separator />

            <TierFeaturesSection editedTier={editedTier} onUpdateField={onUpdateField} />
            ...
            <TierDisplaySection editedTier={editedTier} onUpdateField={onUpdateField} />
          </div>
        </ScrollArea>
