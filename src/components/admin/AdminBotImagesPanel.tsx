        ...
        <ScrollArea className="h-[500px] pr-4">
          <div className="grid gap-4">
            {MENU_IMAGE_CONFIGS.map((config) => (
              <div key={config.key} className="flex flex-col sm:flex-row gap-4 p-4 rounded-lg border bg-card">
                {/* Preview */}
                <div className="relative w-full sm:w-40 h-24 rounded-lg overflow-hidden bg-muted flex-shrink-0">
                  ...
                  {isCustomImage(config.key) && (
                    <div className="absolute top-1 right-1">
                      <div className="bg-primary text-primary-foreground text-xs px-1.5 py-0.5 rounded">Custom</div>
                    </div>
                  )}
                </div>
                ...
                <div className="flex-1 min-w-0">
                  ...
                  <div className="flex flex-wrap gap-2 mt-3">
                    ...
                    <Button size="sm" variant="ghost" onClick={() => window.open(getImageUrl(config), "_blank")}>
