    ...
    <div className="space-y-4">
        ...
        <Card className="lg:col-span-2">
          ...
          <CardContent>
            <div className="grid grid-cols-2 sm:grid-cols-3 gap-2 sm:gap-3">
              ...
              />
              <MetricCard label="FCP" value={stats.avgFcp} unit="ms" threshold={thresholds.fcp} />
              <MetricCard label="TTFB" value={stats.avgTtfb} unit="ms" threshold={thresholds.ttfb} />
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
        ...
        <Card>
          ...
          <CardContent>
            {dailyTrend.length === 0 ? (
              <div className="h-[180px] flex items-center justify-center text-muted-foreground text-sm">Нет данных</div>
            ) : (
            ...
            {deviceBreakdown.length === 0 ? (
              ...
              <ResponsiveContainer width="100%" height={180}>
                <BarChart data={deviceBreakdown} layout="vertical">
                  ...
                  <YAxis type="category" dataKey="device" tick={{ fontSize: 10 }} width={60} />
                  <Tooltip
                    contentStyle={{
                      backgroundColor: "hsl(var(--card))",
                      border: "1px solid hsl(var(--border))",
                    ...
                    formatter={(value: number | string) => [`${value.toFixed(0)} ms`, "Avg LCP"]}
                  />
