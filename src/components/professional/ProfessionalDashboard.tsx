...
const professionalWorkflows = [
  {
    ...
    steps: [
      { id: "1", title: "AI Generation", icon: Sparkles, status: "completed" as const, description: "Генерация трека" },
      {
        ...
        description: "Разделение на стемы",
      },
  ...
  },
  {
    ...
    steps: [
      { id: "1", title: "Audio Track", icon: Music, status: "completed" as const, description: "Исходный трек" },
      {
        ...
        icon: FileMusic,
        status: "current" as const,
        description: "Конвертация в MIDI",
      },
      ...
      <motion.div initial={{ opacity: 0, y: -20 }} animate={{ opacity: 1, y: 0 }} className="space-y-2">
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-sm text-muted-foreground">Полный контроль над творческим процессом</p>
          </div>
        </div>
      </motion.div>
      ...
      <div className="space-y-3">
        <div className="flex items-center justify-between">
          ...
          <Badge variant="outline" className="text-xs">
            <TrendingUp className="w-3 h-3 mr-1" />В процессе
          </Badge>
        </div>
                ...
                >
                  <CardHeader className="pb-3">
                    <div className="flex items-start justify-between">
                      <div className="flex items-center gap-3">
                        <motion.div
                          className={cn("p-2 rounded-lg shrink-0", `bg-gradient-to-br ${workflow.color}`)}
