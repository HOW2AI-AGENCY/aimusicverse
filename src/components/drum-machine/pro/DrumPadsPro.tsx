...
const Pad = memo(function Pad({ sound, isActive, isMuted, isSolo, hasSoloActive, onTrigger }: PadProps) {
  ...
  return (
    ...
    >
      ...
      <div className="absolute top-0 left-0 right-0 h-2 flex justify-center items-center gap-1">
        <div
          className={cn("w-8 h-1 rounded-full transition-all duration-75", isActive ? "opacity-100" : "opacity-20")}
          style={{
