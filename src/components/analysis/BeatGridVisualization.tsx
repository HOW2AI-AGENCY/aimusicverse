...
export function BeatGridVisualization({
  ...
  return (
    <div className={cn("space-y-2", className)}>
      ...
      {/* Beat grid */}
      <div className="relative rounded-lg bg-background/50 border overflow-hidden" style={{ height }}>
        {/* Measure backgrounds */}
        {measures.map((measure, i) => (
          <div
            key={i}
            className={cn("absolute top-0 bottom-0", i % 2 === 0 ? "bg-muted/20" : "bg-transparent")}
            style={{
