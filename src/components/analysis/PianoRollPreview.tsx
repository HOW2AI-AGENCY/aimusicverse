...
export function PianoRollPreview({ notes, duration, height = 150, className, currentTime = 0 }: PianoRollPreviewProps) {
          ...
          return (
            <div
              ...
              className={cn(
                ...
                isBlackKey ? "bg-primary/60 hover:bg-primary/80" : "bg-primary hover:bg-primary/90",
                isPast && "opacity-40",
