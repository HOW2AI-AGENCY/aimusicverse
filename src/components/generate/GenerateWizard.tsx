      ...
      {steps.map((step, index) => (
        <div key={step.id} className="flex items-center w-full">
          ...
          >
            ...
            <p
              className={`mt-1.5 sm:mt-2 text-[10px] sm:text-xs font-semibold transition-colors ${
                index === currentStepIndex
                  ? "text-primary"
                  : index < currentStepIndex
          ...
          {index < steps.length - 1 && (
            <div
              className={`flex-1 h-0.5 sm:h-1 mx-1 sm:mx-2 transition-all duration-300 rounded-full ${
