...
const QUICK_PRESETS = [
  ...
  { id: "rock", label: "Rock", channels: { genre: "rock", instrument: "electric guitar, drums", mood: "powerful" } },
  {
    id: "classical",
    label: "Classical",
    channels: { genre: "classical", instrument: "orchestra, strings", mood: "majestic" },
  },
];
...
export const PromptDJClean = memo(function PromptDJClean() {
  ...
  const handleUseAsReference = useCallback(
    (track: (typeof generatedTracks)[0]) => {
  ...
  return (
    <div className="flex flex-col gap-4">
      ...
      <div className="relative rounded-2xl overflow-hidden bg-gradient-to-br from-purple-500/5 via-background to-blue-500/5 border border-border/30 p-4">
        ...
        <LiveVisualizer analyzerNode={analyzerNode} isActive={isPlaying} className="absolute inset-0 opacity-30" />
      ...
      <div className="flex flex-col gap-3 p-4 rounded-2xl bg-card/30 border border-border/30">
        ...
        <div className="flex items-center justify-center gap-3">
          ...
          {isPlaying && (
            <Button variant="outline" size="icon" className="h-12 w-12 rounded-full" onClick={stopPlayback}>
      ...
      <AnimatePresence>
        {generatedTracks.length > 0 && (
          <motion.div
            ...
            className="space-y-2"
          >
            <div className="text-xs text-muted-foreground px-1">История ({generatedTracks.length})</div>
