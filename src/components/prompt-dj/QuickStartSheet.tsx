...
import { X, Sparkles, Music, Zap, Moon, Sun, Flame, Waves } from "@/lib/icons";
...
export const QuickStartSheet = memo(function QuickStartSheet({ isOpen, onClose, onApplyPreset }: QuickStartSheetProps) {
  return (
    <AnimatePresence>
      {isOpen && (
        <motion.div
