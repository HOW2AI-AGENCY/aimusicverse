/**
 * UnifiedTrackCard - Re-export from track-card-new
 *
 * This is a centralized re-export for the UI redesign.
 * The actual implementation is in src/components/track/track-card-new/UnifiedTrackCard.tsx
 *
