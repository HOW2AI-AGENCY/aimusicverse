...
export function GenreTabsSection({
  tracks,
  tracksByGenre: preloadedByGenre,
  isLoading,
  onRemix,
  ...
  if (
    !tracks.length &&
    !isLoading &&
    (!preloadedByGenre || Object.values(preloadedByGenre).every((arr) => arr.length === 0))
  ) {
    return null;
  }
