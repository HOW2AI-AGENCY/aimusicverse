...
const colorStyles = {
  primary: {
    bg: "from-primary/15 via-primary/5",
  ...
  purple: {
    bg: "from-purple-500/15 via-purple-500/5",
  ...
  pink: {
    bg: "from-pink-500/15 via-pink-500/5",
...
export const DailyTipCard = memo(function DailyTipCard({ className, onDismiss }: DailyTipCardProps) {
    ...
    <>
        ...
        >
          ...
          <div className="flex items-start gap-3 lg:gap-4 pr-8 lg:pr-10">
            ...
            <div className="flex-1 min-w-0">
              <p className="text-sm lg:text-base font-medium text-foreground mb-0.5 lg:mb-1">{todaysTip.tip}</p>
              <p className="text-xs lg:text-sm text-muted-foreground italic mb-2 lg:mb-3">{todaysTip.example}</p>
      ...
      {tutorialOpen && (
        <Suspense fallback={null}>
          <FeatureTutorialDialog open={tutorialOpen} onOpenChange={setTutorialOpen} type={todaysTip.id} />
        </Suspense>
      )}
    </>
  );
