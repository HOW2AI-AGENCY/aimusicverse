        ...
        >
          ...
          <motion.span
            ...
            className={cn(
              ...
              isDisabled ? "bg-muted text-muted-foreground" : "bg-card text-card-foreground",
            )}
          >
          ...
          <Button
            ...
            className={cn(
              ...
              isDisabled ? cn(action.disabledColor, "opacity-50 cursor-not-allowed") : action.color,
            )}
  ...
  return (
    <>
      ...
      <div className={cn("fixed bottom-24 right-4 z-contextual flex flex-col-reverse items-end gap-3", className)}>
        ...
        {/* Main FAB */}
        <motion.div animate={{ rotate: isOpen ? 45 : 0 }} transition={{ type: "spring", stiffness: 400, damping: 20 }}>
          <Button
            size="icon"
            className={cn(
