...
export const StudioTransport = memo(function StudioTransport({ 
  ...
  }, [isMuted, setMasterVolume, haptic]);
  ...
  if (isMobile) {
    return (
      <div className={cn(
        'flex flex-col gap-2 px-3 py-2 bg-card/50 backdrop-blur-sm border-b border-border/50',
        className
      )}>
        ...
        {/* Bottom row: Seek slider (full width on mobile) */}
