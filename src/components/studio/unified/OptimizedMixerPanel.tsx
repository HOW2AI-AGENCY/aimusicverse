...
export const OptimizedMixerPanel = memo(function OptimizedMixerPanel({
  ...
  return (
    ...
    >
      {/* Channels */}
      <ScrollArea className={cn("flex-1", isVertical ? "h-full" : "w-full")}>
        <div className={cn("flex gap-1 p-2", isVertical ? "flex-row" : "flex-col")}>
      ...
      {/* Master Channel */}
      {showMaster && (
        <div className={cn("flex items-center gap-3 p-3 border-t", isVertical && "border-t-0 border-l flex-col")}>
          ...
          <Button variant="ghost" size="icon" className="h-6 w-6" onClick={resetToDefaults} title="Reset mixer">
