    ...
    >
      ...
      <div className="flex items-center justify-between px-4 py-3 border-b border-border/50 bg-card/95 backdrop-blur-md shrink-0">
        <div className="flex items-center gap-2">
          <h1 className="text-lg font-semibold truncate max-w-[140px]">{project.name}</h1>
        ...
        <div className="flex items-center gap-1.5">
          ...
          <Button variant="outline" size="icon" onClick={handleMixerToggle} className="h-9 w-9">
      ...
      <div className="flex-1 overflow-y-auto overflow-x-hidden">
        {project.tracks.length === 0 ? (
          <div className="flex flex-col items-center justify-center h-full p-8 text-center">
            <p className="text-muted-foreground mb-4">No tracks yet. Add tracks to get started.</p>
            {onAddTrack && (
          ...
          <div className="min-h-full">
            {project.tracks.map((track) => {
              ...
              return (
                <div key={track.id} className="flex items-center gap-2 p-2 border-b border-border/20 hover:bg-muted/30">
      ...
      >
        <div className="flex items-center justify-between px-4 py-3">
          ...
          <div className="flex items-center gap-1">
            {onSkipBack && (
              <Button variant="ghost" size="icon" onClick={onSkipBack} className="h-10 w-10">
            ...
            {onSkipForward && (
              <Button variant="ghost" size="icon" onClick={onSkipForward} className="h-10 w-10">
          ...
          <div className="flex items-center gap-2 min-w-[100px] justify-end">
            <Button variant="ghost" size="icon" onClick={handleMasterMuteToggle} className="h-8 w-8">
        ...
        <SheetContent side="right" className="w-full sm:w-[400px] p-0">
          ...
          <div className="p-4 space-y-4 overflow-y-auto h-[calc(100%-60px)]">
            ...
            <div className="space-y-2">
              ...
              <div className="flex items-center gap-2">
                <Button variant="ghost" size="icon" onClick={handleMasterMuteToggle} className="h-8 w-8 shrink-0">
