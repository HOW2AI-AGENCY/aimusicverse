          ...
          <Card className="max-w-md w-full border-destructive/50 bg-destructive/5">
            <CardHeader className="pb-3">
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <CardDescription className="text-sm mt-0.5">{fallbackMessage || errorType}</CardDescription>
                </div>
              </div>
            </CardHeader>
            <CardContent className="space-y-4">
              ...
              <div className="flex gap-2">
                <Button onClick={this.handleReset} disabled={isRecovering} className="flex-1" variant="default">
                  {isRecovering ? (
                    <>
                ...
                <Button onClick={this.handleReload} variant="outline" disabled={isRecovering}>
