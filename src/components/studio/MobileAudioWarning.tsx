...
export const MobileAudioWarning = memo(({ show, activeCount, limitedStems, onDismiss }: MobileAudioWarningProps) => {
      ...
      {show && (
        ...
        >
          <Alert variant="default" className="bg-amber-500/10 border-amber-500/30">
            ...
            <AlertTitle className="text-amber-500 text-sm">Ограничение мобильного аудио</AlertTitle>
            <AlertDescription className="text-xs text-muted-foreground pr-8">
              <p>
                Воспроизводятся {activeCount} из {activeCount + limitedStems.length} стемов. Отключены: {limitedTypes}
