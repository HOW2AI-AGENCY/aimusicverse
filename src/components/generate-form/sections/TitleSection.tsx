...
export const TitleSection = memo(function TitleSection({ title, onTitleChange }: TitleSectionProps) {
  return (
    <div className="space-y-2">
      <div className="flex items-center justify-between">
        <SectionLabel label="Название" htmlFor="title" hint={SECTION_HINTS.title} suffix="(опционально)" />
        <FormFieldActions value={title} onClear={() => onTitleChange("")} />
      </div>
      <Input
        id="title"
