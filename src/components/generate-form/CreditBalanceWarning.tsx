      ...
      <AnimatePresence>
        <motion.div
          ...
          className={cn(
            ...
            isInsufficient ? "border-destructive/30 bg-destructive/10" : "border-amber-500/30 bg-amber-500/10",
            className,
          )}
        >
          <div className="p-3">
              ...
              <div className="flex-1 min-w-0">
                ...
                <p className="text-[11px] text-muted-foreground mt-0.5">
                  {isInsufficient ? (
                    showUpgradeOption ? (
                      ...
                      <>
                        Ваш баланс: <span className="font-semibold text-foreground">{balance}</span> • Требуется:{" "}
                    ...
                    <>
                      ...
                      <span className="font-semibold text-amber-600 dark:text-amber-400">{balance - cost}</span>{" "}
                      кредитов
                    </>
                  )}
                </p>
                ...
                <Button
                  ...
                  className={cn(
                    ...
                    showUpgradeOption &&
                      isInsufficient &&
                      "bg-gradient-to-r from-amber-500 to-orange-500 border-0 text-white hover:from-amber-600 hover:to-orange-600",
                  )}
                >
                  {showUpgradeOption ? (
                    <>
