...
export const ChatMessageList = memo(
  forwardRef<HTMLDivElement, ChatMessageListProps>(
    (
      {
        messages,
        isLoading,
      ...
      return (
        <div ref={ref} className="flex-1 overflow-y-auto px-4 py-3 space-y-4 scroll-smooth overscroll-contain">
          <AnimatePresence mode="popLayout" initial={false}>
            {messages.map((message) => (
              <motion.div
                ...
                layout
              >
                <ChatMessageBubble message={message} onOptionClick={onOptionClick} />
                ...
                {message.component === "genre" && (
                  <motion.div
                    ...
                    className="mt-3 ml-2"
                  >
                    <GenrePicker value={selectedGenre} onChange={onGenreSelect} mode="grid" className="max-w-sm" />
                  </motion.div>
                )}
                ...
                {message.component === "structure" && (
                  <motion.div
                    ...
                    className="mt-3 ml-2"
                  >
                    <StructurePicker value={selectedStructure} onChange={onStructureSelect} className="max-w-sm" />
                  </motion.div>
                )}
