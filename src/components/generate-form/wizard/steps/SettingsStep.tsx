    ...
    >
      ...
      <div className="flex items-center gap-3">
        ...
        <div>
          ...
          <p className="text-sm text-muted-foreground">Название и параметры генерации</p>
        </div>
      </div>

      {/* Title input */}
      <div className="space-y-2">
        <label className="text-xs text-muted-foreground font-medium">Название трека (опционально):</label>
        <Input
      ...
      {/* Privacy toggle */}
      <div className="space-y-2">
        <label className="text-xs text-muted-foreground font-medium">Приватность:</label>
      ...
      {/* Model selection */}
      <div className="space-y-2">
        <label className="text-xs text-muted-foreground font-medium">Модель AI:</label>
        <div className="grid grid-cols-2 gap-2">
          {availableModels.slice(0, 4).map((m) => (
            <button
              ...
              className={cn(
                ...
                model === m.key ? "border-primary bg-primary/10" : "border-border hover:border-primary/50",
              )}
            >
              ...
              <div className="flex-1 min-w-0">
                <div className="flex items-center gap-1">
                  ...
                  {m.status === "latest" && (
                    <span className="text-[8px] px-1 py-0.5 rounded bg-primary/20 text-primary font-bold">NEW</span>
                  )}
                </div>
