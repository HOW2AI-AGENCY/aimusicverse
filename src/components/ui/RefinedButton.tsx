...
const variantStyles: Record<ButtonVariant, string> = {
  ...
  secondary: cn("bg-secondary text-secondary-foreground", "hover:bg-secondary/80", "border border-secondary/20"),
  outline: cn("bg-transparent text-foreground", "border border-border", "hover:bg-accent hover:border-primary/30"),
  ghost: cn("bg-transparent text-foreground", "hover:bg-accent"),
  destructive: cn("bg-destructive text-destructive-foreground", "hover:bg-destructive/90", "shadow-sm"),
  success: cn("bg-success text-white", "hover:bg-success/90", "shadow-sm"),
  premium: cn(
...
export function ButtonGroup({ children, orientation = "horizontal", attached = false, className }: ButtonGroupProps) {
  return (
    <div
      className={cn(
        "flex",
