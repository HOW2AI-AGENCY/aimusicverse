...
/**
 * SectionHeader — re-export of the canonical implementation.
 * The canonical SectionHeader lives at `@/components/common/SectionHeader`.
 * This export is kept for backwards compatibility with existing imports.
 *
 * @deprecated import directly from `@/components/common/SectionHeader`.
 */
