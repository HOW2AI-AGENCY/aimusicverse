...
export function IconButton({
  ...
  return (
    <Button
      ...
      size="icon"
      className={cn(
        touchTargetClass.icon,
        iconSizes[visualSize],
        className
      )}
      {...props}
    >
  ...
  return (
    <div
      ...
      className={cn(
        ...
        interactive && 'hover:bg-accent/50 focus-visible:bg-accent/50 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-inset',
...
export { touchTarget, TOUCH_CLASSES, TOUCH_TARGET_MIN_SIZE, validateTouchTarget, getTouchTargetPadding } from '@/lib/touch-target';
