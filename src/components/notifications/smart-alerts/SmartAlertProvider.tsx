  ...
  useEffect(() => {
    ...
    const checkConditions = async () => {
      try {
        ...
        // Гейт: «Стемы готовы» — контекстный алёрт, показывать только в
        // студии / библиотеке, не на главной и не на других случайных экранах.
        const isStemsContextRoute =
          location.pathname.startsWith("/studio") ||
          location.pathname.startsWith("/library") ||
          location.pathname.startsWith("/track");

        if (isStemsContextRoute) {
