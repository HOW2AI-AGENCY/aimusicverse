...
import { 
  Loader2, Music2, ChevronDown, ChevronUp, 
  Clock, Sparkles, ExternalLink, X 
} from 'lucide-react';
      ...
      <div className="flex items-start gap-3">
        ...
        <div className="flex-1 min-w-0">
          ...
          <div className="flex items-center gap-2 mt-1">
            <Badge 
              variant="outline" 
              className={cn("text-[10px] h-5 px-1.5", statusColors[generation.status])}
            >
    ...
    >
      <div className="bg-background/95 backdrop-blur-xl border border-primary/30 rounded-2xl shadow-lg shadow-primary/10 overflow-hidden">
        ...
        <Button
          ...
          className="h-auto py-3 px-4 gap-3 hover:bg-primary/5 rounded-none w-full justify-between"
        >
            ...
            <div className="flex-1 min-w-0 text-left">
              ...
              {mainGeneration && (
                <p className="text-xs text-muted-foreground truncate">
                  ...
                  {mainGeneration.estimated_time && mainGeneration.estimated_time > 0 && 
