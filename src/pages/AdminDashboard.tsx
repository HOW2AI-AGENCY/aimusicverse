  ...
  return (
    ...
    >
      ...
      <div className="space-y-4">
        {dashboard.activeTab === "overview" && <MonitoringHub onNavigateToTab={(tab) => dashboard.setActiveTab(tab)} />}

        {dashboard.activeTab === "analytics" && <EnhancedAnalyticsPanel />}

        {dashboard.activeTab === "generation-stats" && <GenerationStatsPanel />}

        {dashboard.activeTab === "performance" && <PerformanceDashboard />}
        ...
        {dashboard.activeTab === "moderation" && <ModerationReportsPanel />}
        ...
        {dashboard.activeTab === "feedback" && (
          <Card>
            ...
            <CardContent className="space-y-4">
              <p className="text-muted-foreground">Просмотр и ответ на сообщения пользователей из бота.</p>
              <Button onClick={() => dashboard.navigate("/admin/feedback")} className="w-full">
        ...
        {dashboard.activeTab === "bot" && <BotTab metrics={dashboard.metrics} isMobile={dashboard.isMobile} />}
        ...
        {dashboard.activeTab === "payments" && <StarsPaymentsPanel />}

        {dashboard.activeTab === "logs" && <GenerationLogsPanel />}

        {dashboard.activeTab === "balances" && <UserBalancesPanel />}

        {dashboard.activeTab === "deeplinks" && <DeeplinkAnalyticsPanel />}
          ...
          <div className="grid gap-4 md:grid-cols-2">
            ...
            <Card>
              ...
              <CardContent className="space-y-3">
                ...
                <Button onClick={() => dashboard.navigate("/blog")} className="w-full">
        ...
        {dashboard.activeTab === "users" && (
          <UsersTab
            ...
            onToggleAdmin={(userId, action) => dashboard.toggleRole.mutate({ userId, role: "admin", action })}
          />
        )}
      </div>
