...
export default function PaymentSuccess() {
  ...
  const purchasedTier = productCode?.includes("premium") ? "premium" : productCode?.includes("pro") ? "pro" : null;
    ...
    <div className="min-h-screen flex items-center justify-center p-4 bg-gradient-to-b from-background via-background to-success/10 relative overflow-hidden">
      ...
      <AnimatePresence>
        {showContent && (
          ...
          >
            <div className={cn("overflow-hidden rounded-3xl border", glass.card, "shadow-2xl shadow-success/20")}>
              <div className="pt-10 pb-8 px-6 text-center space-y-6">
                ...
                >
                  <h1 className="text-2xl font-bold text-foreground flex items-center justify-center gap-2">
                    <motion.span animate={{ rotate: [0, 15, -15, 0] }} transition={{ duration: 0.5, delay: 0.6 }}>
                      🎉
                    </motion.span>
                    Оплата успешна!
                    <motion.span animate={{ rotate: [0, -15, 15, 0] }} transition={{ duration: 0.5, delay: 0.7 }}>
                      🎉
                    </motion.span>
                  </h1>
                  <p className="text-muted-foreground">Кредиты уже зачислены на ваш счёт</p>
                </motion.div>
                ...
                >
                  ...
                  {orderId && (
                    <div className={cn("text-sm rounded-xl p-3", glass.card)}>
                ...
                >
                  ...
                  <Button onClick={handleGoToLibrary} variant="outline" className="w-full gap-2 h-11">
