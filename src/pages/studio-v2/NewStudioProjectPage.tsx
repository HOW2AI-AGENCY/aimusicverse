    ...
    <div className="min-h-screen bg-background">
      ...
      >
        <div className="container flex h-14 items-center px-4">
          <Button variant="ghost" size="icon" onClick={() => navigate("/studio-v2")} className="mr-3">
      ...
      <main className="container max-w-2xl px-4 py-6">
        ...
        <div className="grid gap-4 sm:grid-cols-2 mb-6">
          <Card
            className={`cursor-pointer transition-all ${
              mode === "empty" ? "border-primary ring-2 ring-primary/20" : "hover:border-muted-foreground/50"
            }`}
          ...
          >
            <CardContent className="flex flex-col items-center p-6 text-center">
              ...
              <p className="text-sm text-muted-foreground mt-1">Создайте проект с нуля</p>
            </CardContent>
          </Card>

          <Card
            className={`cursor-pointer transition-all ${
              mode === "from-track" ? "border-primary ring-2 ring-primary/20" : "hover:border-muted-foreground/50"
            }`}
          ...
          >
            <CardContent className="flex flex-col items-center p-6 text-center">
              ...
              <p className="text-sm text-muted-foreground mt-1">Начните с готового трека</p>
            </CardContent>
          </Card>
        </div>
        ...
        {mode === "empty" && (
          <Card>
            <CardHeader>
              ...
              <CardDescription>Задайте базовые параметры проекта</CardDescription>
            </CardHeader>
            <CardContent className="space-y-4">
              <div className="space-y-2">
                <Label htmlFor="name">Название *</Label>
                <Input id="name" placeholder="Мой проект" value={name} onChange={(e) => setName(e.target.value)} />
              </div>
        ...
        {mode === "from-track" && (
          <Card>
            <CardHeader>
              ...
              <CardDescription>Проект будет создан на основе выбранного трека</CardDescription>
            </CardHeader>
            <CardContent>
              {loadingTracks ? (
                ...
                <div className="text-center py-8">
                  ...
                  <Button variant="link" onClick={() => navigate("/generate")} className="mt-2">
                    Создать трек
                  </Button>
                </div>
              ) : (
        ...
        <div className="mt-6 flex gap-3">
          <Button variant="outline" onClick={() => navigate("/studio-v2")} className="flex-1 sm:flex-none">
            Отмена
          </Button>
          <Button
