                ...
                <div className="space-y-6 text-sm pr-4">
                  ...
                  <section>
                    ...
                    <p className="text-muted-foreground leading-relaxed">
                      Настоящая Политика конфиденциальности описывает, как MusicVerse AI ("мы", "нас", "наш") собирает,
                      использует, хранит и защищает вашу персональную информацию при использовании нашего сервиса через
                      Telegram Mini App и Telegram Bot.
                    </p>
                    <p className="text-muted-foreground leading-relaxed mt-2">
                      Мы серьезно относимся к защите ваших данных и соблюдаем требования применимого законодательства о
                  ...
                  <section>
                    ...
                    <p className="text-muted-foreground leading-relaxed">При авторизации через Telegram мы получаем:</p>
                  ...
                  <section>
                    ...
                    <ul className="list-disc list-inside space-y-1 text-muted-foreground">
                      <li>
                        <strong>Предоставления сервиса:</strong> генерация музыки, хранение треков, управление
                        библиотекой
                      </li>
                      <li>
                        <strong>Персонализации:</strong> рекомендации, настройки интерфейса
                      </li>
                      <li>
                        <strong>Коммуникации:</strong> уведомления о статусе генерации, важные обновления
                      </li>
                      <li>
                        <strong>Улучшения сервиса:</strong> анализ использования, выявление проблем
                      </li>
                      <li>
                        <strong>Безопасности:</strong> защита от мошенничества и злоупотреблений
                      </li>
                      <li>
                        <strong>Соблюдения закона:</strong> выполнение юридических обязательств
                      </li>
                    </ul>
                  </section>
                  ...
                  <section>
                    ...
                    <p className="text-muted-foreground leading-relaxed">
                      Ваши данные хранятся на защищенных облачных серверах (на базе PostgreSQL) с резервным
                      копированием. Аудио-файлы хранятся в облачном хранилище с шифрованием при передаче и хранении.
                    </p>
                    ...
                    <p className="text-muted-foreground leading-relaxed">
                      Мы храним ваши данные пока вы активно используете сервис. При удалении аккаунта большинство данных
                      удаляется в течение 30 дней, за исключением:
                    </p>
                    <ul className="list-disc list-inside mt-2 space-y-1 text-muted-foreground">
                  ...
                  <section>
                    ...
                    <ul className="list-disc list-inside mt-2 space-y-1 text-muted-foreground">
                      <li>
                        <strong>Lovable Cloud:</strong> хранение данных и аутентификация
                      </li>
                      <li>
                        <strong>Suno AI:</strong> генерация музыки (передаются только промпты и аудио-референсы)
                      </li>
                      <li>
                        <strong>Telegram:</strong> отправка уведомлений и взаимодействие через бот
                      </li>
                    </ul>

                    <h3 className="font-semibold mt-3 mb-1">5.2. Публичный контент</h3>
                    <p className="text-muted-foreground leading-relaxed">Если вы делаете ваш контент публичным:</p>
                    <ul className="list-disc list-inside mt-2 space-y-1 text-muted-foreground">
                  ...
                  <section>
                    ...
                    <ul className="list-disc list-inside space-y-1 text-muted-foreground">
                      <li>
                        <strong>Доступ:</strong> запросить копию ваших данных
                      </li>
                      <li>
                        <strong>Исправление:</strong> обновить неточную информацию
                      </li>
                      <li>
                        <strong>Удаление:</strong> удалить ваш аккаунт и данные
                      </li>
                      <li>
                        <strong>Ограничение:</strong> ограничить обработку данных
                      </li>
                      <li>
                        <strong>Переносимость:</strong> получить данные в машиночитаемом формате
                      </li>
                      <li>
                        <strong>Возражение:</strong> возразить против определенных видов обработки
                      </li>
                      <li>
                        <strong>Отзыв согласия:</strong> отозвать согласие на обработку данных
                      </li>
                    </ul>
                    <p className="text-muted-foreground leading-relaxed mt-2">
                      Для реализации этих прав обратитесь к нам через {getBotMention()} или support@musicverse.ai
                    </p>
                  </section>
                  ...
                  <section>
                    ...
                    <ul className="list-disc list-inside mt-2 space-y-1 text-muted-foreground">
                      <li>
                        <strong>LocalStorage:</strong> для хранения настроек интерфейса
                      </li>
                      <li>
                        <strong>Session Storage:</strong> для временных данных сеанса
                      </li>
                      <li>
                        <strong>Telegram CloudStorage:</strong> для синхронизации настроек
                      </li>
                    </ul>
                    <p className="text-muted-foreground leading-relaxed mt-2">
                      Мы НЕ используем сторонние системы аналитики (Google Analytics и т.п.). Вся аналитика происходит
                  ...
                  <section>
                    ...
                    <p className="text-muted-foreground leading-relaxed">
                      Наш сервис предназначен для пользователей старше 13 лет. Мы не собираем намеренно данные детей
                      младше 13 лет. Если вы узнали, что ребенок предоставил нам персональные данные, пожалуйста,
                  ...
                  <section>
                    ...
                    <p className="text-muted-foreground leading-relaxed">
                      Ваши данные могут обрабатываться в странах, где расположены наши сервис-провайдеры. Мы
                      обеспечиваем адекватный уровень защиты данных в соответствии с применимым законодательством.
                    </p>
                  </section>
                  ...
                  <section>
                    ...
                    <p className="text-muted-foreground leading-relaxed">
                      Мы можем обновлять эту Политику конфиденциальности. Существенные изменения будут доведены до
                      вашего сведения через:
                    </p>
                    <ul className="list-disc list-inside mt-2 space-y-1 text-muted-foreground">
                    ...
                    <p className="text-muted-foreground leading-relaxed mt-2">
                      Продолжение использования сервиса после изменений означает ваше согласие с обновленной политикой.
                    </p>
                  </section>
                  ...
                  <section>
                    ...
                    <p className="text-muted-foreground leading-relaxed">
                      Используя MusicVerse AI, вы подтверждаете, что прочитали и поняли настоящую Политику
                      конфиденциальности и даете согласие на обработку ваших персональных данных в соответствии с
