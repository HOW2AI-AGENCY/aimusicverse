                ...
                <div className="space-y-6 text-sm pr-4">
                  ...
                  <section>
                    ...
                    <p className="text-muted-foreground leading-relaxed">
                      Добро пожаловать в MusicVerse AI! Настоящее Пользовательское соглашение регулирует использование
                      вами нашего сервиса по созданию музыки с помощью искусственного интеллекта через Telegram Mini App
                      и Telegram Bot.
                    </p>
                    <p className="text-muted-foreground leading-relaxed mt-2">
                      Используя наш сервис, вы подтверждаете, что прочитали, поняли и согласны соблюдать настоящие
                  ...
                  <section>
                    ...
                    <p className="text-muted-foreground leading-relaxed">
                      MusicVerse AI предоставляет платформу для создания музыкальных композиций с использованием
                      технологий искусственного интеллекта. Сервис включает:
                    </p>
                  ...
                  <section>
                    ...
                    <p className="text-muted-foreground leading-relaxed">
                      <strong>Права на созданный контент:</strong> Вы сохраняете права на музыкальные композиции,
                      созданные с помощью нашего сервиса. При этом:
                    </p>
                    <ul className="list-disc list-inside mt-2 space-y-1 text-muted-foreground">
                    ...
                    <p className="text-muted-foreground leading-relaxed mt-2">
                      <strong>Права на сервис:</strong> Все права на программное обеспечение, дизайн, логотипы и
                      торговые марки принадлежат MusicVerse AI.
                    </p>
                  </section>
                  ...
                  <section>
                    ...
                    <p className="text-muted-foreground leading-relaxed">
                      Мы серьезно относимся к защите ваших данных. Подробная информация о сборе, использовании и защите
                      персональных данных представлена в нашей{" "}
                      <Button
                        variant="link"
                  ...
                  <section>
                    ...
                    <p className="text-muted-foreground leading-relaxed">
                      <strong>Кредиты:</strong> Сервис работает на основе системы кредитов. Генерация треков расходует
                      кредиты согласно тарифам.
                    </p>
                    <p className="text-muted-foreground leading-relaxed mt-2">
                      <strong>Возвраты:</strong> Возврат средств возможен в случае технических проблем с нашей стороны.
                      Неиспользованные кредиты не подлежат возврату.
                    </p>
                  </section>
                  ...
                  <section>
                    ...
                    <p className="text-muted-foreground leading-relaxed">
                      Мы можем изменять настоящие Условия использования в любое время. Существенные изменения будут
                      доведены до вашего сведения через:
                    </p>
                    <ul className="list-disc list-inside mt-2 space-y-1 text-muted-foreground">
                  ...
                  <section>
                    ...
                    <p className="text-muted-foreground leading-relaxed">
                      Настоящие Условия регулируются и толкуются в соответствии с законодательством, применимым к месту
                      регистрации сервиса. Любые споры подлежат разрешению в соответствующих судебных инстанциях.
                    </p>
                  </section>
                </div>
              </ScrollArea>
