...
<p>
  ...
  <img alt="Audit" src="https://img.shields.io/badge/audit-032_complete-10B981?style=for-the-badge"/>
</p>
...
flowchart LR
    Start[👋 You]
    Start --> Newcomer[🧭 Newcomer]
    Start --> Frontend[🎨 Frontend]
    Start --> Backend[⚙️ Backend]
    Start --> Design[🖌 Designer]
    Start --> PM[📋 PM]
    Start --> DevOps[🛡 DevOps]

    Newcomer --> KB[KNOWLEDGE_BASE]
    KB --> Arch[ARCHITECTURE_HUB]
    Arch --> Contrib[CONTRIBUTING]

    Frontend --> Hooks[docs/HOOKS_REFERENCE]
    Hooks --> Player[docs/PLAYER_ARCHITECTURE]
    Player --> Mobile[docs/MOBILE_COMPONENTS]

    Backend --> DB[docs/DATABASE]
    DB --> Edge[docs/API]
    Edge --> Suno[docs/SUNO_API]

    Design --> DS[docs/DESIGN_SYSTEM_COMPREHENSIVE]
    DS --> Tokens[docs/DESIGN_TOKENS]
    Tokens --> Layout[docs/LAYOUT_SYSTEM]

    PM --> Status[PROJECT_STATUS]
    Status --> Road[ROADMAP]
    Road --> Sprints[SPRINTS/]

    DevOps --> Deploy[docs/DEPLOYMENT_GUIDE]
    Deploy --> Env[docs/ENVIRONMENT_VARIABLES]
    Env --> Monit[docs/PERFORMANCE_MONITORING_SETUP]
```
...
| [README_RU](README_RU.md) | Русская версия | ✅ |
| [KNOWLEDGE_BASE](KNOWLEDGE_BASE.md) | Project knowledge base | ✅ |
