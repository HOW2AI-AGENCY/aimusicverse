...
### Archive
- **archive/** - Historical reports and summaries
  - audits/ - Project audits and analysis
  - session-summaries/ - Development session logs
  - implementation-reports/ - Feature implementation reports
  - sprint-reports/ - Sprint status reports
...
- [SPRINTS/SPRINT-PROGRESS.md](../SPRINTS/SPRINT-PROGRESS.md) - Active tracking

### Development
- [CONTRIBUTING.md](../CONTRIBUTING.md) - Contributing guide
- [DEVELOPMENT_WORKFLOW.md](../DEVELOPMENT_WORKFLOW.md) - Dev workflow
- [SPRINT_IMPLEMENTATION_GUIDE.md](../SPRINT_IMPLEMENTATION_GUIDE.md) - Implementation patterns

### Key Technical Docs
- [GENERATION_SYSTEM.md](./GENERATION_SYSTEM.md) - Music generation architecture
- [PLAYER_ARCHITECTURE.md](./PLAYER_ARCHITECTURE.md) - Audio player system
