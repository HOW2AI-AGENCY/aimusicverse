...
2. **ВИЗУАЛИЗАЦИЯ*ПОЛЬЗОВАТЕЛЬСКИХ*СЦЕНАРИЕВ.md** → docs/ru/user-scenarios.md
3. **ИТОГОВЫЙ*ОТЧЕТ*АНАЛИЗА.md** → docs/ru/analysis-report.md
4. **ПЛАН_ДОРАБОТКИ.md** → docs/ru/improvement-plan.md
5. **ПЛАН*РАЗВИТИЯ*И*УЛУЧШЕНИЯ*СТУДИИ.md** → docs/ru/studio-development-plan.md
